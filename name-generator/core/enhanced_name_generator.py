#!/usr/bin/env python3
"""
Enhanced Fantasy Name Generator - Phase 2
...
class EnhancedNameGenerator:
    def __init__(self, database_file: str = 'enhanced_name_database.json'):
    ...
    def generate_name(self, culture: str = None, count: int = 1, min_quality: float = 70.0) -> List[str]:
...
def main():
    ...
    if not generator.names_by_culture:
        print("❌ No name database found! Please run parse_dnd_names.py first.")
        return
