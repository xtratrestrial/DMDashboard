...
Source: https://foundryvtt.com/api/classes/foundry.documents.NoteDocument.html
...
- foundry.documents.Scene: The Scene document type which contains Note documents
- foundry.applications.sheets.NoteConfig: The Note configuration application


#### Hierarchy (View Summary)

- BaseNote<this>NoteDocument
- NoteDocument
...
- new NoteDocument(    data?: Partial<NoteData>,    options?: DocumentConstructionContext,): NoteDocumentParametersOptionaldata: Partial<NoteData> = {}Initial data used to construct the data object. The provided object will be
...
Returns NoteDocumentInherited from BaseNote.constructor
- Optionaldata: Partial<NoteData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseNote.constructor
...
Inherited from BaseNote._source
...
Inherited from BaseNote.parent
...
Inherited from BaseNote._schema


### StaticDEFAULT_ICON

`Static`The default icon used for newly created Note documents.

Inherited from BaseNote.DEFAULT_ICON


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseNote.LOCALIZATION_PREFIXES
...
Inherited from BaseNote.metadata
...
Returns anyInherited from CanvasDocumentMixin(BaseNote).compendium
...
- get entry(): documents.JournalEntryThe associated JournalEntry which is referenced by this Note
...
Returns null | stringInherited from CanvasDocumentMixin(BaseNote).id
...
Returns booleanInherited from CanvasDocumentMixin(BaseNote).inCompendium
...
Returns booleanInherited from CanvasDocumentMixin(BaseNote).invalid
...
Returns booleanInherited from CanvasDocumentMixin(BaseNote).isEmbedded
...
- get label(): stringThe text label used to annotate this Note
Returns string
...
- get page(): documents.JournalEntryPageThe specific JournalEntryPage within the associated JournalEntry referenced by this Note.
...
Returns SchemaFieldInherited from CanvasDocumentMixin(BaseNote).schema
...
Returns stringInherited from CanvasDocumentMixin(BaseNote).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from CanvasDocumentMixin(BaseNote).validationFailures
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseNote).baseDocument
...
Returns stringInherited from CanvasDocumentMixin(BaseNote).collectionName
...
Returns abstract.DatabaseBackendInherited from CanvasDocumentMixin(BaseNote).database
...
Returns stringInherited from CanvasDocumentMixin(BaseNote).documentName
...
Returns booleanInherited from CanvasDocumentMixin(BaseNote).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from CanvasDocumentMixin(BaseNote).hierarchy
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseNote).implementation
...
Returns string[]Inherited from CanvasDocumentMixin(BaseNote).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseNote._configure
...
Inherited from BaseNote._configure
...
Returns null | stringInherited from BaseNote._getParentCollection
...
Inherited from BaseNote._getParentCollection
...
Inherited from BaseNote.canUserModify
...
Inherited from BaseNote.createEmbeddedDocuments
...
Inherited from BaseNote.delete
...
SeeDocument.deleteDocuments
Inherited from BaseNote.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseNote.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseNote.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseNote.getFlag
...
Inherited from BaseNote.getUserLevel
...
Inherited from BaseNote.migrateSystemData
...
Returns voidInherited from BaseNote.reset
...
Inherited from BaseNote.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseNote.testUserPermission
...
Inherited from BaseNote.toJSON
...
Inherited from BaseNote.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseNote.traverseEmbeddedDocuments
...
Inherited from BaseNote.traverseEmbeddedDocuments
...
Inherited from BaseNote.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseNote.update
...
SeeDocument.updateDocuments
Inherited from BaseNote.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseNote.updateSource
...
Inherited from BaseNote.validate
...
Returns voidInherited from BaseNote._initialize
...
Inherited from BaseNote._initialize
...
Inherited from BaseNote._initializeSource
...
`data`Inherited from BaseNote._initializeSource
...
Returns voidInherited from BaseNote._onCreate
...
Inherited from BaseNote._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseNote._onDelete
...
Inherited from BaseNote._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseNote._onUpdate
...
Inherited from BaseNote._onUpdate
...
Inherited from BaseNote._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseNote._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseNote._preUpdate
...
Inherited from BaseNote._addDataFieldMigration
...
Returns voidInherited from BaseNote._addDataFieldShim
...
Inherited from BaseNote._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseNote._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseNote._addDataFieldShims
...
Returns voidInherited from BaseNote._clearFieldsRecusively
...
Inherited from BaseNote._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseNote._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseNote._initializationOrder
...
Returns voidInherited from BaseNote._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseNote._logDataFieldMigration


### StaticcanUserCreate

`Static`- canUserCreate(user: any): anyParametersuser: anyReturns anyInherited from BaseNote.canUserCreate
- user: any
...
Inherited from BaseNote.canUserCreate
...
Inherited from BaseNote.cleanData
...
`source`Inherited from BaseNote.cleanData
...
Inherited from BaseNote.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseNote.create


### StaticcreateDialog

`Static`- createDialog(    noteData?: {},    createOptions?: {},    dialogOptions?: {},): Promise<any>ParametersnoteData: {} = {}createOptions: {} = {}dialogOptions: {} = {}Returns Promise<any>Inherit DocOverrides CanvasDocumentMixin(BaseNote).createDialog
- noteData: {} = {}
- createOptions: {} = {}
- dialogOptions: {} = {}
...
Inherited from BaseNote.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseNote.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    elevation: NumberField;    entryId: ForeignDocumentField;    flags: DocumentFlagsField;    fontFamily: StringField;    fontSize: NumberField;    global: BooleanField;    iconSize: NumberField;    pageId: ForeignDocumentField;    sort: NumberField;    text: StringField;    textAnchor: NumberField;    textColor: ColorField;    texture: TextureData;    x: NumberField;    y: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    elevation: NumberField;    entryId: ForeignDocumentField;    flags: DocumentFlagsField;    fontFamily: StringField;    fontSize: NumberField;    global: BooleanField;    iconSize: NumberField;    pageId: ForeignDocumentField;    sort: NumberField;    text: StringField;    textAnchor: NumberField;    textColor: ColorField;    texture: TextureData;    x: NumberField;    y: NumberField;}Inherited from BaseNote.defineSchema
...
Inherited from BaseNote.defineSchema
...
Inherited from BaseNote.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseNote.deleteDocuments
...
Inherited from BaseNote.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseNote.fromSource
...
Inherited from BaseNote.fromSource
...
Inherited from BaseNote.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseNote.getCollectionName
...
Inherited from BaseNote.migrateData
...
`source`Inherited from BaseNote.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseNote.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseNote.migrateDataSafe
...
the data argument
Inherited from BaseNote.shimData
...
`data`Inherited from BaseNote.shimData
...
Inherited from BaseNote.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseNote.updateDocuments
...
Inherited from BaseNote.validateJoint
...
Returns Promise<void>Inherited from BaseNote._onCreateOperation
...
Inherited from BaseNote._onCreateOperation
...
Returns Promise<void>Inherited from BaseNote._onDeleteOperation
...
Inherited from BaseNote._onDeleteOperation
...
Returns Promise<void>Inherited from BaseNote._onUpdateOperation
...
Inherited from BaseNote._onUpdateOperation
...
Inherited from BaseNote._preCreateOperation
...
Inherited from BaseNote._preDeleteOperation
...
Inherited from BaseNote._preUpdateOperation
