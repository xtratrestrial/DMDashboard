...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseRegionBehavior.html
...
- DocumentBaseRegionBehaviordocuments.RegionBehavior
- BaseRegionBehaviordocuments.RegionBehavior
...
- new BaseRegionBehavior(    data?: Partial<RegionBehaviorData>,    options?: DocumentConstructionContext,): BaseRegionBehaviorParametersOptionaldata: Partial<RegionBehaviorData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseRegionBehaviorInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    disabled: BooleanField;    flags: DocumentFlagsField;    name: StringField;    system: TypeDataField;    type: DocumentTypeField;}Overrides Document.defineSchema
