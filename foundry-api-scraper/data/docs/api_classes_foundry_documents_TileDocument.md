# TileDocument | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.TileDocument.html
...
- foundry.documents.Scene: The Scene document type which contains Tile documents
- foundry.applications.sheets.TileConfig: The Tile configuration application


#### Hierarchy (View Summary)

- BaseTile<this>TileDocument
- TileDocument
...
- new TileDocument(    data?: Partial<TileData>,    options?: DocumentConstructionContext,): TileDocumentParametersOptionaldata: Partial<TileData> = {}Initial data used to construct the data object. The provided object will be
...
Returns TileDocumentInherited from BaseTile.constructor
- Optionaldata: Partial<TileData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseTile.constructor
...
Inherited from BaseTile._source
...
Inherited from BaseTile.parent
...
Inherited from BaseTile._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseTile.LOCALIZATION_PREFIXES
...
Inherited from BaseTile.metadata
...
Returns anyInherited from CanvasDocumentMixin(BaseTile).compendium
...
Returns null | stringInherited from CanvasDocumentMixin(BaseTile).id
...
Returns booleanInherited from CanvasDocumentMixin(BaseTile).inCompendium
...
Returns booleanInherited from CanvasDocumentMixin(BaseTile).invalid
...
Returns booleanInherited from CanvasDocumentMixin(BaseTile).isEmbedded
...
Returns SchemaFieldInherited from CanvasDocumentMixin(BaseTile).schema
...
Returns stringInherited from CanvasDocumentMixin(BaseTile).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from CanvasDocumentMixin(BaseTile).validationFailures
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseTile).baseDocument
...
Returns stringInherited from CanvasDocumentMixin(BaseTile).collectionName
...
Returns abstract.DatabaseBackendInherited from CanvasDocumentMixin(BaseTile).database
...
Returns stringInherited from CanvasDocumentMixin(BaseTile).documentName
...
Returns booleanInherited from CanvasDocumentMixin(BaseTile).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from CanvasDocumentMixin(BaseTile).hierarchy
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseTile).implementation
...
Returns string[]Inherited from CanvasDocumentMixin(BaseTile).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseTile._configure
...
Inherited from BaseTile._configure
...
Returns null | stringInherited from BaseTile._getParentCollection
...
Inherited from BaseTile._getParentCollection
...
Inherited from BaseTile.canUserModify
...
Inherited from BaseTile.createEmbeddedDocuments
...
Inherited from BaseTile.delete
...
SeeDocument.deleteDocuments
Inherited from BaseTile.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseTile.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseTile.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseTile.getFlag
...
Inherited from BaseTile.getUserLevel
...
Inherited from BaseTile.migrateSystemData
...
Returns voidInherited from BaseTile.reset
...
Inherited from BaseTile.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseTile.testUserPermission
...
Inherited from BaseTile.toJSON
...
Inherited from BaseTile.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseTile.traverseEmbeddedDocuments
...
Inherited from BaseTile.traverseEmbeddedDocuments
...
Inherited from BaseTile.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseTile.update
...
SeeDocument.updateDocuments
Inherited from BaseTile.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseTile.updateSource
...
Inherited from BaseTile.validate
...
Returns voidInherited from BaseTile._initialize
...
Inherited from BaseTile._initialize
...
Inherited from BaseTile._initializeSource
...
`data`Inherited from BaseTile._initializeSource
...
Returns voidInherited from BaseTile._onCreate
...
Inherited from BaseTile._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseTile._onDelete
...
Inherited from BaseTile._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseTile._onUpdate
...
Inherited from BaseTile._onUpdate
...
Inherited from BaseTile._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseTile._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseTile._preUpdate
...
Inherited from BaseTile._addDataFieldMigration
...
Returns voidInherited from BaseTile._addDataFieldShim
...
Inherited from BaseTile._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseTile._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseTile._addDataFieldShims
...
Returns voidInherited from BaseTile._clearFieldsRecusively
...
Inherited from BaseTile._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseTile._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseTile._initializationOrder
...
Returns voidInherited from BaseTile._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseTile._logDataFieldMigration
...
Inherited from BaseTile.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseTile.cleanData
...
`source`Inherited from BaseTile.cleanData
...
Inherited from BaseTile.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseTile.create
...
Inherited from BaseTile.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseTile.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    alpha: AlphaField;    elevation: NumberField;    flags: DocumentFlagsField;    height: NumberField;    hidden: BooleanField;    locked: BooleanField;    occlusion: SchemaField;    restrictions: SchemaField;    rotation: AngleField;    sort: NumberField;    texture: TextureData;    video: SchemaField;    width: NumberField;    x: NumberField;    y: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    alpha: AlphaField;    elevation: NumberField;    flags: DocumentFlagsField;    height: NumberField;    hidden: BooleanField;    locked: BooleanField;    occlusion: SchemaField;    restrictions: SchemaField;    rotation: AngleField;    sort: NumberField;    texture: TextureData;    video: SchemaField;    width: NumberField;    x: NumberField;    y: NumberField;}Inherited from BaseTile.defineSchema
...
Inherited from BaseTile.defineSchema
...
Inherited from BaseTile.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseTile.deleteDocuments
...
Inherited from BaseTile.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseTile.fromSource
...
Inherited from BaseTile.fromSource
...
Inherited from BaseTile.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseTile.getCollectionName
...
Inherited from BaseTile.migrateData
...
`source`Inherited from BaseTile.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseTile.migrateDataSafe
...
`source`Inherited from BaseTile.migrateDataSafe
...
the data argument
Inherited from BaseTile.shimData
...
`data`Inherited from BaseTile.shimData
...
Inherited from BaseTile.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseTile.updateDocuments
...
Inherited from BaseTile.validateJoint
...
Returns Promise<void>Inherited from BaseTile._onCreateOperation
...
Inherited from BaseTile._onCreateOperation
...
Returns Promise<void>Inherited from BaseTile._onDeleteOperation
...
Inherited from BaseTile._onDeleteOperation
...
Returns Promise<void>Inherited from BaseTile._onUpdateOperation
...
Inherited from BaseTile._onUpdateOperation
...
Inherited from BaseTile._preCreateOperation
...
Inherited from BaseTile._preDeleteOperation
...
Inherited from BaseTile._preUpdateOperation
