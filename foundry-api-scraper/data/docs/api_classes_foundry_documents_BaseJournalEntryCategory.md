...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseJournalEntryCategory.html
...
- DocumentBaseJournalEntryCategorydocuments.JournalEntryCategory
- BaseJournalEntryCategorydocuments.JournalEntryCategory
...
- new BaseJournalEntryCategory(    data?: Partial<JournalEntryCategoryData>,    options?: DocumentConstructionContext,): BaseJournalEntryCategoryParametersOptionaldata: Partial<JournalEntryCategoryData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseJournalEntryCategoryInherited from Document.constructor
...
`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    flags: DocumentFlagsField;    name: StringField;    sort: IntegerSortField;}Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    flags: DocumentFlagsField;    name: StringField;    sort: IntegerSortField;}Overrides Document.defineSchema
