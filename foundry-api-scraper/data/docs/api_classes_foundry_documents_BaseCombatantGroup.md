# BaseCombatantGroup | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BaseCombatantGroup.html
...
- DocumentBaseCombatantGroupdocuments.CombatantGroup
- BaseCombatantGroupdocuments.CombatantGroup
...
- new BaseCombatantGroup(    data?: Partial<CombatantGroupData>,    options?: DocumentConstructionContext,): BaseCombatantGroupParametersOptionaldata: Partial<CombatantGroupData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseCombatantGroupInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    flags: DocumentFlagsField;    img: FilePathField;    initiative: NumberField;    name: StringField;    ownership: DocumentOwnershipField;    system: TypeDataField;    type: DocumentTypeField;}Overrides Document.defineSchema
