...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseCombat.html
...
- DocumentBaseCombatdocuments.Combat
- BaseCombatdocuments.Combat
- documents.Combat
...
- new BaseCombat(    data?: Partial<CombatData>,    options?: DocumentConstructionContext,): BaseCombatParametersOptionaldata: Partial<CombatData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseCombatInherited from Document.constructor
