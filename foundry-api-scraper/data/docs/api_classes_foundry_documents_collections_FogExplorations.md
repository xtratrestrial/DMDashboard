...
Source: https://foundryvtt.com/api/classes/foundry.documents.collections.FogExplorations.html
...
foundry.documents.FogExploration: The FogExploration document


#### Hierarchy (View Summary)

- WorldCollectionFogExplorations
- FogExplorations
...
- new FogExplorations(data?: object[]): FogExplorationsParametersdata: object[] = []An array of data objects from which to create document instances
Returns FogExplorationsInherited from WorldCollection.constructor
...
`Static`- _activateSocketListeners(socket: Socket): voidInternalActivate Socket event listeners to handle for fog resets
Parameterssocket: SocketThe active web socket connection
Returns void
- socket: SocketThe active web socket connection

`Internal`Activate Socket event listeners to handle for fog resets
