# BaseRollTable | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BaseRollTable.html
...
- DocumentBaseRollTabledocuments.RollTable
- BaseRollTabledocuments.RollTable
- documents.RollTable
...
- new BaseRollTable(    data?: Partial<RollTableData>,    options?: DocumentConstructionContext,): BaseRollTableParametersOptionaldata: Partial<RollTableData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseRollTableInherited from Document.constructor
