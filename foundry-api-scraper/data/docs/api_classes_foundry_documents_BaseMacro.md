# BaseMacro | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BaseMacro.html
...
- DocumentBaseMacrodocuments.Macro
- BaseMacrodocuments.Macro
- documents.Macro
...
- new BaseMacro(    data?: Partial<MacroData>,    options?: DocumentConstructionContext,): BaseMacroParametersOptionaldata: Partial<MacroData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseMacroInherited from Document.constructor
...
`Static`- validateJoint(data: any): voidParametersdata: anyReturns voidOverrides Document.validateJoint
- data: any
