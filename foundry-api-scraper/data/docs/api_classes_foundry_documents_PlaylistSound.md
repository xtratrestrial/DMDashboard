...
Source: https://foundryvtt.com/api/classes/foundry.documents.PlaylistSound.html
...
- foundry.documents.Playlist: The Playlist document which contains PlaylistSound embedded
documents
- foundry.applications.sheets.PlaylistSoundConfig: The PlaylistSound configuration
application
- foundry.audio.Sound   The Sound API which manages web audio playback


#### Hierarchy (View Summary)

- BasePlaylistSound<this>PlaylistSound
- PlaylistSound
...
- new PlaylistSound(    data?: Partial<PlaylistSoundData>,    options?: DocumentConstructionContext,): documents.PlaylistSoundParametersOptionaldata: Partial<PlaylistSoundData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.PlaylistSoundInherited from BasePlaylistSound.constructor
...
#### Returns documents.PlaylistSound

Inherited from BasePlaylistSound.constructor
...
Inherited from BasePlaylistSound._source
...
Inherited from BasePlaylistSound.parent
...
Inherited from BasePlaylistSound._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BasePlaylistSound.LOCALIZATION_PREFIXES
...
Inherited from BasePlaylistSound.metadata


### StaticVOLUME_DEBOUNCE_MS

`Static`The debounce tolerance for processing rapid volume changes into database updates in milliseconds
...
Returns anyInherited from ClientDocumentMixin(BasePlaylistSound).compendium
...
- get context(): undefined | AudioContextThe audio context within which this sound is played.
...
- get effectiveVolume(): numberThe effective volume at which this playlist sound is played, incorporating the global playlist volume setting.
Returns number
...
- get fadeDuration(): numberDetermine the fade-in length:
...
Returns null | stringInherited from ClientDocumentMixin(BasePlaylistSound).id
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylistSound).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylistSound).invalid
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylistSound).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BasePlaylistSound).schema
...
Returns stringInherited from ClientDocumentMixin(BasePlaylistSound).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BasePlaylistSound).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BasePlaylistSound).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BasePlaylistSound).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BasePlaylistSound).database
...
Returns stringInherited from ClientDocumentMixin(BasePlaylistSound).documentName
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylistSound).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BasePlaylistSound).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BasePlaylistSound).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BasePlaylistSound).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BasePlaylistSound._configure
...
Returns null | stringInherited from BasePlaylistSound._getParentCollection
...
Inherited from BasePlaylistSound._getParentCollection
...
Returns voidOverrides BasePlaylistSound._onDelete
...
userId: anyThe id of the User requesting the document update
Returns voidOverrides BasePlaylistSound._onUpdate
...
- load(): Promise<void>Load the audio for this sound for the current client.
...
Returns voidInherited from BasePlaylistSound.reset
...
- sync(): voidSynchronize playback for this particular PlaylistSound instance.
Returns void
...
Returns Generator<any, void, any>YieldsInherited from BasePlaylistSound.traverseEmbeddedDocuments
...
### Protected_cancelFadeOut

`Protected`- _cancelFadeOut(): voidProtectedCancel any pending fade-out on the current sound.
Returns void

`Protected`Cancel any pending fade-out on the current sound.
...
`Protected`- _createSound(): anyProtectedCreate a Sound used to play this PlaylistSound document
Returns any

`Protected`Create a Sound used to play this PlaylistSound document
...
Returns voidInherited from BasePlaylistSound._initialize
...
`data`Inherited from BasePlaylistSound._initializeSource
...
Returns voidInherited from BasePlaylistSound._onCreate
...
`Protected`- _onEnd(): Promise<any>ProtectedSpecial handling that occurs when a PlaylistSound reaches the natural conclusion of its playback.
Returns Promise<any>

`Protected`Special handling that occurs when a PlaylistSound reaches the natural conclusion of its playback.
...
`Protected`- _onStart(): Promise<any>ProtectedSpecial handling that occurs when playback of a PlaylistSound is started.
Returns Promise<any>

`Protected`Special handling that occurs when playback of a PlaylistSound is started.
...
`Protected`- _onStop(): Promise<void>ProtectedSpecial handling that occurs when a PlaylistSound is manually stopped before its natural conclusion.
Returns Promise<void>

`Protected`Special handling that occurs when a PlaylistSound is manually stopped before its natural conclusion.
...
### Protected_scheduleFadeOut

`Protected`- _scheduleFadeOut(): voidProtectedschedule the fade-out that should occur when repeat is off.
Does nothing if the sound is set to repeat or has no finite duration.
Returns void

`Protected`schedule the fade-out that should occur when repeat is off.
Does nothing if the sound is set to repeat or has no finite duration.
...
Inherited from BasePlaylistSound._addDataFieldMigration
...
Returns voidInherited from BasePlaylistSound._addDataFieldShim
...
Inherited from BasePlaylistSound._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BasePlaylistSound._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BasePlaylistSound._addDataFieldShims
...
Returns voidInherited from BasePlaylistSound._clearFieldsRecusively
...
Inherited from BasePlaylistSound._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BasePlaylistSound._initializationOrder
...
Returns voidInherited from BasePlaylistSound._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BasePlaylistSound._logDataFieldMigration
...
`source`Inherited from BasePlaylistSound.cleanData
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BasePlaylistSound.create
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BasePlaylistSound.createDocuments
...
Returns {    _id: DocumentIdField;    channel: StringField;    description: StringField;    fade: NumberField;    flags: DocumentFlagsField;    name: StringField;    path: FilePathField;    pausedTime: NumberField;    playing: BooleanField;    repeat: BooleanField;    sort: IntegerSortField;    volume: AlphaField;}Inherited from BasePlaylistSound.defineSchema
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BasePlaylistSound.deleteDocuments
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BasePlaylistSound.fromSource
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BasePlaylistSound.getCollectionName
...
`source`Inherited from BasePlaylistSound.migrateData
...
`source`Inherited from BasePlaylistSound.migrateDataSafe
...
`data`Inherited from BasePlaylistSound.shimData
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BasePlaylistSound.updateDocuments
...
Returns Promise<void>Inherited from BasePlaylistSound._onCreateOperation
...
Returns Promise<void>Inherited from BasePlaylistSound._onDeleteOperation
...
Returns Promise<void>Inherited from BasePlaylistSound._onUpdateOperation
