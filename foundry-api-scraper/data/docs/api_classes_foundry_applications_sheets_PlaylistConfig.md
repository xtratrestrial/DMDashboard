# PlaylistConfig | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.PlaylistConfig.html
...
- DocumentSheetV2<this>PlaylistConfig
- PlaylistConfig
...
- new PlaylistConfig(options: any, ...args: any[]): PlaylistConfigParametersoptions: any...args: any[]Returns PlaylistConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- _prepareContext(    options: any,): Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        channels: {};        milliseconds: string;        modes: {};        sortModes: {};    },>Parametersoptions: anyReturns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        channels: {};        milliseconds: string;        modes: {};        sortModes: {};    },>Overrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareContext
- options: any
...
#### Returns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        channels: {};        milliseconds: string;        modes: {};        sortModes: {};    },>
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<PlaylistConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<PlaylistConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<PlaylistConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<PlaylistConfig>A Promise which resolves to the rendered Application instance
