...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.ItemSheetV2.html
...
- new ItemSheetV2(options: any, ...args: any[]): ItemSheetV2Parametersoptions: any...args: any[]Returns ItemSheetV2Inherit DocInherited from DocumentSheetV2.constructor
- options: any
- ...args: any[]
...
- get actor(): null | documents.ActorThe Actor instance which owns this Item, if any.
...
- get item(): documents.ItemThe Item document managed by this sheet.
...
- _onRender(context: any, options: any): Promise<void>Parameterscontext: anyoptions: anyReturns Promise<void>Inherit DocInherited from DocumentSheetV2._onRender
- context: any
- options: any
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<ItemSheetV2>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<ItemSheetV2>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<ItemSheetV2>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<ItemSheetV2>A Promise which resolves to the rendered Application instance
...
Returns ApplicationHeaderControlsEntry[]Inherited from DocumentSheetV2._getHeaderControls
