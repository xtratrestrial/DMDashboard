...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.AmbientLightConfig.html
...
- DocumentSheetV2<this>AmbientLightConfig
- AmbientLightConfig
...
- new AmbientLightConfig(options: any, ...args: any[]): AmbientLightConfigParametersoptions: any...args: any[]Returns AmbientLightConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- _prepareContext(    options: any,): Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: (            | { action: string; icon: string; label: string; type: string }            | { action?: undefined; icon: string; label: string; type: string }        )[];        colorationTechniques: Record<string, ShaderTechnique>;        document: AmbientLightDocument;        gridUnits: any;        isDarkness: any;        light: AmbientLightDocument;        lightAnimations:            | LightSourceAnimationConfig            | DarknessSourceAnimationConfig;        source: AmbientLightData;    },>Parametersoptions: anyReturns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: (            | { action: string; icon: string; label: string; type: string }            | { action?: undefined; icon: string; label: string; type: string }        )[];        colorationTechniques: Record<string, ShaderTechnique>;        document: AmbientLightDocument;        gridUnits: any;        isDarkness: any;        light: AmbientLightDocument;        lightAnimations:            | LightSourceAnimationConfig            | DarknessSourceAnimationConfig;        source: AmbientLightData;    },>Inherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareContext
- options: any
...
#### Returns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: (            | { action: string; icon: string; label: string; type: string }            | { action?: undefined; icon: string; label: string; type: string }        )[];        colorationTechniques: Record<string, ShaderTechnique>;        document: AmbientLightDocument;        gridUnits: any;        isDarkness: any;        light: AmbientLightDocument;        lightAnimations:            | LightSourceAnimationConfig            | DarknessSourceAnimationConfig;        source: AmbientLightData;    },>
...
- changeTab(...args: any[]): voidParameters...args: any[]Returns voidInherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2).changeTab
- ...args: any[]
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<AmbientLightConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<AmbientLightConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<AmbientLightConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<AmbientLightConfig>A Promise which resolves to the rendered Application instance
...
### Protected_previewChanges

`Protected`- _previewChanges(change?: object): voidProtectedPreview changes to the AmbientLight document as if they were true document updates.
ParametersOptionalchange: objectA change to preview.
Returns void
- Optionalchange: objectA change to preview.

`Protected`Preview changes to the AmbientLight document as if they were true document updates.
...
### Protected_resetPreview

`Protected`- _resetPreview(): voidProtectedRestore the true data for the AmbientLight document when the form is submitted or closed.
Returns void

`Protected`Restore the true data for the AmbientLight document when the form is submitted or closed.
