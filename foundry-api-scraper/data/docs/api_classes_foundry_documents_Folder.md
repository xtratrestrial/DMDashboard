...
Source: https://foundryvtt.com/api/classes/foundry.documents.Folder.html
...
- foundry.documents.collections.Folders: The world-level collection of Folder documents
- foundry.applications.sheets.FolderConfig: The Folder configuration application


#### Hierarchy (View Summary)

- BaseFolder<this>Folder
- Folder
...
- new Folder(    data?: Partial<FolderData>,    options?: DocumentConstructionContext,): documents.FolderParametersOptionaldata: Partial<FolderData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.FolderInherited from BaseFolder.constructor
- Optionaldata: Partial<FolderData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseFolder.constructor
...
Inherited from BaseFolder._source


### children

An array of nodes representing the children of this one. This differs from the results of
Folder.getSubfolders, which reports the subset of child Folders displayed to the current User in the UI.
...
Inherited from BaseFolder.parent
...
Inherited from BaseFolder._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseFolder.LOCALIZATION_PREFIXES
...
Inherited from BaseFolder.metadata


### StaticSORTING_MODES

`Static`Allow folder sorting modes

Inherited from BaseFolder.SORTING_MODES
...
- get ancestors(): documents.Folder[]Return the list of ancestors of this folder, starting with the parent.
Returns documents.Folder[]
...
Returns anyInherited from ClientDocumentMixin(BaseFolder).compendium
...
- get contents(): any[]The array of the Document instances which are contained within this Folder,
...
- get documentClass(): FunctionThe reference to the Document type which is contained within this Folder.
Returns Function
...
- get documentCollection(): undefined | Collection<any, any> | WorldCollectionThe reference to the WorldCollection instance which provides Documents to this Folder,
...
Returns undefined | Collection<any, any> | WorldCollection
...
- get expanded(): booleanReturn whether the folder is currently expanded within the sidebar interface.
Returns boolean
...
Returns null | stringInherited from ClientDocumentMixin(BaseFolder).id
...
- get inCompendium(): booleanReturns booleanOverrides ClientDocumentMixin(BaseFolder).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseFolder).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseFolder).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseFolder).schema
...
Returns stringInherited from ClientDocumentMixin(BaseFolder).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseFolder).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseFolder).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseFolder).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseFolder).database
...
Returns stringInherited from ClientDocumentMixin(BaseFolder).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseFolder).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseFolder).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseFolder).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseFolder).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseFolder._configure
...
Inherited from BaseFolder._configure
...
Returns null | stringInherited from BaseFolder._getParentCollection
...
Inherited from BaseFolder._getParentCollection


### _preCreate

- _preCreate(data: any, options: any, user: any): Promise<boolean | void>Pre-process a creation operation for a single Document instance. Pre-operation events only occur for the client
...
Overrides BaseFolder._preCreate
...
Inherited from BaseFolder.canUserModify
...
Inherited from BaseFolder.clone
...
Inherited from BaseFolder.createEmbeddedDocuments
...
Inherited from BaseFolder.delete
...
SeeDocument.deleteDocuments
Inherited from BaseFolder.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
- exportDialog(    pack: null | string,    options?: { keepFolders?: boolean; keepId?: boolean; merge?: boolean },): Promise<void>Provide a dialog form that allows for exporting the contents of a Folder into an eligible Compendium pack.
Parameterspack: null | stringA pack ID to set as the default choice in the select input
Optionaloptions: { keepFolders?: boolean; keepId?: boolean; merge?: boolean } = {}Additional options which customize how content is exported
OptionalkeepFolders?: booleanRetain the existing Folder structure
OptionalkeepId?: booleanRetain the original _id attribute when updating an document
...
- pack: null | stringA pack ID to set as the default choice in the select input
- Optionaloptions: { keepFolders?: boolean; keepId?: boolean; merge?: boolean } = {}Additional options which customize how content is exported
OptionalkeepFolders?: booleanRetain the existing Folder structure
OptionalkeepId?: booleanRetain the original _id attribute when updating an document
Optionalmerge?: booleanUpdate existing entries in the Compendium pack, matching by name
...
`Optional`Additional options which customize how content is exported
...
##### OptionalkeepFolders?: boolean

`Optional`Retain the existing Folder structure


##### OptionalkeepId?: boolean

`Optional`Retain the original _id attribute when updating an document


##### Optionalmerge?: boolean

`Optional`Update existing entries in the Compendium pack, matching by name
...
- exportToCompendium(    pack: CompendiumCollection,    options?: {        folder?: string;        keepFolders?: boolean;        keepId?: boolean;        updateByName?: boolean;    },): Promise<CompendiumCollection>Export all Documents contained in this Folder to a given Compendium pack.
Optionally update existing Documents within the Pack by name, otherwise append all new entries.
Parameterspack: CompendiumCollectionA Compendium pack to which the documents will be exported
Optionaloptions: {    folder?: string;    keepFolders?: boolean;    keepId?: boolean;    updateByName?: boolean;} = {}Additional options which customize how content is exported.
See ClientDocumentMixin#toCompendium.
Optionalfolder?: stringA target folder id to which the documents will be exported
OptionalkeepFolders?: booleanRetain the existing Folder structure
OptionalkeepId?: booleanRetain the original _id attribute when updating an document
OptionalupdateByName?: booleanUpdate existing entries in the Compendium pack, matching by name
Returns Promise<CompendiumCollection>The updated Compendium Collection instance
- pack: CompendiumCollectionA Compendium pack to which the documents will be exported
- Optionaloptions: {    folder?: string;    keepFolders?: boolean;    keepId?: boolean;    updateByName?: boolean;} = {}Additional options which customize how content is exported.
See ClientDocumentMixin#toCompendium.
Optionalfolder?: stringA target folder id to which the documents will be exported
OptionalkeepFolders?: booleanRetain the existing Folder structure
...
`Optional`A target folder id to which the documents will be exported
...
Inherited from BaseFolder.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseFolder.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseFolder.getFlag
...
- getParentFolders(): documents.Folder[]Get the Folder documents which are parent folders of the current folder or any if its parents.
Returns documents.Folder[]An array of Folder documents which are parent folders of this one
...
- getSubfolders(recursive?: boolean): documents.Folder[]Get the Folder documents which are sub-folders of the current folder, either direct children or recursively.
ParametersOptionalrecursive: boolean = falseIdentify child folders recursively, if false only direct children are returned
Returns documents.Folder[]An array of Folder documents which are subfolders of this one
- Optionalrecursive: boolean = falseIdentify child folders recursively, if false only direct children are returned
...
`Optional`Identify child folders recursively, if false only direct children are returned
...
Inherited from BaseFolder.getUserLevel
...
Inherited from BaseFolder.migrateSystemData
...
Returns voidInherited from BaseFolder.reset
...
Inherited from BaseFolder.reset
...
Inherited from BaseFolder.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseFolder.testUserPermission
...
Inherited from BaseFolder.toJSON
...
Inherited from BaseFolder.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseFolder.traverseEmbeddedDocuments
...
Inherited from BaseFolder.traverseEmbeddedDocuments
...
Inherited from BaseFolder.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseFolder.update
...
SeeDocument.updateDocuments
Inherited from BaseFolder.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseFolder.updateSource
...
Inherited from BaseFolder.validate
...
Returns voidInherited from BaseFolder._initialize
...
Inherited from BaseFolder._initialize
...
Inherited from BaseFolder._initializeSource
...
`data`Inherited from BaseFolder._initializeSource
...
Returns voidInherited from BaseFolder._onCreate
...
Inherited from BaseFolder._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseFolder._onDelete
...
Inherited from BaseFolder._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseFolder._onUpdate
...
Inherited from BaseFolder._onUpdate
...
Inherited from BaseFolder._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseFolder._preUpdate
...
Inherited from BaseFolder._addDataFieldMigration
...
Returns voidInherited from BaseFolder._addDataFieldShim
...
Inherited from BaseFolder._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseFolder._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseFolder._addDataFieldShims
...
Returns voidInherited from BaseFolder._clearFieldsRecusively
...
Inherited from BaseFolder._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseFolder._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseFolder._initializationOrder
...
Returns voidInherited from BaseFolder._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseFolder._logDataFieldMigration
...
Inherited from BaseFolder.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseFolder.cleanData
...
`source`Inherited from BaseFolder.cleanData
...
Inherited from BaseFolder.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseFolder.create


### StaticcreateDialog

`Static`- createDialog(data?: {}, createOptions?: {}, dialogOptions?: {}): Promise<any>Parametersdata: {} = {}createOptions: {} = {}dialogOptions: {} = {}Returns Promise<any>Overrides ClientDocumentMixin(BaseFolder).createDialog
- data: {} = {}
- createOptions: {} = {}
- dialogOptions: {} = {}
...
Inherited from BaseFolder.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseFolder.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    color: ColorField;    description: HTMLField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    name: StringField;    sort: IntegerSortField;    sorting: StringField;    type: DocumentTypeField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    color: ColorField;    description: HTMLField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    name: StringField;    sort: IntegerSortField;    sorting: StringField;    type: DocumentTypeField;}Inherited from BaseFolder.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    color: ColorField;    description: HTMLField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    name: StringField;    sort: IntegerSortField;    sorting: StringField;    type: DocumentTypeField;}

Inherited from BaseFolder.defineSchema
...
Inherited from BaseFolder.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseFolder.deleteDocuments
...
Inherited from BaseFolder.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseFolder.fromSource
...
Inherited from BaseFolder.fromSource


### Staticget

`Static`- get(    documentId: any,    options?: {},): null | Document<object, DocumentConstructionContext>ParametersdocumentId: anyoptions: {} = {}Returns null | Document<object, DocumentConstructionContext>Inherited from BaseFolder.get
- documentId: any
- options: {} = {}
...
Inherited from BaseFolder.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseFolder.getCollectionName
...
Inherited from BaseFolder.migrateData
...
`source`Inherited from BaseFolder.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseFolder.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseFolder.migrateDataSafe
...
the data argument
Inherited from BaseFolder.shimData
...
`data`Inherited from BaseFolder.shimData
...
Inherited from BaseFolder.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseFolder.updateDocuments


### StaticvalidateJoint

`Static`- validateJoint(data: any): voidEvaluate joint validation rules which apply validation conditions across multiple fields of the model.
Field-specific validation rules should be defined as part of the DataSchema for the model.
This method allows for testing aggregate rules which impose requirements on the overall model.
Parametersdata: anyCandidate data for the model
Returns voidThrowsAn error if a validation failure is detected
Inherited from BaseFolder.validateJoint
- data: anyCandidate data for the model
...
Returns Promise<void>Inherited from BaseFolder._onCreateOperation
...
Inherited from BaseFolder._onCreateOperation
...
Returns Promise<void>Inherited from BaseFolder._onDeleteOperation
...
Inherited from BaseFolder._onDeleteOperation
...
Returns Promise<void>Inherited from BaseFolder._onUpdateOperation
...
Inherited from BaseFolder._onUpdateOperation
...
Inherited from BaseFolder._preCreateOperation
...
Inherited from BaseFolder._preDeleteOperation
...
Inherited from BaseFolder._preUpdateOperation
