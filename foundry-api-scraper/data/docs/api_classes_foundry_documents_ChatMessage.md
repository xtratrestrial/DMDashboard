...
- hookEvents.renderChatMessageHTML
...
foundry.documents.collections.ChatMessages: The world-level collection of ChatMessage
documents
...
- new ChatMessage(    data?: Partial<ChatMessageData>,    options?: DocumentConstructionContext,): documents.ChatMessageParametersOptionaldata: Partial<ChatMessageData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.ChatMessageInherited from BaseChatMessage.constructor
...
#### Returns documents.ChatMessage

Inherited from BaseChatMessage.constructor
...
Inherited from BaseChatMessage._source
...
Inherited from BaseChatMessage.parent
...
Inherited from BaseChatMessage._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseChatMessage.LOCALIZATION_PREFIXES
...
Inherited from BaseChatMessage.metadata
...
- get alias(): stringReturn the recommended String alias for this message.
...
Returns anyInherited from ClientDocumentMixin(BaseChatMessage).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseChatMessage).id
...
Returns booleanInherited from ClientDocumentMixin(BaseChatMessage).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseChatMessage).invalid
...
- get isAuthor(): booleanIs the current User the author of this message?
Returns boolean
...
- get isContentVisible(): booleanReturn whether the content of the message is visible to the current user.
...
Returns booleanInherited from ClientDocumentMixin(BaseChatMessage).isEmbedded
...
- get isRoll(): booleanDoes this message contain dice rolls?
Returns boolean
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseChatMessage).schema
...
- get speakerActor(): null | documents.ActorThe Actor which represents the speaker of this message (if any).
...
Returns stringInherited from ClientDocumentMixin(BaseChatMessage).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseChatMessage).validationFailures
...
- get visible(): booleanReturn whether the ChatMessage is visible to the current User.
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseChatMessage).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseChatMessage).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseChatMessage).database
...
Returns stringInherited from ClientDocumentMixin(BaseChatMessage).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseChatMessage).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseChatMessage).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseChatMessage).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseChatMessage).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseChatMessage._configure
...
Inherited from BaseChatMessage._configure
...
Returns null | stringInherited from BaseChatMessage._getParentCollection
...
Inherited from BaseChatMessage._getParentCollection
...
Returns voidOverrides BaseChatMessage._onCreate
...
Overrides BaseChatMessage._onCreate
...
userId: anyThe id of the User requesting the document update
Returns voidOverrides BaseChatMessage._onDelete
...
Overrides BaseChatMessage._onDelete
...
userId: anyThe id of the User requesting the document update
Returns voidOverrides BaseChatMessage._onUpdate
...
Overrides BaseChatMessage._onUpdate
...
Overrides BaseChatMessage._preCreate
- data: anyThe initial data object provided to the document creation request
- options: anyAdditional options which modify the creation request
- user: anyThe User requesting the document creation
...
- applyRollMode(    rollMode: "publicroll" | "gmroll" | "blindroll" | "selfroll" | "roll",): voidUpdate the data of a ChatMessage instance to apply a requested roll mode.
This function calls ChatMessage.applyRollMode and updates the source of the ChatMessage.
ParametersrollMode: "publicroll" | "gmroll" | "blindroll" | "selfroll" | "roll"The roll mode to apply to this message data. "roll" is the current roll mode.
Returns void
...
Inherited from BaseChatMessage.canUserModify
...
Inherited from BaseChatMessage.clone
...
Inherited from BaseChatMessage.createEmbeddedDocuments
...
Inherited from BaseChatMessage.delete
...
SeeDocument.deleteDocuments
Inherited from BaseChatMessage.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
- export(): stringExport the content of the chat message into a standardized log format
Returns string
...
Inherited from BaseChatMessage.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseChatMessage.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseChatMessage.getFlag
...
- getRollData(): objectObtain a data object used to evaluate any dice rolls associated with this particular chat message
Returns object
...
Inherited from BaseChatMessage.getUserLevel
...
Inherited from BaseChatMessage.migrateSystemData
...
- renderHTML(    options?: { canClose?: boolean; canDelete?: boolean },): Promise<HTMLElement>Render the HTML for the ChatMessage which should be added to the log
ParametersOptionaloptions: { canClose?: boolean; canDelete?: boolean } = {}Additional options passed to the Handlebars template.
OptionalcanClose?: booleanRender a close button for dismissing chat card notifications.
OptionalcanDelete?: booleanRender a delete button. By default, this is true for GM users.
Returns Promise<HTMLElement>
- Optionaloptions: { canClose?: boolean; canDelete?: boolean } = {}Additional options passed to the Handlebars template.
OptionalcanClose?: booleanRender a close button for dismissing chat card notifications.
OptionalcanDelete?: booleanRender a delete button. By default, this is true for GM users.
- OptionalcanClose?: booleanRender a close button for dismissing chat card notifications.
- OptionalcanDelete?: booleanRender a delete button. By default, this is true for GM users.
...
`Optional`Additional options passed to the Handlebars template.
...
`Optional`Render a close button for dismissing chat card notifications.


##### OptionalcanDelete?: boolean

`Optional`Render a delete button. By default, this is true for GM users.
...
Returns voidInherited from BaseChatMessage.reset
...
Inherited from BaseChatMessage.reset
...
Inherited from BaseChatMessage.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseChatMessage.testUserPermission
...
Inherited from BaseChatMessage.toJSON
...
Inherited from BaseChatMessage.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseChatMessage.traverseEmbeddedDocuments
...
Inherited from BaseChatMessage.traverseEmbeddedDocuments
...
Inherited from BaseChatMessage.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseChatMessage.update
...
SeeDocument.updateDocuments
Inherited from BaseChatMessage.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseChatMessage.updateSource
...
Inherited from BaseChatMessage.validate
...
Returns voidInherited from BaseChatMessage._initialize
...
Inherited from BaseChatMessage._initialize
...
Inherited from BaseChatMessage._initializeSource
...
`data`Inherited from BaseChatMessage._initializeSource
...
Inherited from BaseChatMessage._preDelete
...
Inherited from BaseChatMessage._preUpdate
...
Inherited from BaseChatMessage._addDataFieldMigration
...
Returns voidInherited from BaseChatMessage._addDataFieldShim
...
Inherited from BaseChatMessage._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseChatMessage._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseChatMessage._addDataFieldShims
...
Returns voidInherited from BaseChatMessage._clearFieldsRecusively
...
Inherited from BaseChatMessage._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseChatMessage._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseChatMessage._initializationOrder
...
Returns voidInherited from BaseChatMessage._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseChatMessage._logDataFieldMigration


### StaticapplyRollMode

`Static`- applyRollMode(    chatData: object,    rollMode: "publicroll" | "gmroll" | "blindroll" | "selfroll" | "roll",): objectTransform a provided object of ChatMessage data by applying a certain roll mode to the data object.
...
ParameterschatData: objectThe object of ChatMessage data
rollMode: "publicroll" | "gmroll" | "blindroll" | "selfroll" | "roll"The roll mode to apply to this message data. "roll" is the current roll mode.
Returns objectThe modified ChatMessage data with the roll mode applied
- Public: whisper is set to [] and blind is set to false.
- Self: whisper is set to [game.user.id] and blind is set to false.
- Private: whisper is set to the GM users unless whisper is nonempty and blind is set to false.
- Blind: whisper is set to the GM users unless whisper is nonempty and blind is set to true.
- chatData: objectThe object of ChatMessage data
- rollMode: "publicroll" | "gmroll" | "blindroll" | "selfroll" | "roll"The roll mode to apply to this message data. "roll" is the current roll mode.
...
`whisper``[]``blind``false``whisper``[game.user.id]``blind``false``whisper``whisper``blind``false``whisper``whisper``blind``true`
#### Parameters
...
Inherited from BaseChatMessage.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseChatMessage.cleanData
...
`source`Inherited from BaseChatMessage.cleanData
...
Inherited from BaseChatMessage.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseChatMessage.create
...
Inherited from BaseChatMessage.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseChatMessage.createDocuments
...
Inherited from BaseChatMessage.defineSchema
...
Inherited from BaseChatMessage.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseChatMessage.deleteDocuments
...
Inherited from BaseChatMessage.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseChatMessage.fromSource
...
Inherited from BaseChatMessage.fromSource
...
Inherited from BaseChatMessage.get
...
Inherited from BaseChatMessage.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseChatMessage.getCollectionName


### StaticgetSpeaker

`Static`- getSpeaker(    options?: {        actor?: documents.Actor;        alias?: string;        scene?: documents.Scene;        token?: TokenDocument;    },): ChatSpeakerDataAttempt to determine who is the speaking character (and token) for a certain Chat Message
First assume that the currently controlled Token is the speaker
ParametersOptionaloptions: {    actor?: documents.Actor;    alias?: string;    scene?: documents.Scene;    token?: TokenDocument;} = {}Options which affect speaker identification
Optionalactor?: documents.ActorThe Actor who is speaking
Optionalalias?: stringThe name of the speaker to display
Optionalscene?: documents.SceneThe Scene in which the speaker resides
Optionaltoken?: TokenDocumentThe Token who is speaking
Returns ChatSpeakerDataThe identified speaker data
- Optionaloptions: {    actor?: documents.Actor;    alias?: string;    scene?: documents.Scene;    token?: TokenDocument;} = {}Options which affect speaker identification
Optionalactor?: documents.ActorThe Actor who is speaking
Optionalalias?: stringThe name of the speaker to display
Optionalscene?: documents.SceneThe Scene in which the speaker resides
Optionaltoken?: TokenDocumentThe Token who is speaking
...
`Optional`Options which affect speaker identification
...
##### Optionalactor?: documents.Actor

`Optional`The Actor who is speaking


##### Optionalalias?: string

`Optional`The name of the speaker to display


##### Optionalscene?: documents.Scene

`Optional`The Scene in which the speaker resides


##### Optionaltoken?: TokenDocument

`Optional`The Token who is speaking


#### Returns ChatSpeakerData

The identified speaker data


### StaticgetSpeakerActor

`Static`- getSpeakerActor(speaker: Object): null | documents.ActorObtain an Actor instance which represents the speaker of this message (if any)
Parametersspeaker: ObjectThe speaker data object
Returns null | documents.Actor
- speaker: ObjectThe speaker data object
...
### StaticgetWhisperRecipients

`Static`- getWhisperRecipients(name: string): documents.User[]Given a string whisper target, return an Array of the user IDs which should be targeted for the whisper
Parametersname: stringThe target name of the whisper target
Returns documents.User[]An array of User instances
- name: stringThe target name of the whisper target
...
Inherited from BaseChatMessage.migrateData
...
`source`Inherited from BaseChatMessage.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseChatMessage.migrateDataSafe
...
`source`Inherited from BaseChatMessage.migrateDataSafe
...
the data argument
Inherited from BaseChatMessage.shimData
...
`data`Inherited from BaseChatMessage.shimData
...
Inherited from BaseChatMessage.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseChatMessage.updateDocuments
...
Inherited from BaseChatMessage.validateJoint
...
Returns Promise<void>Inherited from BaseChatMessage._onCreateOperation
...
Inherited from BaseChatMessage._onCreateOperation
...
Returns Promise<void>Inherited from BaseChatMessage._onDeleteOperation
...
Inherited from BaseChatMessage._onDeleteOperation
...
Returns Promise<void>Inherited from BaseChatMessage._onUpdateOperation
...
Inherited from BaseChatMessage._onUpdateOperation
...
Inherited from BaseChatMessage._preCreateOperation
...
Inherited from BaseChatMessage._preDeleteOperation
...
Inherited from BaseChatMessage._preUpdateOperation
