...
Source: https://foundryvtt.com/api/classes/foundry.documents.Cards.html
...
- hookEvents.dealCards
- hookEvents.passCards
- hookEvents.returnCards
...
- foundry.documents.collections.CardStacks: The world-level collection of Cards documents
- foundry.applications.sheets.CardsConfig: The Cards configuration application


#### Hierarchy (View Summary)

- BaseCards<this>Cards
- Cards
...
- new Cards(    data?: Partial<CardsData>,    options?: DocumentConstructionContext,): documents.CardsParametersOptionaldata: Partial<CardsData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.CardsInherited from BaseCards.constructor
...
#### Returns documents.Cards

Inherited from BaseCards.constructor
...
Inherited from BaseCards._source
...
Inherited from BaseCards.parent
...
Inherited from BaseCards._schema
...
Inherited from BaseCards.DEFAULT_ICON


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseCards.LOCALIZATION_PREFIXES
...
Inherited from BaseCards.metadata
...
- get availableCards(): documents.Card[]The Card documents within this stack which are available to be drawn.
Returns documents.Card[]
...
- get canClone(): booleanCan this Cards document be cloned in a duplicate workflow?
Returns boolean
...
Returns anyInherited from ClientDocumentMixin(BaseCards).compendium
...
- get drawnCards(): documents.Card[]The Card documents which belong to this stack but have already been drawn.
Returns documents.Card[]
...
Returns null | stringInherited from ClientDocumentMixin(BaseCards).id
...
Returns booleanInherited from ClientDocumentMixin(BaseCards).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseCards).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseCards).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseCards).schema
...
- get typeLabel(): stringReturns the localized Label for the type of Card Stack this is
Returns string
...
Returns stringInherited from ClientDocumentMixin(BaseCards).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseCards).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseCards).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseCards).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseCards).database
...
Returns stringInherited from ClientDocumentMixin(BaseCards).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseCards).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseCards).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseCards).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseCards).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseCards._configure
...
Inherited from BaseCards._configure
...
Returns null | stringInherited from BaseCards._getParentCollection
...
Inherited from BaseCards._getParentCollection
...
Returns voidInherited from BaseCards._initialize
...
Inherited from BaseCards._initialize
...
Overrides BaseCards._preCreate
...
- _preDelete(options: any, user: any): Promise<boolean | void>Pre-process a deletion operation for a single Document instance. Pre-operation events only occur for the client
which requested the operation.
Parametersoptions: anyAdditional options which modify the deletion request
user: anyThe User requesting the document deletion
Returns Promise<boolean | void>A return value of false indicates the deletion operation should be cancelled.
Overrides BaseCards._preDelete
...
Inherited from BaseCards.canUserModify
...
Inherited from BaseCards.clone
...
Inherited from BaseCards.createEmbeddedDocuments
...
- deal(    to: documents.Cards[],    number?: number,    options?: {        action?: string;        chatNotification?: boolean;        how?: number;        updateData?: object;    },): Promise<documents.Cards>Deal one or more cards from this Cards document to each of a provided array of Cards destinations.
Cards are allocated from the top of the deck in cyclical order until the required number of Cards have been dealt.
Parametersto: documents.Cards[]An array of other Cards documents to which cards are dealt
Optionalnumber: number = 1The number of cards to deal to each other document
Optionaloptions: {    action?: string;    chatNotification?: boolean;    how?: number;    updateData?: object;} = {}Options which modify how the deal operation is performed
Optionalaction?: stringThe name of the action being performed, used as part of the dispatched
Hook event
OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
Optionalhow?: numberHow to draw, a value from CONST.CARD_DRAW_MODES
OptionalupdateData?: objectModifications to make to each Card as part of the deal operation,
for example the displayed face
Returns Promise<documents.Cards>This Cards document after the deal operation has completed
...
`Optional`The number of cards to deal to each other document

`Optional`Options which modify how the deal operation is performed
...
`Optional`The name of the action being performed, used as part of the dispatched
Hook event


##### OptionalchatNotification?: boolean

`Optional`Create a ChatMessage which notifies that this action has occurred


##### Optionalhow?: number

`Optional`How to draw, a value from CONST.CARD_DRAW_MODES


##### OptionalupdateData?: object

`Optional`Modifications to make to each Card as part of the deal operation,
for example the displayed face
...
- dealDialog(): Promise<null | documents.Cards>Display a dialog which prompts the user to deal cards to some number of hand-type Cards documents.
Returns Promise<null | documents.Cards>SeeCards#deal

Display a dialog which prompts the user to deal cards to some number of hand-type Cards documents.


#### Returns Promise<null | documents.Cards>
...
Inherited from BaseCards.delete
...
- deleteDialog(options?: {}): Promise<any>Parametersoptions: {} = {}Returns Promise<any>Inherit Doc
- options: {} = {}
...
SeeDocument.deleteDocuments
Inherited from BaseCards.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
- draw(    from: documents.Cards,    number?: number,    options?: { how?: number; updateData?: object },): Promise<documents.Card[]>Draw one or more cards from some other Cards document.
Parametersfrom: documents.CardsSome other Cards document from which to draw
Optionalnumber: number = 1The number of cards to draw
Optionaloptions: { how?: number; updateData?: object } = {}Options which modify how the draw operation is performed
Optionalhow?: numberHow to draw, a value from CONST.CARD_DRAW_MODES
OptionalupdateData?: objectModifications to make to each Card as part of the draw operation,
for example the displayed face
Returns Promise<documents.Card[]>An array of the Card documents which were drawn
- from: documents.CardsSome other Cards document from which to draw
- Optionalnumber: number = 1The number of cards to draw
- Optionaloptions: { how?: number; updateData?: object } = {}Options which modify how the draw operation is performed
Optionalhow?: numberHow to draw, a value from CONST.CARD_DRAW_MODES
OptionalupdateData?: objectModifications to make to each Card as part of the draw operation,
...
`Optional`The number of cards to draw

`Optional`Options which modify how the draw operation is performed
...
`Optional`Modifications to make to each Card as part of the draw operation,
for example the displayed face


#### Returns Promise<documents.Card[]>
...
- drawDialog(): Promise<null | documents.Card[]>Display a dialog which prompts the user to draw cards from some other deck-type Cards documents.
Returns Promise<null | documents.Card[]>SeeCards#draw

Display a dialog which prompts the user to draw cards from some other deck-type Cards documents.


#### Returns Promise<null | documents.Card[]>
...
Inherited from BaseCards.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseCards.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseCards.getFlag
...
Inherited from BaseCards.getUserLevel
...
Inherited from BaseCards.migrateSystemData
...
- pass(    to: documents.Cards,    ids: string[],    options?: {        action?: string;        chatNotification?: boolean;        updateData?: object;    },): Promise<documents.Card[]>Pass an array of specific Card documents from this document to some other Cards stack.
Parametersto: documents.CardsSome other Cards document that is the destination for the pass operation
ids: string[]The embedded Card ids which should be passed
Optionaloptions: { action?: string; chatNotification?: boolean; updateData?: object } = {}Additional options which modify the pass operation
Optionalaction?: stringThe name of the action being performed, used as part of the dispatched
Hook event
OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
OptionalupdateData?: objectModifications to make to each Card as part of the pass operation,
for example the displayed face
Returns Promise<documents.Card[]>An array of the Card embedded documents created within the destination stack
- to: documents.CardsSome other Cards document that is the destination for the pass operation
- ids: string[]The embedded Card ids which should be passed
- Optionaloptions: { action?: string; chatNotification?: boolean; updateData?: object } = {}Additional options which modify the pass operation
Optionalaction?: stringThe name of the action being performed, used as part of the dispatched
Hook event
...
`Optional`Additional options which modify the pass operation
...
`Optional`Modifications to make to each Card as part of the pass operation,
for example the displayed face
...
- passDialog(): Promise<null | documents.Cards>Display a dialog which prompts the user to pass cards from this document to some other Cards document.
Returns Promise<null | documents.Cards>SeeCards#deal
...
- playDialog(card: documents.Card): Promise<null | documents.Card[]>Display a dialog which prompts the user to play a specific Card to some other Cards document
Parameterscard: documents.CardThe specific card being played as part of this dialog
Returns Promise<null | documents.Card[]>SeeCards#pass
- card: documents.CardThe specific card being played as part of this dialog
...
- recall(    options?: { chatNotification?: boolean; updateData?: object },): Promise<documents.Cards>Recall the Cards stack, retrieving all original cards from other stacks where they may have been drawn if this is a
deck, otherwise returning all the cards in this stack to the decks where they originated.
ParametersOptionaloptions: { chatNotification?: boolean; updateData?: object }Options which modify the recall operation
OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
OptionalupdateData?: objectModifications to make to each Card as part of the recall operation,
for example the displayed face
Returns Promise<documents.Cards>The Cards document after the recall operation has completed.
- Optionaloptions: { chatNotification?: boolean; updateData?: object }Options which modify the recall operation
OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
OptionalupdateData?: objectModifications to make to each Card as part of the recall operation,
for example the displayed face
- OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
...
`Optional`Options which modify the recall operation
...
`Optional`Modifications to make to each Card as part of the recall operation,
for example the displayed face
...
Returns voidInherited from BaseCards.reset
...
Inherited from BaseCards.reset


### resetDialog

- resetDialog(): Promise<null | false | documents.Cards>Display a confirmation dialog for whether the user wishes to reset a Cards stack
Returns Promise<null | false | documents.Cards>SeeCards#recall

Display a confirmation dialog for whether the user wishes to reset a Cards stack


#### Returns Promise<null | false | documents.Cards>
...
Inherited from BaseCards.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
- shuffle(    options?: { chatNotification?: boolean; updateData?: object },): Promise<documents.Cards>Shuffle this Cards stack, randomizing the sort order of all the cards it contains.
ParametersOptionaloptions: { chatNotification?: boolean; updateData?: object } = {}Options which modify how the shuffle operation is performed.
OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
OptionalupdateData?: objectModifications to make to each Card as part of the shuffle operation,
for example the displayed face.
Returns Promise<documents.Cards>The Cards document after the shuffle operation has completed
- Optionaloptions: { chatNotification?: boolean; updateData?: object } = {}Options which modify how the shuffle operation is performed.
OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
OptionalupdateData?: objectModifications to make to each Card as part of the shuffle operation,
for example the displayed face.
- OptionalchatNotification?: booleanCreate a ChatMessage which notifies that this action has occurred
...
`Optional`Options which modify how the shuffle operation is performed.
...
`Optional`Modifications to make to each Card as part of the shuffle operation,
for example the displayed face.
...
Inherited from BaseCards.testUserPermission
...
Inherited from BaseCards.toJSON
...
Inherited from BaseCards.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseCards.traverseEmbeddedDocuments
...
Inherited from BaseCards.traverseEmbeddedDocuments
...
Inherited from BaseCards.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseCards.update
...
SeeDocument.updateDocuments
Inherited from BaseCards.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseCards.updateSource
...
Inherited from BaseCards.validate
...
`Protected`- _drawCards(number: number, how: number): documents.Card[]ProtectedAn internal helper method for drawing a certain number of Card documents from this Cards stack.
Parametersnumber: numberThe number of cards to draw
how: numberA draw mode from CONST.CARD_DRAW_MODES
Returns documents.Card[]An array of drawn Card documents
- number: numberThe number of cards to draw
- how: numberA draw mode from CONST.CARD_DRAW_MODES

`Protected`An internal helper method for drawing a certain number of Card documents from this Cards stack.
...
Inherited from BaseCards._initializeSource
...
`data`Inherited from BaseCards._initializeSource
...
Returns voidInherited from BaseCards._onCreate
...
Inherited from BaseCards._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseCards._onDelete
...
Inherited from BaseCards._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseCards._onUpdate
...
Inherited from BaseCards._onUpdate
...
Inherited from BaseCards._preUpdate
...
### ProtectedsortShuffled

`Protected`- sortShuffled(a: documents.Card, b: documents.Card): numberProtectedA sorting function that is used to determine the order of Card documents within a shuffled stack.
Parametersa: documents.CardThe card being sorted
b: documents.CardAnother card being sorted against
Returns number
- a: documents.CardThe card being sorted
- b: documents.CardAnother card being sorted against

`Protected`A sorting function that is used to determine the order of Card documents within a shuffled stack.
...
### ProtectedsortStandard

`Protected`- sortStandard(a: documents.Card, b: documents.Card): numberProtectedA sorting function that is used to determine the standard order of Card documents within an un-shuffled stack.
...
`Protected`A sorting function that is used to determine the standard order of Card documents within an un-shuffled stack.
Sorting with "en" locale to ensure the same order regardless of which client sorts the deck.
...
Inherited from BaseCards._addDataFieldMigration
...
Returns voidInherited from BaseCards._addDataFieldShim
...
Inherited from BaseCards._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseCards._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseCards._addDataFieldShims
...
Returns voidInherited from BaseCards._clearFieldsRecusively
...
Inherited from BaseCards._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseCards._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseCards._initializationOrder
...
Returns voidInherited from BaseCards._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseCards._logDataFieldMigration
...
Inherited from BaseCards.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseCards.cleanData
...
`source`Inherited from BaseCards.cleanData
...
Inherited from BaseCards.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseCards.create


### StaticcreateDialog

`Static`- createDialog(    data?: {},    createOptions?: {},    __namedParameters?: {},): Promise<any>Parametersdata: {} = {}createOptions: {} = {}__namedParameters: {} = {}Returns Promise<any>Overrides ClientDocumentMixin(BaseCards).createDialog
- data: {} = {}
- createOptions: {} = {}
- __namedParameters: {} = {}
...
`Static`- createDocuments(    data?: any[],    context?: {},): Promise<Document<object, DocumentConstructionContext>[]>Create multiple Documents using provided input data.
Data is provided as an array of objects where each individual object becomes one new Document.
Parametersdata: any[] = []An array of data objects or existing Documents to persist.
context: {} = {}Parameters of the requested creation
operation
Returns Promise<Document<object, DocumentConstructionContext>[]>An array of created Document instances
...
Overrides BaseCards.createDocuments
- data: any[] = []An array of data objects or existing Documents to persist.
- context: {} = {}Parameters of the requested creation
operation
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Overrides BaseCards.createDocuments
...
Inherited from BaseCards.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseCards.deleteDocuments
...
Inherited from BaseCards.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseCards.fromSource
...
Inherited from BaseCards.fromSource
...
Inherited from BaseCards.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseCards.getCollectionName
...
Inherited from BaseCards.migrateData
...
`source`Inherited from BaseCards.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseCards.migrateDataSafe
...
`source`Inherited from BaseCards.migrateDataSafe
...
the data argument
Inherited from BaseCards.shimData
...
`data`Inherited from BaseCards.shimData
...
Inherited from BaseCards.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseCards.updateDocuments
...
Inherited from BaseCards.validateJoint
...
Returns Promise<void>Inherited from BaseCards._onCreateOperation
...
Inherited from BaseCards._onCreateOperation
...
Returns Promise<void>Inherited from BaseCards._onDeleteOperation
...
Inherited from BaseCards._onDeleteOperation
...
Returns Promise<void>Inherited from BaseCards._onUpdateOperation
...
Inherited from BaseCards._onUpdateOperation
...
Inherited from BaseCards._preCreateOperation
...
Inherited from BaseCards._preDeleteOperation
...
Inherited from BaseCards._preUpdateOperation
