...
Source: https://foundryvtt.com/api/classes/foundry.documents.collections.Folders.html
...
foundry.documents.Folder: The Folder document


#### Hierarchy (View Summary)

- WorldCollectionFolders
- Folders
...
- new Folders(data?: object[]): FoldersParametersdata: object[] = []An array of data objects from which to create document instances
Returns FoldersInherited from WorldCollection.constructor
...
`Internal`Track which Folders are currently expanded in the UI
...
- _onModifyContents(    action: any,    documents: any,    result: any,    operation: any,    user: any,): voidParametersaction: anydocuments: anyresult: anyoperation: anyuser: anyReturns voidOverrides WorldCollection._onModifyContents
- action: any
- documents: any
- result: any
- operation: any
...
Overrides WorldCollection._onModifyContents
...
- render(force: any, options?: {}): voidParametersforce: anyoptions: {} = {}Returns voidOverrides WorldCollection.render
- force: any
- options: {} = {}
