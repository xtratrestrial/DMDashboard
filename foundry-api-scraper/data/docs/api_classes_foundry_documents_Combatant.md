...
Source: https://foundryvtt.com/api/classes/foundry.documents.Combatant.html
...
- foundry.documents.Combat: The Combat document which contains Combatant embedded documents
- foundry.applications.sheets.CombatantConfig: The application which configures a
Combatant


#### Hierarchy (View Summary)

- BaseCombatant<this>Combatant
- Combatant
...
- new Combatant(    data?: Partial<CombatantData>,    options?: DocumentConstructionContext,): documents.CombatantParametersOptionaldata: Partial<CombatantData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.CombatantInherited from BaseCombatant.constructor
- Optionaldata: Partial<CombatantData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseCombatant.constructor
...
Inherited from BaseCombatant._source


### Internal_videoSrc

`Internal`The token video source image (if any)
...
Inherited from BaseCombatant.parent
...
Inherited from BaseCombatant._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseCombatant.LOCALIZATION_PREFIXES
...
Inherited from BaseCombatant.metadata
...
- get actor(): null | documents.ActorA reference to the Actor document which this Combatant represents, if any
...
- get combat(): null | documents.CombatA convenience alias of Combatant#parent which is more semantically intuitive
...
Returns anyInherited from ClientDocumentMixin(BaseCombatant).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseCombatant).id
...
Returns booleanInherited from ClientDocumentMixin(BaseCombatant).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseCombatant).invalid
...
- get isDefeated(): booleanHas this combatant been marked as defeated?
Returns boolean
...
Returns booleanInherited from ClientDocumentMixin(BaseCombatant).isEmbedded
...
- get isNPC(): booleanThis is treated as a non-player combatant if it has no associated actor and no player users who can control it
Returns boolean
...
- get permission(): anyEschew ClientDocument's redirection to Combat#permission in favor of special ownership determination.
Returns any

Eschew ClientDocument's redirection to Combat#permission in favor of special ownership determination.

`ClientDocument``Combat#permission`
#### Returns any


### players

- get players(): documents.User[]An array of non-Gamemaster Users who have ownership of this Combatant.
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseCombatant).schema
...
- get token(): null | TokenDocumentA reference to the Token document which this Combatant represents, if any
...
Returns stringInherited from ClientDocumentMixin(BaseCombatant).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseCombatant).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseCombatant).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseCombatant).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseCombatant).database
...
Returns stringInherited from ClientDocumentMixin(BaseCombatant).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseCombatant).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseCombatant).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseCombatant).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseCombatant).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseCombatant._configure
...
Inherited from BaseCombatant._configure
...
Returns null | stringInherited from BaseCombatant._getParentCollection
...
Inherited from BaseCombatant._getParentCollection
...
Inherited from BaseCombatant.canUserModify
...
- clearMovementHistory(): Promise<void>Clear the movement history of the Combatant's Token.
...
Inherited from BaseCombatant.clone
...
Inherited from BaseCombatant.createEmbeddedDocuments
...
Inherited from BaseCombatant.delete
...
SeeDocument.deleteDocuments
Inherited from BaseCombatant.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseCombatant.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseCombatant.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseCombatant.getFlag
...
- getInitiativeRoll(formula: string): RollGet a Roll object which represents the initiative roll for this Combatant.
Parametersformula: stringAn explicit Roll formula to use for the combatant.
Returns RollThe unevaluated Roll instance to use for the combatant.
- formula: stringAn explicit Roll formula to use for the combatant.
...
Inherited from BaseCombatant.getUserLevel
...
Inherited from BaseCombatant.migrateSystemData
...
Returns voidInherited from BaseCombatant.reset
...
Inherited from BaseCombatant.reset


### rollInitiative

- rollInitiative(formula?: string): Promise<documents.Combatant>Roll initiative for this particular combatant.
ParametersOptionalformula: stringA dice formula which overrides the default for this Combatant.
Returns Promise<documents.Combatant>The updated Combatant.
- Optionalformula: stringA dice formula which overrides the default for this Combatant.
...
`Optional`A dice formula which overrides the default for this Combatant.
...
Inherited from BaseCombatant.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseCombatant.testUserPermission
...
Inherited from BaseCombatant.toJSON
...
Inherited from BaseCombatant.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseCombatant.traverseEmbeddedDocuments
...
Inherited from BaseCombatant.traverseEmbeddedDocuments
...
Inherited from BaseCombatant.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseCombatant.update
...
SeeDocument.updateDocuments
Inherited from BaseCombatant.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
- updateResource(): null | objectUpdate the value of the tracked resource for this Combatant.
Returns null | object
...
Inherited from BaseCombatant.updateSource
...
Inherited from BaseCombatant.validate
...
### Protected_getInitiativeFormula

`Protected`- _getInitiativeFormula(): stringProtectedAcquire the default dice formula which should be used to roll initiative for this combatant.
Modules or systems could choose to override or extend this to accommodate special situations.
Returns stringThe initiative formula to use for this combatant.

`Protected`Acquire the default dice formula which should be used to roll initiative for this combatant.
Modules or systems could choose to override or extend this to accommodate special situations.
...
Returns voidInherited from BaseCombatant._initialize
...
Inherited from BaseCombatant._initialize
...
Inherited from BaseCombatant._initializeSource
...
`data`Inherited from BaseCombatant._initializeSource
...
Returns voidInherited from BaseCombatant._onCreate
...
Inherited from BaseCombatant._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseCombatant._onDelete
...
Inherited from BaseCombatant._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseCombatant._onUpdate
...
Inherited from BaseCombatant._onUpdate
...
Inherited from BaseCombatant._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseCombatant._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
### Protected_prepareGroup

`Protected`- _prepareGroup(): voidProtectedPrepare derived data based on group membership.
Returns void

`Protected`Prepare derived data based on group membership.
...
Inherited from BaseCombatant._preUpdate
...
Inherited from BaseCombatant._addDataFieldMigration
...
Returns voidInherited from BaseCombatant._addDataFieldShim
...
Inherited from BaseCombatant._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseCombatant._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseCombatant._addDataFieldShims
...
Returns voidInherited from BaseCombatant._clearFieldsRecusively
...
Inherited from BaseCombatant._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseCombatant._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseCombatant._initializationOrder
...
Returns voidInherited from BaseCombatant._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseCombatant._logDataFieldMigration


### Static_preCreateOperation

`Static`- _preCreateOperation(documents: any, operation: any, _user: any): Promise<void>Parametersdocuments: anyoperation: any_user: anyReturns Promise<void>Overrides BaseCombatant._preCreateOperation
- documents: any
- operation: any
- _user: any
...
Overrides BaseCombatant._preCreateOperation


### Static_preDeleteOperation

`Static`- _preDeleteOperation(_documents: any, operation: any, _user: any): Promise<void>Parameters_documents: anyoperation: any_user: anyReturns Promise<void>Overrides BaseCombatant._preDeleteOperation
- _documents: any
- operation: any
- _user: any
...
Overrides BaseCombatant._preDeleteOperation


### Static_preUpdateOperation

`Static`- _preUpdateOperation(_documents: any, operation: any, _user: any): Promise<void>Parameters_documents: anyoperation: any_user: anyReturns Promise<void>Overrides BaseCombatant._preUpdateOperation
- _documents: any
- operation: any
- _user: any
...
Overrides BaseCombatant._preUpdateOperation
...
Inherited from BaseCombatant.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseCombatant.cleanData
...
`source`Inherited from BaseCombatant.cleanData
...
Inherited from BaseCombatant.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseCombatant.create
...
Inherited from BaseCombatant.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseCombatant.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    actorId: ForeignDocumentField;    defeated: BooleanField;    flags: DocumentFlagsField;    group: DocumentIdField;    hidden: BooleanField;    img: FilePathField;    initiative: NumberField;    name: StringField;    sceneId: ForeignDocumentField;    system: TypeDataField;    tokenId: ForeignDocumentField;    type: DocumentTypeField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    actorId: ForeignDocumentField;    defeated: BooleanField;    flags: DocumentFlagsField;    group: DocumentIdField;    hidden: BooleanField;    img: FilePathField;    initiative: NumberField;    name: StringField;    sceneId: ForeignDocumentField;    system: TypeDataField;    tokenId: ForeignDocumentField;    type: DocumentTypeField;}Inherited from BaseCombatant.defineSchema
...
Inherited from BaseCombatant.defineSchema
...
Inherited from BaseCombatant.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseCombatant.deleteDocuments
...
Inherited from BaseCombatant.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseCombatant.fromSource
...
Inherited from BaseCombatant.fromSource
...
Inherited from BaseCombatant.get
...
Inherited from BaseCombatant.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseCombatant.getCollectionName
...
Inherited from BaseCombatant.migrateData
...
`source`Inherited from BaseCombatant.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseCombatant.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseCombatant.migrateDataSafe
...
the data argument
Inherited from BaseCombatant.shimData
...
`data`Inherited from BaseCombatant.shimData
...
Inherited from BaseCombatant.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseCombatant.updateDocuments
...
Inherited from BaseCombatant.validateJoint
...
Returns Promise<void>Inherited from BaseCombatant._onCreateOperation
...
Inherited from BaseCombatant._onCreateOperation
...
Returns Promise<void>Inherited from BaseCombatant._onDeleteOperation
...
Inherited from BaseCombatant._onDeleteOperation
...
Returns Promise<void>Inherited from BaseCombatant._onUpdateOperation
...
Inherited from BaseCombatant._onUpdateOperation
