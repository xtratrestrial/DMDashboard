# TableResult | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.TableResult.html
...
foundry.documents.RollTable: The RollTable document type which contains TableResult
documents


#### Hierarchy (View Summary)

- BaseTableResult<this>TableResult
- TableResult
...
- new TableResult(    data?: Partial<TableResultData>,    options?: DocumentConstructionContext,): documents.TableResultParametersOptionaldata: Partial<TableResultData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.TableResultInherited from BaseTableResult.constructor
- Optionaldata: Partial<TableResultData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseTableResult.constructor
...
Inherited from BaseTableResult._source
...
Inherited from BaseTableResult.parent
...
Inherited from BaseTableResult._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseTableResult.LOCALIZATION_PREFIXES
...
Inherited from BaseTableResult.metadata
...
Returns anyInherited from ClientDocumentMixin(BaseTableResult).compendium
...
- get icon(): stringA path reference to the icon image used to represent this result
Returns string
...
Returns null | stringInherited from ClientDocumentMixin(BaseTableResult).id
...
Returns booleanInherited from ClientDocumentMixin(BaseTableResult).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseTableResult).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseTableResult).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseTableResult).schema
...
Returns stringInherited from ClientDocumentMixin(BaseTableResult).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseTableResult).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseTableResult).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseTableResult).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseTableResult).database
...
Returns stringInherited from ClientDocumentMixin(BaseTableResult).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseTableResult).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseTableResult).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseTableResult).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseTableResult).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseTableResult._configure
...
Inherited from BaseTableResult._configure
...
Returns null | stringInherited from BaseTableResult._getParentCollection
...
Inherited from BaseTableResult._getParentCollection


### _preUpdate

- _preUpdate(changes: any, options: any, user: any): Promise<boolean | void>Pre-process an update operation for a single Document instance. Pre-operation events only occur for the client
which requested the operation.
Parameterschanges: anyThe candidate changes to the Document
...
Overrides BaseTableResult._preUpdate
- changes: anyThe candidate changes to the Document
- options: anyAdditional options which modify the update request
- user: anyThe User requesting the document update
...
Inherited from BaseTableResult.canUserModify
...
Inherited from BaseTableResult.clone
...
Inherited from BaseTableResult.createEmbeddedDocuments
...
Inherited from BaseTableResult.delete
...
SeeDocument.deleteDocuments
Inherited from BaseTableResult.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
- documentToAnchor(): null | HTMLAnchorElementCreate a content-link anchor from this Result's referenced Document.
...
Inherited from BaseTableResult.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseTableResult.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseTableResult.getFlag
...
- getHTML(): Promise<string>Prepare a string representation for this result.
...
Inherited from BaseTableResult.getUserLevel
...
Inherited from BaseTableResult.migrateSystemData
...
Returns voidInherited from BaseTableResult.reset
...
Inherited from BaseTableResult.reset
...
Inherited from BaseTableResult.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseTableResult.testUserPermission
...
Inherited from BaseTableResult.toJSON
...
Inherited from BaseTableResult.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseTableResult.traverseEmbeddedDocuments
...
Inherited from BaseTableResult.traverseEmbeddedDocuments
...
Inherited from BaseTableResult.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseTableResult.update
...
SeeDocument.updateDocuments
Inherited from BaseTableResult.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseTableResult.updateSource
...
Inherited from BaseTableResult.validate
...
Returns voidInherited from BaseTableResult._initialize
...
Inherited from BaseTableResult._initialize
...
Inherited from BaseTableResult._initializeSource
...
`data`Inherited from BaseTableResult._initializeSource
...
Returns voidInherited from BaseTableResult._onCreate
...
Inherited from BaseTableResult._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseTableResult._onDelete
...
Inherited from BaseTableResult._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseTableResult._onUpdate
...
Inherited from BaseTableResult._onUpdate
...
Inherited from BaseTableResult._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseTableResult._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseTableResult._addDataFieldMigration
...
Returns voidInherited from BaseTableResult._addDataFieldShim
...
Inherited from BaseTableResult._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseTableResult._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseTableResult._addDataFieldShims
...
Returns voidInherited from BaseTableResult._clearFieldsRecusively
...
Inherited from BaseTableResult._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseTableResult._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseTableResult._initializationOrder
...
Returns voidInherited from BaseTableResult._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseTableResult._logDataFieldMigration
...
Inherited from BaseTableResult.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseTableResult.cleanData
...
`source`Inherited from BaseTableResult.cleanData
...
Inherited from BaseTableResult.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseTableResult.create
...
Inherited from BaseTableResult.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseTableResult.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    description: HTMLField;    documentUuid: DocumentUUIDField;    drawn: BooleanField;    flags: DocumentFlagsField;    img: FilePathField;    name: StringField;    range: ArrayField<NumberField>;    type: DocumentTypeField;    weight: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    description: HTMLField;    documentUuid: DocumentUUIDField;    drawn: BooleanField;    flags: DocumentFlagsField;    img: FilePathField;    name: StringField;    range: ArrayField<NumberField>;    type: DocumentTypeField;    weight: NumberField;}Inherited from BaseTableResult.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    description: HTMLField;    documentUuid: DocumentUUIDField;    drawn: BooleanField;    flags: DocumentFlagsField;    img: FilePathField;    name: StringField;    range: ArrayField<NumberField>;    type: DocumentTypeField;    weight: NumberField;}

Inherited from BaseTableResult.defineSchema
...
Inherited from BaseTableResult.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseTableResult.deleteDocuments
...
Inherited from BaseTableResult.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseTableResult.fromSource
...
Inherited from BaseTableResult.fromSource
...
Inherited from BaseTableResult.get
...
Inherited from BaseTableResult.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseTableResult.getCollectionName
...
Inherited from BaseTableResult.migrateData
...
`source`Inherited from BaseTableResult.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseTableResult.migrateDataSafe
...
`source`Inherited from BaseTableResult.migrateDataSafe
...
the data argument
Inherited from BaseTableResult.shimData
...
`data`Inherited from BaseTableResult.shimData
...
Inherited from BaseTableResult.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseTableResult.updateDocuments
...
Inherited from BaseTableResult.validateJoint
...
Returns Promise<void>Inherited from BaseTableResult._onCreateOperation
...
Inherited from BaseTableResult._onCreateOperation
...
Returns Promise<void>Inherited from BaseTableResult._onDeleteOperation
...
Inherited from BaseTableResult._onDeleteOperation
...
Returns Promise<void>Inherited from BaseTableResult._onUpdateOperation
...
Inherited from BaseTableResult._onUpdateOperation
...
Inherited from BaseTableResult._preCreateOperation
...
Inherited from BaseTableResult._preDeleteOperation
...
Inherited from BaseTableResult._preUpdateOperation
