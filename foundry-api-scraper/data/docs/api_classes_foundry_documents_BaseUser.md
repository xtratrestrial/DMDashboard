...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseUser.html
...
- DocumentBaseUserdocuments.User
- BaseUserdocuments.User
- documents.User
...
- new BaseUser(    data?: Partial<UserData>,    options?: DocumentConstructionContext,): BaseUserParametersOptionaldata: Partial<UserData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseUserInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    avatar: FilePathField;    character: ForeignDocumentField;    color: ColorField;    flags: DocumentFlagsField;    hotbar: ObjectField;    name: StringField;    password: StringField;    passwordSalt: StringField;    permissions: ObjectField;    pronouns: StringField;    role: NumberField;}Overrides Document.defineSchema
