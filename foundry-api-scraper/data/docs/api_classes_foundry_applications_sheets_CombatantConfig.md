...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.CombatantConfig.html
...
- DocumentSheetV2<this>CombatantConfig
- CombatantConfig
...
- new CombatantConfig(options: any, ...args: any[]): CombatantConfigParametersoptions: any...args: any[]Returns CombatantConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<CombatantConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<CombatantConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<CombatantConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<CombatantConfig>A Promise which resolves to the rendered Application instance
