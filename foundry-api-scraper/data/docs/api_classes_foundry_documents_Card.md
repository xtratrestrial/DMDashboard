# Card | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.Card.html
...
- foundry.documents.Cards: The Cards document type which contains Card embedded documents
- foundry.applications.sheets.CardConfig: The Card configuration application
...
- new Card(    data?: Partial<CardData>,    options?: DocumentConstructionContext,): documents.CardParametersOptionaldata: Partial<CardData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.CardInherited from BaseCard.constructor
- Optionaldata: Partial<CardData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseCard.constructor
...
Inherited from BaseCard._source
...
Inherited from BaseCard.parent
...
Inherited from BaseCard._schema


### StaticDEFAULT_ICON

`Static`The default icon used for a Card face that does not have a custom image set

Inherited from BaseCard.DEFAULT_ICON


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseCard.LOCALIZATION_PREFIXES
...
Inherited from BaseCard.metadata
...
Returns anyInherited from ClientDocumentMixin(BaseCard).compendium
...
- get currentFace(): null | CardFaceDataThe current card face
Returns null | CardFaceData
...
- get hasNextFace(): booleanDoes this Card have a next face available to flip to?
Returns boolean
...
- get hasPreviousFace(): booleanDoes this Card have a previous face available to flip to?
Returns boolean
...
Returns null | stringInherited from ClientDocumentMixin(BaseCard).id
...
- get img(): stringThe image of the currently displayed card face or back
Returns string
...
Returns booleanInherited from ClientDocumentMixin(BaseCard).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseCard).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseCard).isEmbedded
...
- get isHome(): booleanA convenience property for whether the Card is within its source Cards stack. Cards in decks are always
considered home.
Returns boolean
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseCard).schema
...
- get showFace(): booleanWhether to display the face of this card?
Returns boolean
...
- get source(): null | documents.CardsA reference to the source Cards document which defines this Card.
Returns null | documents.Cards
...
Returns stringInherited from ClientDocumentMixin(BaseCard).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseCard).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseCard).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseCard).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseCard).database
...
Returns stringInherited from ClientDocumentMixin(BaseCard).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseCard).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseCard).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseCard).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseCard).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseCard._configure
...
Inherited from BaseCard._configure
...
Returns null | stringInherited from BaseCard._getParentCollection
...
Inherited from BaseCard._getParentCollection
...
Inherited from BaseCard.canUserModify
...
Inherited from BaseCard.createEmbeddedDocuments
...
Inherited from BaseCard.delete
...
SeeDocument.deleteDocuments
Inherited from BaseCard.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
- discard(to: any, __namedParameters?: { updateData?: {} }): Promise<any>Parametersto: any__namedParameters: { updateData?: {} } = {}Returns Promise<any>SeeCard#pass
Inherit Doc
- to: any
...
- flip(face?: null | number): Promise<documents.Card>Flip this card to some other face. A specific face may be requested, otherwise:
...
ParametersOptionalface: null | numberA specific face to flip the card to
Returns Promise<documents.Card>A reference to this card after the flip operation is complete
- Optionalface: null | numberA specific face to flip the card to
...
`Optional`A specific face to flip the card to
...
Inherited from BaseCard.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseCard.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseCard.getFlag
...
Inherited from BaseCard.getUserLevel
...
Inherited from BaseCard.migrateSystemData
...
- pass(    to: documents.Cards,    options?: { updateData?: object },): Promise<documents.Card>Pass this Card to some other Cards document.
Parametersto: documents.CardsA new Cards document this card should be passed to
Optionaloptions: { updateData?: object } = {}Options which modify the pass operation
OptionalupdateData?: objectModifications to make to the Card as part of the pass operation,
for example the displayed face
Returns Promise<documents.Card>A reference to this card after it has been passed to another parent document
- to: documents.CardsA new Cards document this card should be passed to
- Optionaloptions: { updateData?: object } = {}Options which modify the pass operation
OptionalupdateData?: objectModifications to make to the Card as part of the pass operation,
for example the displayed face
- OptionalupdateData?: objectModifications to make to the Card as part of the pass operation,
...
`Optional`Options which modify the pass operation
...
`Optional`Modifications to make to the Card as part of the pass operation,
for example the displayed face
...
- play(to: any, __namedParameters?: { updateData?: {} }): Promise<any>Parametersto: any__namedParameters: { updateData?: {} } = {}Returns Promise<any>SeeCard#pass
Inherit Doc
- to: any
- __namedParameters: { updateData?: {} } = {}
...
- recall(options?: object): Promise<documents.Card>Recall this Card to its original Cards parent.
ParametersOptionaloptions: object = {}Options which modify the recall operation
Returns Promise<documents.Card>A reference to the recalled card belonging to its original parent
- Optionaloptions: object = {}Options which modify the recall operation
...
Returns voidInherited from BaseCard.reset
...
Inherited from BaseCard.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseCard.testUserPermission
...
Inherited from BaseCard.toJSON
...
- toMessage(    messageData?: object,    options?: object,): Promise<documents.ChatMessage>Create a chat message which displays this Card.
ParametersOptionalmessageData: object = {}Additional data which becomes part of the created ChatMessageData
Optionaloptions: object = {}Options which modify the message creation operation
Returns Promise<documents.ChatMessage>The created chat message
- OptionalmessageData: object = {}Additional data which becomes part of the created ChatMessageData
- Optionaloptions: object = {}Options which modify the message creation operation
...
`Optional`Additional data which becomes part of the created ChatMessageData

`Optional`Options which modify the message creation operation


#### Returns Promise<documents.ChatMessage>
...
Inherited from BaseCard.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseCard.traverseEmbeddedDocuments
...
Inherited from BaseCard.traverseEmbeddedDocuments
...
Inherited from BaseCard.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseCard.update
...
SeeDocument.updateDocuments
Inherited from BaseCard.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseCard.updateSource
...
Inherited from BaseCard.validate
...
Returns voidInherited from BaseCard._initialize
...
Inherited from BaseCard._initialize
...
Inherited from BaseCard._initializeSource
...
`data`Inherited from BaseCard._initializeSource
...
Returns voidInherited from BaseCard._onCreate
...
Inherited from BaseCard._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseCard._onDelete
...
Inherited from BaseCard._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseCard._onUpdate
...
Inherited from BaseCard._onUpdate
...
Inherited from BaseCard._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseCard._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseCard._preUpdate
...
Inherited from BaseCard._addDataFieldMigration
...
Returns voidInherited from BaseCard._addDataFieldShim
...
Inherited from BaseCard._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseCard._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseCard._addDataFieldShims
...
Returns voidInherited from BaseCard._clearFieldsRecusively
...
Inherited from BaseCard._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseCard._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseCard._initializationOrder
...
Returns voidInherited from BaseCard._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseCard._logDataFieldMigration
...
Inherited from BaseCard.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseCard.cleanData
...
`source`Inherited from BaseCard.cleanData
...
Inherited from BaseCard.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseCard.create
...
Inherited from BaseCard.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseCard.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    back: SchemaField;    description: HTMLField;    drawn: BooleanField;    face: NumberField;    faces: ArrayField<SchemaField>;    flags: DocumentFlagsField;    height: NumberField;    name: StringField;    origin: ForeignDocumentField;    rotation: AngleField;    sort: IntegerSortField;    suit: StringField;    system: TypeDataField;    type: DocumentTypeField;    value: NumberField;    width: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    back: SchemaField;    description: HTMLField;    drawn: BooleanField;    face: NumberField;    faces: ArrayField<SchemaField>;    flags: DocumentFlagsField;    height: NumberField;    name: StringField;    origin: ForeignDocumentField;    rotation: AngleField;    sort: IntegerSortField;    suit: StringField;    system: TypeDataField;    type: DocumentTypeField;    value: NumberField;    width: NumberField;}Inherited from BaseCard.defineSchema
...
Inherited from BaseCard.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseCard.deleteDocuments
...
Inherited from BaseCard.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseCard.fromSource
...
Inherited from BaseCard.fromSource
...
Inherited from BaseCard.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseCard.getCollectionName
...
Inherited from BaseCard.migrateData
...
`source`Inherited from BaseCard.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseCard.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseCard.migrateDataSafe
...
the data argument
Inherited from BaseCard.shimData
...
`data`Inherited from BaseCard.shimData
...
Inherited from BaseCard.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseCard.updateDocuments
...
Inherited from BaseCard.validateJoint
...
Returns Promise<void>Inherited from BaseCard._onCreateOperation
...
Inherited from BaseCard._onCreateOperation
...
Returns Promise<void>Inherited from BaseCard._onDeleteOperation
...
Inherited from BaseCard._onDeleteOperation
...
Returns Promise<void>Inherited from BaseCard._onUpdateOperation
...
Inherited from BaseCard._onUpdateOperation
...
Inherited from BaseCard._preCreateOperation
...
Inherited from BaseCard._preDeleteOperation
...
Inherited from BaseCard._preUpdateOperation
