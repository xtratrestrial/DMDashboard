...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseFolder.html
...
- DocumentBaseFolderdocuments.Folder
- BaseFolderdocuments.Folder
- documents.Folder
...
- new BaseFolder(    data?: Partial<FolderData>,    options?: DocumentConstructionContext,): BaseFolderParametersOptionaldata: Partial<FolderData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseFolderInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    color: ColorField;    description: HTMLField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    name: StringField;    sort: IntegerSortField;    sorting: StringField;    type: DocumentTypeField;}Overrides Document.defineSchema
...
`Static`- get(    documentId: any,    options?: {},): null | Document<object, DocumentConstructionContext>ParametersdocumentId: anyoptions: {} = {}Returns null | Document<object, DocumentConstructionContext>Overrides Document.get
- documentId: any
- options: {} = {}
