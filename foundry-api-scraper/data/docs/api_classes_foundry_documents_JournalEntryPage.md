...
Source: https://foundryvtt.com/api/classes/foundry.documents.JournalEntryPage.html
...
foundry.documents.JournalEntry: The JournalEntry document type which contains
JournalEntryPage embedded documents.


#### Hierarchy (View Summary)

- BaseJournalEntryPage<this>JournalEntryPage
- JournalEntryPage
...
- new JournalEntryPage(    data?: Partial<JournalEntryPageData>,    options?: DocumentConstructionContext,): documents.JournalEntryPageParametersOptionaldata: Partial<JournalEntryPageData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.JournalEntryPageInherited from BaseJournalEntryPage.constructor
- Optionaldata: Partial<JournalEntryPageData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseJournalEntryPage.constructor
...
Inherited from BaseJournalEntryPage._source
...
Inherited from BaseJournalEntryPage.parent


### Protected_toc

`Protected`The cached table of contents for this JournalEntryPage.
...
Inherited from BaseJournalEntryPage._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseJournalEntryPage.LOCALIZATION_PREFIXES
...
Inherited from BaseJournalEntryPage.metadata
...
Returns anyInherited from ClientDocumentMixin(BaseJournalEntryPage).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseJournalEntryPage).id
...
Returns booleanInherited from ClientDocumentMixin(BaseJournalEntryPage).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseJournalEntryPage).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseJournalEntryPage).isEmbedded
...
- get permission(): DocumentOwnershipNumberReturns DocumentOwnershipNumberInherit Doc
...
- get sceneNote(): null | canvas.placeables.NoteReturn a reference to the Note instance for this Journal Entry Page in the current Scene, if any.
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseJournalEntryPage).schema
...
- get toc(): Record<string, JournalEntryPageHeading>The table of contents for this JournalEntryPage.
...
Returns stringInherited from ClientDocumentMixin(BaseJournalEntryPage).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseJournalEntryPage).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseJournalEntryPage).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseJournalEntryPage).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseJournalEntryPage).database
...
Returns stringInherited from ClientDocumentMixin(BaseJournalEntryPage).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseJournalEntryPage).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseJournalEntryPage).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseJournalEntryPage).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseJournalEntryPage).TYPES
...
- _buildEmbedHTML(config: any, options?: {}): Promise<any>Parametersconfig: anyoptions: {} = {}Returns Promise<any>Inherit Doc
- config: any
- options: {} = {}
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseJournalEntryPage._configure
...
Inherited from BaseJournalEntryPage._configure


### _createDocumentLink

- _createDocumentLink(eventData: any, __namedParameters?: {}): anyParameterseventData: any__namedParameters: {} = {}Returns anyInherit Doc
- eventData: any
- __namedParameters: {} = {}
...
Returns null | stringInherited from BaseJournalEntryPage._getParentCollection
...
Inherited from BaseJournalEntryPage._getParentCollection
...
Returns voidOverrides BaseJournalEntryPage._onUpdate
...
Overrides BaseJournalEntryPage._onUpdate
...
Inherited from BaseJournalEntryPage.canUserModify
...
Inherited from BaseJournalEntryPage.clone
...
Inherited from BaseJournalEntryPage.createEmbeddedDocuments
...
Inherited from BaseJournalEntryPage.delete
...
SeeDocument.deleteDocuments
Inherited from BaseJournalEntryPage.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseJournalEntryPage.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseJournalEntryPage.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseJournalEntryPage.getFlag
...
Inherited from BaseJournalEntryPage.getUserLevel
...
Inherited from BaseJournalEntryPage.migrateSystemData
...
Returns voidInherited from BaseJournalEntryPage.reset
...
Inherited from BaseJournalEntryPage.reset
...
Inherited from BaseJournalEntryPage.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseJournalEntryPage.testUserPermission
...
Inherited from BaseJournalEntryPage.toJSON
...
Inherited from BaseJournalEntryPage.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseJournalEntryPage.traverseEmbeddedDocuments
...
Inherited from BaseJournalEntryPage.traverseEmbeddedDocuments
...
Inherited from BaseJournalEntryPage.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseJournalEntryPage.update
...
SeeDocument.updateDocuments
Inherited from BaseJournalEntryPage.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseJournalEntryPage.updateSource
...
Inherited from BaseJournalEntryPage.validate
...
### Protected_embedImagePage

`Protected`- _embedImagePage(    config: DocumentHTMLEmbedConfig,    options?: any,): Promise<null | HTMLElement | HTMLCollection>ProtectedEmbed image page content.
Parametersconfig: DocumentHTMLEmbedConfigConfiguration for embedding behavior.
altAlt text for the image, otherwise the caption will be used.
Optionaloptions: any = {}The original enrichment options for cases where the Document embed content
also contains text that must be enriched.
Returns Promise<null | HTMLElement | HTMLCollection>Example: Create an embedded image from a sibling journal entry page.@Embed[.QnH8yGIHy4pmFBHR classes="small right"]{Special caption}
becomes
<figure class="content-embed small right" data-content-embed        data-uuid="JournalEntry.xFNPjbSEDbWjILNj.JournalEntryPage.QnH8yGIHy4pmFBHR">  <img src="path/to/image.webp" alt="Special caption">  <figcaption>    <strong class="embed-caption">Special caption</strong>    <cite>      <a class="content-link" draggable="true" data-link         data-uuid="JournalEntry.xFNPjbSEDbWjILNj.JournalEntryPage.QnH8yGIHy4pmFBHR"         data-id="QnH8yGIHy4pmFBHR" data-type="JournalEntryPage" data-tooltip="Image Page">        <i class="fa-solid fa-file-image"></i> Image Page      </a>    </cite>  </figcaption></figure>
Copy
...
`Protected`Embed image page content.
...
`@Embed[.QnH8yGIHy4pmFBHR classes="small right"]{Special caption}````javascript
<figure class="content-embed small right" data-content-embed        data-uuid="JournalEntry.xFNPjbSEDbWjILNj.JournalEntryPage.QnH8yGIHy4pmFBHR">  <img src="path/to/image.webp" alt="Special caption">  <figcaption>    <strong class="embed-caption">Special caption</strong>    <cite>      <a class="content-link" draggable="true" data-link         data-uuid="JournalEntry.xFNPjbSEDbWjILNj.JournalEntryPage.QnH8yGIHy4pmFBHR"         data-id="QnH8yGIHy4pmFBHR" data-type="JournalEntryPage" data-tooltip="Image Page">        <i class="fa-solid fa-file-image"></i> Image Page      </a>    </cite>  </figcaption></figure>
Copy
```

`<figure class="content-embed small right" data-content-embed        data-uuid="JournalEntry.xFNPjbSEDbWjILNj.JournalEntryPage.QnH8yGIHy4pmFBHR">  <img src="path/to/image.webp" alt="Special caption">  <figcaption>    <strong class="embed-caption">Special caption</strong>    <cite>      <a class="content-link" draggable="true" data-link         data-uuid="JournalEntry.xFNPjbSEDbWjILNj.JournalEntryPage.QnH8yGIHy4pmFBHR"         data-id="QnH8yGIHy4pmFBHR" data-type="JournalEntryPage" data-tooltip="Image Page">        <i class="fa-solid fa-file-image"></i> Image Page      </a>    </cite>  </figcaption></figure>`
### Protected_embedTextPage

`Protected`- _embedTextPage(    config: any,    options?: any,): Promise<null | HTMLElement | HTMLCollection>ProtectedEmbed text page content.
Parametersconfig: anyConfiguration for embedding behavior. This can include
enrichment options to override those passed as part of
the root enrichment process.
Optionaloptions: any = {}The original enrichment options to propagate to the embedded text page's
enrichment.
Returns Promise<null | HTMLElement | HTMLCollection>Example: Embed the content of the Journal Entry Page as a figure.@Embed[.yDbDF1ThSfeinh3Y classes="small right"]{Special caption}
becomes
<figure class="content-embed small right" data-content-embed        data-uuid="JournalEntry.ekAeXsvXvNL8rKFZ.JournalEntryPage.yDbDF1ThSfeinh3Y">  <p>The contents of the page</p>  <figcaption>    <strong class="embed-caption">Special caption</strong>    <cite>      <a class="content-link" draggable="true" data-link         data-uuid="JournalEntry.ekAeXsvXvNL8rKFZ.JournalEntryPage.yDbDF1ThSfeinh3Y"         data-id="yDbDF1ThSfeinh3Y" data-type="JournalEntryPage" data-tooltip="Text Page">        <i class="fa-solid fa-file-lines"></i> Text Page      </a>    </cite>  <figcaption></figure>
Copy

Example: Embed the content of the Journal Entry Page into the main content flow.@Embed[.yDbDF1ThSfeinh3Y inline]
becomes
<section class="content-embed" data-content-embed         data-uuid="JournalEntry.ekAeXsvXvNL8rKFZ.JournalEntryPage.yDbDF1ThSfeinh3Y">  <p>The contents of the page</p></section>
Copy
- config: anyConfiguration for embedding behavior. This can include
enrichment options to override those passed as part of
the root enrichment process.
- Optionaloptions: any = {}The original enrichment options to propagate to the embedded text page's
enrichment.

`Protected`Embed text page content.
...
`Optional`The original enrichment options to propagate to the embedded text page's
enrichment.
...
`@Embed[.yDbDF1ThSfeinh3Y classes="small right"]{Special caption}````javascript
<figure class="content-embed small right" data-content-embed        data-uuid="JournalEntry.ekAeXsvXvNL8rKFZ.JournalEntryPage.yDbDF1ThSfeinh3Y">  <p>The contents of the page</p>  <figcaption>    <strong class="embed-caption">Special caption</strong>    <cite>      <a class="content-link" draggable="true" data-link         data-uuid="JournalEntry.ekAeXsvXvNL8rKFZ.JournalEntryPage.yDbDF1ThSfeinh3Y"         data-id="yDbDF1ThSfeinh3Y" data-type="JournalEntryPage" data-tooltip="Text Page">        <i class="fa-solid fa-file-lines"></i> Text Page      </a>    </cite>  <figcaption></figure>
Copy
```
...
`@Embed[.yDbDF1ThSfeinh3Y inline]````javascript
<section class="content-embed" data-content-embed         data-uuid="JournalEntry.ekAeXsvXvNL8rKFZ.JournalEntryPage.yDbDF1ThSfeinh3Y">  <p>The contents of the page</p></section>
Copy
```
...
Returns voidInherited from BaseJournalEntryPage._initialize
...
Inherited from BaseJournalEntryPage._initialize
...
Inherited from BaseJournalEntryPage._initializeSource
...
`data`Inherited from BaseJournalEntryPage._initializeSource
...
Returns voidInherited from BaseJournalEntryPage._onCreate
...
Inherited from BaseJournalEntryPage._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseJournalEntryPage._onDelete
...
Inherited from BaseJournalEntryPage._onDelete
...
Inherited from BaseJournalEntryPage._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseJournalEntryPage._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseJournalEntryPage._preUpdate
...
Inherited from BaseJournalEntryPage._addDataFieldMigration
...
Returns voidInherited from BaseJournalEntryPage._addDataFieldShim
...
Inherited from BaseJournalEntryPage._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseJournalEntryPage._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseJournalEntryPage._addDataFieldShims
...
Returns voidInherited from BaseJournalEntryPage._clearFieldsRecusively
...
Inherited from BaseJournalEntryPage._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseJournalEntryPage._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseJournalEntryPage._initializationOrder
...
Returns voidInherited from BaseJournalEntryPage._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseJournalEntryPage._logDataFieldMigration


### StaticbuildTOC

`Static`- buildTOC(    html: HTMLElement | HTMLElement[],    options?: { includeElement?: boolean },): Record<string, JournalEntryPageHeading>Build a table of contents for the given HTML content.
Parametershtml: HTMLElement | HTMLElement[]The HTML content to generate a ToC outline for.
Optionaloptions: { includeElement?: boolean } = {}Additional options to configure ToC generation.
OptionalincludeElement?: booleanInclude references to the heading DOM elements in the returned ToC.
Returns Record<string, JournalEntryPageHeading>
- html: HTMLElement | HTMLElement[]The HTML content to generate a ToC outline for.
- Optionaloptions: { includeElement?: boolean } = {}Additional options to configure ToC generation.
OptionalincludeElement?: booleanInclude references to the heading DOM elements in the returned ToC.
- OptionalincludeElement?: booleanInclude references to the heading DOM elements in the returned ToC.
...
`Optional`Additional options to configure ToC generation.

- OptionalincludeElement?: booleanInclude references to the heading DOM elements in the returned ToC.


##### OptionalincludeElement?: boolean

`Optional`Include references to the heading DOM elements in the returned ToC.
...
Inherited from BaseJournalEntryPage.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseJournalEntryPage.cleanData
...
`source`Inherited from BaseJournalEntryPage.cleanData
...
Inherited from BaseJournalEntryPage.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseJournalEntryPage.create
...
Inherited from BaseJournalEntryPage.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseJournalEntryPage.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    category: DocumentIdField;    flags: DocumentFlagsField;    image: SchemaField;    name: StringField;    ownership: DocumentOwnershipField;    sort: IntegerSortField;    src: StringField;    system: TypeDataField;    text: SchemaField;    title: SchemaField;    type: DocumentTypeField;    video: SchemaField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    category: DocumentIdField;    flags: DocumentFlagsField;    image: SchemaField;    name: StringField;    ownership: DocumentOwnershipField;    sort: IntegerSortField;    src: StringField;    system: TypeDataField;    text: SchemaField;    title: SchemaField;    type: DocumentTypeField;    video: SchemaField;}Inherited from BaseJournalEntryPage.defineSchema
...
Inherited from BaseJournalEntryPage.defineSchema
...
Inherited from BaseJournalEntryPage.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseJournalEntryPage.deleteDocuments
...
Inherited from BaseJournalEntryPage.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseJournalEntryPage.fromSource
...
Inherited from BaseJournalEntryPage.fromSource
...
Inherited from BaseJournalEntryPage.get
...
Inherited from BaseJournalEntryPage.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseJournalEntryPage.getCollectionName
...
Inherited from BaseJournalEntryPage.migrateData
...
`source`Inherited from BaseJournalEntryPage.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseJournalEntryPage.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseJournalEntryPage.migrateDataSafe
...
the data argument
Inherited from BaseJournalEntryPage.shimData
...
`data`Inherited from BaseJournalEntryPage.shimData


### StaticslugifyHeading

`Static`- slugifyHeading(heading: string | HTMLHeadingElement): stringConvert a heading into slug suitable for use as an identifier.
Parametersheading: string | HTMLHeadingElementThe heading element or some text content.
Returns string
- heading: string | HTMLHeadingElementThe heading element or some text content.
...
Inherited from BaseJournalEntryPage.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseJournalEntryPage.updateDocuments
...
Inherited from BaseJournalEntryPage.validateJoint
...
### Protected Static_flattenTOC

`Protected``Static`- _flattenTOC(    nodes: JournalEntryPageHeading[],): Record<string, JournalEntryPageHeading>ProtectedFlatten the tree structure into a single object with each node's slug as the key.
Parametersnodes: JournalEntryPageHeading[]The root ToC nodes.
Returns Record<string, JournalEntryPageHeading>
- nodes: JournalEntryPageHeading[]The root ToC nodes.

`Protected`Flatten the tree structure into a single object with each node's slug as the key.
...
### Protected Static_makeHeadingNode

`Protected``Static`- _makeHeadingNode(    heading: HTMLHeadingElement,    options?: { includeElement?: boolean },): JournalEntryPageHeadingProtectedConstruct a table of contents node from a heading element.
Parametersheading: HTMLHeadingElementThe heading element.
Optionaloptions: { includeElement?: boolean } = {}Additional options to configure the returned node.
OptionalincludeElement?: booleanWhether to include the DOM element in the returned ToC node.
Returns JournalEntryPageHeading
- heading: HTMLHeadingElementThe heading element.
- Optionaloptions: { includeElement?: boolean } = {}Additional options to configure the returned node.
OptionalincludeElement?: booleanWhether to include the DOM element in the returned ToC node.
- OptionalincludeElement?: booleanWhether to include the DOM element in the returned ToC node.

`Protected`Construct a table of contents node from a heading element.
...
`Optional`Additional options to configure the returned node.
...
`Optional`Whether to include the DOM element in the returned ToC node.
...
Returns Promise<void>Inherited from BaseJournalEntryPage._onCreateOperation
...
Inherited from BaseJournalEntryPage._onCreateOperation
...
Returns Promise<void>Inherited from BaseJournalEntryPage._onDeleteOperation
...
Inherited from BaseJournalEntryPage._onDeleteOperation
...
Returns Promise<void>Inherited from BaseJournalEntryPage._onUpdateOperation
...
Inherited from BaseJournalEntryPage._onUpdateOperation
...
Inherited from BaseJournalEntryPage._preCreateOperation
...
Inherited from BaseJournalEntryPage._preDeleteOperation
...
Inherited from BaseJournalEntryPage._preUpdateOperation
