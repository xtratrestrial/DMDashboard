...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.PlaylistSoundConfig.html
...
- DocumentSheetV2<this>PlaylistSoundConfig
- PlaylistSoundConfig
...
- new PlaylistSoundConfig(options: any, ...args: any[]): PlaylistSoundConfigParametersoptions: any...args: any[]Returns PlaylistSoundConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- _prepareContext(    options: any,): Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        channels: {};        defaultChannel: string;        lvolume: number;        milliseconds: string;    },>Parametersoptions: anyReturns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        channels: {};        defaultChannel: string;        lvolume: number;        milliseconds: string;    },>Inherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareContext
- options: any
...
#### Returns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        channels: {};        defaultChannel: string;        lvolume: number;        milliseconds: string;    },>
...
- close(    options?: Partial<ApplicationClosingOptions>,): Promise<PlaylistSoundConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<PlaylistSoundConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<PlaylistSoundConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<PlaylistSoundConfig>A Promise which resolves to the rendered Application instance
