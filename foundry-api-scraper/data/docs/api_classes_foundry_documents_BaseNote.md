...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseNote.html
...
- DocumentBaseNoteNoteDocument
- BaseNoteNoteDocument
- NoteDocument
...
- new BaseNote(    data?: Partial<NoteData>,    options?: DocumentConstructionContext,): BaseNoteParametersOptionaldata: Partial<NoteData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseNoteInherited from Document.constructor
