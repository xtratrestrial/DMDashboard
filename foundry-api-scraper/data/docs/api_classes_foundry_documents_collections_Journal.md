# Journal | Foundry Virtual Tabletop - API Documentation - Version 13
...
- new Journal(data?: object[]): JournalParametersdata: object[] = []An array of data objects from which to create document instances
