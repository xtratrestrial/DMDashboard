...
Source: https://foundryvtt.com/api/classes/foundry.canvas.layers.SoundsLayer.html
...
- _onMouseMove(currentPos: Point): voidInternalHandle mouse cursor movements which may cause ambient audio previews to occur
ParameterscurrentPos: PointReturns void
- currentPos: Point

`Internal`Handle mouse cursor movements which may cause ambient audio previews to occur
...
- emitAtPosition(...args: any[]): Promise<void>Emit playback to other connected clients to occur at a specified position.
Parameters...args: any[]Arguments passed to SoundsLayer#playAtPosition
...
- getListenerPositions(): ElevatedPoint[]Get an array of listener positions for Tokens which are able to hear environmental sound.
...
- initializeSources(): voidInitialize all AmbientSound sources which are present on this layer
Returns void
...
- playAtPosition(    src: string,    origin: Point | ElevatedPoint,    radius: number,    options?: {        baseEffect?: any;        easing?: boolean;        gmAlways?: boolean;        muffledEffect?: any;        playbackOptions?: any;        sourceData?: Partial<PointEffectSourceData>;        volume?: number;        walls?: boolean;    },): Promise<null | Sound>Play a one-shot Sound originating from a predefined point on the canvas.
...
Parameterssrc: stringThe sound source path to play
origin: Point | ElevatedPointThe canvas coordinates from which the sound originates
radius: numberThe radius of effect in distance units
options: {    baseEffect?: any;    easing?: boolean;    gmAlways?: boolean;    muffledEffect?: any;    playbackOptions?: any;    sourceData?: Partial<PointEffectSourceData>;    volume?: number;    walls?: boolean;} = {}Additional options which configure playback
OptionalbaseEffect?: anyA base sound effect to apply to playback
Optionaleasing?: booleanShould volume be attenuated by distance?
OptionalgmAlways?: booleanShould the sound always be played for GM users regardless
of actively controlled tokens?
OptionalmuffledEffect?: anyA muffled sound effect to apply to playback, a sound may
only be muffled if it is not constrained by walls
OptionalplaybackOptions?: anyAdditional options passed to Sound#play
OptionalsourceData?: Partial<PointEffectSourceData>Additional data passed to the SoundSource constructor
Optionalvolume?: numberThe maximum volume at which the effect should be played
Optionalwalls?: booleanShould the sound be constrained by walls?
Returns Promise<null | Sound>A Promise which resolves to the played Sound, or null
Example: Play the sound of a trap springingconst src = "modules/my-module/sounds/spring-trap.ogg";const origin = {x: 5200, y: 3700};  // The origin point for the soundconst radius = 30;                  // Audible in a 30-foot radiusawait canvas.sounds.playAtPosition(src, origin, radius);
Copy

Example: A Token casts a spellconst src = "modules/my-module/sounds/spells-sprite.ogg";const origin = token.center;         // The origin point for the soundconst radius = 60;                   // Audible in a 60-foot radiusawait canvas.sounds.playAtPosition(src, origin, radius, {  walls: false,                      // Not constrained by walls with a lowpass muffled effect  muffledEffect: {type: "lowpass", intensity: 6},  sourceData: {    angle: 120,                      // Sound emitted at a limited angle    rotation: 270                    // Configure the direction of sound emission  }  playbackOptions: {    loopStart: 12,                   // Audio sprite timing    loopEnd: 16,    fade: 300,                      // Fade-in 300ms    onended: () => console.log("Do something after the spell sound has played")  }});
Copy
- src: stringThe sound source path to play
- origin: Point | ElevatedPointThe canvas coordinates from which the sound originates
- radius: numberThe radius of effect in distance units
- options: {    baseEffect?: any;    easing?: boolean;    gmAlways?: boolean;    muffledEffect?: any;    playbackOptions?: any;    sourceData?: Partial<PointEffectSourceData>;    volume?: number;    walls?: boolean;} = {}Additional options which configure playback
OptionalbaseEffect?: anyA base sound effect to apply to playback
...
##### OptionalbaseEffect?: any

`Optional`A base sound effect to apply to playback


##### Optionaleasing?: boolean

`Optional`Should volume be attenuated by distance?


##### OptionalgmAlways?: boolean

`Optional`Should the sound always be played for GM users regardless
of actively controlled tokens?


##### OptionalmuffledEffect?: any

`Optional`A muffled sound effect to apply to playback, a sound may
only be muffled if it is not constrained by walls


##### OptionalplaybackOptions?: any

`Optional`Additional options passed to Sound#play


##### OptionalsourceData?: Partial<PointEffectSourceData>

`Optional`Additional data passed to the SoundSource constructor


##### Optionalvolume?: number

`Optional`The maximum volume at which the effect should be played


##### Optionalwalls?: boolean

`Optional`Should the sound be constrained by walls?
...
```javascript
const src = "modules/my-module/sounds/spring-trap.ogg";const origin = {x: 5200, y: 3700};  // The origin point for the soundconst radius = 30;                  // Audible in a 30-foot radiusawait canvas.sounds.playAtPosition(src, origin, radius);
Copy
```
...
```javascript
const src = "modules/my-module/sounds/spells-sprite.ogg";const origin = token.center;         // The origin point for the soundconst radius = 60;                   // Audible in a 60-foot radiusawait canvas.sounds.playAtPosition(src, origin, radius, {  walls: false,                      // Not constrained by walls with a lowpass muffled effect  muffledEffect: {type: "lowpass", intensity: 6},  sourceData: {    angle: 120,                      // Sound emitted at a limited angle    rotation: 270                    // Configure the direction of sound emission  }  playbackOptions: {    loopStart: 12,                   // Audio sprite timing    loopEnd: 16,    fade: 300,                      // Fade-in 300ms    onended: () => console.log("Do something after the spell sound has played")  }});
Copy
```
...
- previewSound(position: Point | ElevatedPoint): voidPreview ambient audio for a given position
Parametersposition: Point | ElevatedPointThe position to preview
Returns void
- position: Point | ElevatedPointThe position to preview
...
- refresh(options?: object): undefined | numberUpdate all AmbientSound effects in the layer by toggling their playback status.
Sync audio for the positions of tokens which are capable of hearing.
ParametersOptionaloptions: object = {}Additional options forwarded to AmbientSound synchronization
Returns undefined | number
- Optionaloptions: object = {}Additional options forwarded to AmbientSound synchronization
...
`Optional`Additional options forwarded to AmbientSound synchronization
...
- stopAll(): voidTerminate playback of all ambient audio sources
Returns void
...
### Protected_configurePlayback

`Protected`- _configurePlayback(config: AmbientSoundPlaybackConfig): voidProtectedConfigure playback by assigning the muffled state and final playback volume for the sound.
This method should mutate the config object by assigning the volume and muffled properties.
Parametersconfig: AmbientSoundPlaybackConfigReturns void
- config: AmbientSoundPlaybackConfig

`Protected`Configure playback by assigning the muffled state and final playback volume for the sound.
This method should mutate the config object by assigning the volume and muffled properties.
...
`Protected`- _onDropData(event: DragEvent, data: object): Promise<false | PlaceableObject>ProtectedHandle PlaylistSound document drop data.
Parametersevent: DragEventThe drag drop event
data: objectThe dropped transfer data.
Returns Promise<false | PlaceableObject>
- event: DragEventThe drag drop event
- data: objectThe dropped transfer data.

`Protected`Handle PlaylistSound document drop data.
...
### Protected_syncPositions

`Protected`- _syncPositions(listeners: ElevatedPoint[], options?: object): voidProtectedSync the playing state and volume of all AmbientSound objects based on the position of listener points
Parameterslisteners: ElevatedPoint[]Locations of listeners which have the capability to hear
Optionaloptions: objectAdditional options forwarded to AmbientSound synchronization
Returns void
- listeners: ElevatedPoint[]Locations of listeners which have the capability to hear
- Optionaloptions: objectAdditional options forwarded to AmbientSound synchronization

`Protected`Sync the playing state and volume of all AmbientSound objects based on the position of listener points
...
`Static`- prepareSceneControls(): {    activeTool: string;    icon: string;    layer: string;    name: string;    onChange: (_event: any, active: any) => void;    onToolChange: () => any;    order: number;    title: string;    tools: {        clear: {            button: boolean;            icon: string;            name: string;            onChange: () => any;            order: number;            title: string;        };        preview: {            active: any;            icon: string;            name: string;            onChange: (_event: any, toggled: any) => void;            order: number;            title: string;            toggle: boolean;            toolclip: {                heading: string;                items: { paragraph: string }[];                src: string;            };        };        sound: {            icon: string;            name: string;            order: number;            title: string;            toolclip: {                heading: string;                items: ToolclipConfigurationItem[];                src: string;            };        };    };    visible: boolean;}Returns {    activeTool: string;    icon: string;    layer: string;    name: string;    onChange: (_event: any, active: any) => void;    onToolChange: () => any;    order: number;    title: string;    tools: {        clear: {            button: boolean;            icon: string;            name: string;            onChange: () => any;            order: number;            title: string;        };        preview: {            active: any;            icon: string;            name: string;            onChange: (_event: any, toggled: any) => void;            order: number;            title: string;            toggle: boolean;            toolclip: {                heading: string;                items: { paragraph: string }[];                src: string;            };        };        sound: {            icon: string;            name: string;            order: number;            title: string;            toolclip: {                heading: string;                items: ToolclipConfigurationItem[];                src: string;            };        };    };    visible: boolean;}Overrides PlaceablesLayer.prepareSceneControls


#### Returns {    activeTool: string;    icon: string;    layer: string;    name: string;    onChange: (_event: any, active: any) => void;    onToolChange: () => any;    order: number;    title: string;    tools: {        clear: {            button: boolean;            icon: string;            name: string;            onChange: () => any;            order: number;            title: string;        };        preview: {            active: any;            icon: string;            name: string;            onChange: (_event: any, toggled: any) => void;            order: number;            title: string;            toggle: boolean;            toolclip: {                heading: string;                items: { paragraph: string }[];                src: string;            };        };        sound: {            icon: string;            name: string;            order: number;            title: string;            toolclip: {                heading: string;                items: ToolclipConfigurationItem[];                src: string;            };        };    };    visible: boolean;}
