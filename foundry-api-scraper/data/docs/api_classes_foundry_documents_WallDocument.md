# WallDocument | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.WallDocument.html
...
- foundry.documents.Scene: The Scene document type which contains Wall documents
- foundry.applications.sheets.WallConfig: The Wall configuration application


#### Hierarchy (View Summary)

- BaseWall<this>WallDocument
- WallDocument
...
- new WallDocument(    data?: Partial<WallData>,    options?: DocumentConstructionContext,): WallDocumentParametersOptionaldata: Partial<WallData> = {}Initial data used to construct the data object. The provided object will be
...
Returns WallDocumentInherited from BaseWall.constructor
- Optionaldata: Partial<WallData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseWall.constructor
...
Inherited from BaseWall._source
...
Inherited from BaseWall.parent
...
Inherited from BaseWall._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseWall.LOCALIZATION_PREFIXES
...
Inherited from BaseWall.metadata
...
Returns anyInherited from CanvasDocumentMixin(BaseWall).compendium
...
Returns null | stringInherited from CanvasDocumentMixin(BaseWall).id
...
Returns booleanInherited from CanvasDocumentMixin(BaseWall).inCompendium
...
Returns booleanInherited from CanvasDocumentMixin(BaseWall).invalid
...
Returns booleanInherited from CanvasDocumentMixin(BaseWall).isEmbedded
...
Returns SchemaFieldInherited from CanvasDocumentMixin(BaseWall).schema
...
Returns stringInherited from CanvasDocumentMixin(BaseWall).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from CanvasDocumentMixin(BaseWall).validationFailures
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseWall).baseDocument
...
Returns stringInherited from CanvasDocumentMixin(BaseWall).collectionName
...
Returns abstract.DatabaseBackendInherited from CanvasDocumentMixin(BaseWall).database
...
Returns stringInherited from CanvasDocumentMixin(BaseWall).documentName
...
Returns booleanInherited from CanvasDocumentMixin(BaseWall).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from CanvasDocumentMixin(BaseWall).hierarchy
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseWall).implementation
...
Returns string[]Inherited from CanvasDocumentMixin(BaseWall).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseWall._configure
...
Inherited from BaseWall._configure
...
Returns null | stringInherited from BaseWall._getParentCollection
...
Inherited from BaseWall._getParentCollection
...
Inherited from BaseWall.canUserModify
...
Inherited from BaseWall.createEmbeddedDocuments
...
Inherited from BaseWall.delete
...
SeeDocument.deleteDocuments
Inherited from BaseWall.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseWall.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseWall.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseWall.getFlag
...
Inherited from BaseWall.getUserLevel
...
Inherited from BaseWall.migrateSystemData
...
Returns voidInherited from BaseWall.reset
...
Inherited from BaseWall.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseWall.testUserPermission
...
Inherited from BaseWall.toJSON
...
Inherited from BaseWall.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseWall.traverseEmbeddedDocuments
...
Inherited from BaseWall.traverseEmbeddedDocuments
...
Inherited from BaseWall.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseWall.update
...
SeeDocument.updateDocuments
Inherited from BaseWall.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseWall.updateSource
...
Inherited from BaseWall.validate
...
Returns voidInherited from BaseWall._initialize
...
Inherited from BaseWall._initialize
...
Inherited from BaseWall._initializeSource
...
`data`Inherited from BaseWall._initializeSource
...
Returns voidInherited from BaseWall._onCreate
...
Inherited from BaseWall._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseWall._onDelete
...
Inherited from BaseWall._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseWall._onUpdate
...
Inherited from BaseWall._onUpdate
...
Inherited from BaseWall._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseWall._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseWall._preUpdate
...
Inherited from BaseWall._addDataFieldMigration
...
Returns voidInherited from BaseWall._addDataFieldShim
...
Inherited from BaseWall._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseWall._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseWall._addDataFieldShims
...
Returns voidInherited from BaseWall._clearFieldsRecusively
...
Inherited from BaseWall._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseWall._initializationOrder
...
Returns voidInherited from BaseWall._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseWall._logDataFieldMigration
...
Inherited from BaseWall.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseWall.cleanData
...
`source`Inherited from BaseWall.cleanData
...
Inherited from BaseWall.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseWall.create
...
Inherited from BaseWall.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseWall.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    animation: SchemaField;    c: ArrayField<NumberField>;    dir: NumberField;    door: NumberField;    doorSound: StringField;    ds: NumberField;    flags: DocumentFlagsField;    light: NumberField;    move: NumberField;    sight: NumberField;    sound: NumberField;    threshold: SchemaField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    animation: SchemaField;    c: ArrayField<NumberField>;    dir: NumberField;    door: NumberField;    doorSound: StringField;    ds: NumberField;    flags: DocumentFlagsField;    light: NumberField;    move: NumberField;    sight: NumberField;    sound: NumberField;    threshold: SchemaField;}Inherited from BaseWall.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    animation: SchemaField;    c: ArrayField<NumberField>;    dir: NumberField;    door: NumberField;    doorSound: StringField;    ds: NumberField;    flags: DocumentFlagsField;    light: NumberField;    move: NumberField;    sight: NumberField;    sound: NumberField;    threshold: SchemaField;}

Inherited from BaseWall.defineSchema
...
Inherited from BaseWall.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseWall.deleteDocuments
...
Inherited from BaseWall.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseWall.fromSource
...
Inherited from BaseWall.fromSource
...
Inherited from BaseWall.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseWall.getCollectionName
...
Inherited from BaseWall.migrateData
...
`source`Inherited from BaseWall.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseWall.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseWall.migrateDataSafe
...
the data argument
Inherited from BaseWall.shimData
...
`data`Inherited from BaseWall.shimData
...
Inherited from BaseWall.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseWall.updateDocuments
...
Inherited from BaseWall.validateJoint
...
Returns Promise<void>Inherited from BaseWall._onCreateOperation
...
Inherited from BaseWall._onCreateOperation
...
Returns Promise<void>Inherited from BaseWall._onDeleteOperation
...
Inherited from BaseWall._onDeleteOperation
...
Returns Promise<void>Inherited from BaseWall._onUpdateOperation
...
Inherited from BaseWall._onUpdateOperation
...
Inherited from BaseWall._preCreateOperation
...
Inherited from BaseWall._preDeleteOperation
...
Inherited from BaseWall._preUpdateOperation
