# BaseSetting | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html
...
- new BaseSetting(    data?: Partial<SettingData>,    options?: DocumentConstructionContext,): BaseSettingParametersOptionaldata: Partial<SettingData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseSettingInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    key: StringField;    user: ForeignDocumentField;    value: JSONField;}Overrides Document.defineSchema
