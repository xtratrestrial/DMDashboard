# Playlists | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.collections.Playlists.html
...
- foundry.documents.Playlist: The Playlist document
- foundry.applications.sidebar.tabs.PlaylistDirectory: The PlaylistDirectory sidebar
directory


#### Hierarchy (View Summary)

- WorldCollectionPlaylists
- Playlists
...
- new Playlists(data?: object[]): PlaylistsParametersdata: object[] = []An array of data objects from which to create document instances
Returns PlaylistsInherited from WorldCollection.constructor
...
- get playing(): documents.Playlist[]Return the subset of Playlist documents which are currently playing
...
- _onChangeScene(    scene: null | documents.Scene,    priorScene: null | documents.Scene,): Promise<void>InternalHandle changes to a Scene to determine whether to trigger changes to Playlist documents.
Parametersscene: null | documents.SceneThe new active Scene
priorScene: null | documents.SceneThe previously active Scene
Returns Promise<void>
- scene: null | documents.SceneThe new active Scene
- priorScene: null | documents.SceneThe previously active Scene

`Internal`Handle changes to a Scene to determine whether to trigger changes to Playlist documents.
...
- initialize(): Promise<void>Perform one-time initialization to begin playback of audio.
Returns Promise<void>
