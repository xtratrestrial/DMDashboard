...
Source: https://foundryvtt.com/api/classes/foundry.documents.DrawingDocument.html
...
- foundry.documents.Scene: The Scene document type which contains Drawing embedded documents
- foundry.applications.sheets.DrawingConfig: The Drawing configuration application


#### Hierarchy (View Summary)

- BaseDrawing<this>DrawingDocument
- DrawingDocument
...
- new DrawingDocument(    data?: Partial<DrawingData>,    options?: DocumentConstructionContext,): DrawingDocumentParametersOptionaldata: Partial<DrawingData> = {}Initial data used to construct the data object. The provided object will be
...
Returns DrawingDocumentInherited from BaseDrawing.constructor
- Optionaldata: Partial<DrawingData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseDrawing.constructor
...
Inherited from BaseDrawing._source
...
Inherited from BaseDrawing.parent
...
Inherited from BaseDrawing._schema


### StaticdefaultDrawingFields

`Static`Fields included in the drawing defaults setting


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseDrawing.LOCALIZATION_PREFIXES
...
Inherited from BaseDrawing.metadata
...
Returns anyInherited from CanvasDocumentMixin(BaseDrawing).compendium
...
Returns null | stringInherited from CanvasDocumentMixin(BaseDrawing).id
...
Returns booleanInherited from CanvasDocumentMixin(BaseDrawing).inCompendium
...
Returns booleanInherited from CanvasDocumentMixin(BaseDrawing).invalid
...
- get isAuthor(): booleanIs the current User the author of this drawing?
Returns boolean
...
Returns booleanInherited from CanvasDocumentMixin(BaseDrawing).isEmbedded
...
Returns SchemaFieldInherited from CanvasDocumentMixin(BaseDrawing).schema
...
Returns stringInherited from CanvasDocumentMixin(BaseDrawing).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from CanvasDocumentMixin(BaseDrawing).validationFailures
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseDrawing).baseDocument
...
Returns stringInherited from CanvasDocumentMixin(BaseDrawing).collectionName
...
Returns abstract.DatabaseBackendInherited from CanvasDocumentMixin(BaseDrawing).database
...
Returns stringInherited from CanvasDocumentMixin(BaseDrawing).documentName
...
Returns booleanInherited from CanvasDocumentMixin(BaseDrawing).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from CanvasDocumentMixin(BaseDrawing).hierarchy
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseDrawing).implementation
...
Returns string[]Inherited from CanvasDocumentMixin(BaseDrawing).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseDrawing._configure
...
Inherited from BaseDrawing._configure
...
Returns null | stringInherited from BaseDrawing._getParentCollection
...
Inherited from BaseDrawing._getParentCollection
...
Inherited from BaseDrawing.canUserModify
...
Inherited from BaseDrawing.clone
...
Inherited from BaseDrawing.createEmbeddedDocuments
...
Inherited from BaseDrawing.delete
...
SeeDocument.deleteDocuments
Inherited from BaseDrawing.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseDrawing.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseDrawing.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseDrawing.getFlag
...
Inherited from BaseDrawing.getUserLevel
...
Inherited from BaseDrawing.migrateSystemData
...
Returns voidInherited from BaseDrawing.reset
...
Inherited from BaseDrawing.reset
...
Inherited from BaseDrawing.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseDrawing.testUserPermission
...
Inherited from BaseDrawing.toJSON
...
Inherited from BaseDrawing.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseDrawing.traverseEmbeddedDocuments
...
Inherited from BaseDrawing.traverseEmbeddedDocuments
...
Inherited from BaseDrawing.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseDrawing.update
...
SeeDocument.updateDocuments
Inherited from BaseDrawing.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseDrawing.updateSource
...
Inherited from BaseDrawing.validate
...
Returns voidInherited from BaseDrawing._initialize
...
Inherited from BaseDrawing._initialize
...
Inherited from BaseDrawing._initializeSource
...
`data`Inherited from BaseDrawing._initializeSource
...
Returns voidInherited from BaseDrawing._onCreate
...
Inherited from BaseDrawing._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseDrawing._onDelete
...
Inherited from BaseDrawing._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseDrawing._onUpdate
...
Inherited from BaseDrawing._onUpdate
...
Inherited from BaseDrawing._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseDrawing._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseDrawing._preUpdate
...
Inherited from BaseDrawing._addDataFieldMigration
...
Returns voidInherited from BaseDrawing._addDataFieldShim
...
Inherited from BaseDrawing._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseDrawing._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseDrawing._addDataFieldShims
...
Returns voidInherited from BaseDrawing._clearFieldsRecusively
...
Inherited from BaseDrawing._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseDrawing._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseDrawing._initializationOrder
...
Returns voidInherited from BaseDrawing._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseDrawing._logDataFieldMigration


### Static_validateVisibleContent

`Static`- _validateVisibleContent(    data: Partial<Pick<DrawingData, "shape">> & Pick<        DrawingData,        | "text"        | "textAlpha"        | "fillType"        | "fillAlpha"        | "strokeWidth"        | "strokeAlpha",    >,): booleanInternalValidate whether the drawing has some visible content (as required by validation).
Parametersdata: Partial<Pick<DrawingData, "shape">> & Pick<    DrawingData,    | "text"    | "textAlpha"    | "fillType"    | "fillAlpha"    | "strokeWidth"    | "strokeAlpha",>Returns booleanInherited from BaseDrawing._validateVisibleContent
- data: Partial<Pick<DrawingData, "shape">> & Pick<    DrawingData,    | "text"    | "textAlpha"    | "fillType"    | "fillAlpha"    | "strokeWidth"    | "strokeAlpha",>

`Internal`Validate whether the drawing has some visible content (as required by validation).
...
Inherited from BaseDrawing._validateVisibleContent


### StaticcanUserCreate

`Static`- canUserCreate(user: any): anyParametersuser: anyReturns anyInherited from BaseDrawing.canUserCreate
- user: any
...
Inherited from BaseDrawing.canUserCreate
...
Inherited from BaseDrawing.cleanData
...
`source`Inherited from BaseDrawing.cleanData
...
Inherited from BaseDrawing.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseDrawing.create
...
Inherited from BaseDrawing.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseDrawing.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    author: DocumentAuthorField;    bezierFactor: AlphaField;    elevation: NumberField;    fillAlpha: AlphaField;    fillColor: ColorField;    fillType: NumberField;    flags: DocumentFlagsField;    fontFamily: StringField;    fontSize: NumberField;    hidden: BooleanField;    interface: BooleanField;    locked: BooleanField;    rotation: AngleField;    shape: EmbeddedDataField;    sort: NumberField;    strokeAlpha: AlphaField;    strokeColor: ColorField;    strokeWidth: NumberField;    text: StringField;    textAlpha: AlphaField;    textColor: ColorField;    texture: FilePathField;    x: NumberField;    y: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    author: DocumentAuthorField;    bezierFactor: AlphaField;    elevation: NumberField;    fillAlpha: AlphaField;    fillColor: ColorField;    fillType: NumberField;    flags: DocumentFlagsField;    fontFamily: StringField;    fontSize: NumberField;    hidden: BooleanField;    interface: BooleanField;    locked: BooleanField;    rotation: AngleField;    shape: EmbeddedDataField;    sort: NumberField;    strokeAlpha: AlphaField;    strokeColor: ColorField;    strokeWidth: NumberField;    text: StringField;    textAlpha: AlphaField;    textColor: ColorField;    texture: FilePathField;    x: NumberField;    y: NumberField;}Inherited from BaseDrawing.defineSchema
...
Inherited from BaseDrawing.defineSchema
...
Inherited from BaseDrawing.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseDrawing.deleteDocuments
...
Inherited from BaseDrawing.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseDrawing.fromSource
...
Inherited from BaseDrawing.fromSource
...
Inherited from BaseDrawing.get
...
Inherited from BaseDrawing.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseDrawing.getCollectionName
...
Inherited from BaseDrawing.migrateData
...
`source`Inherited from BaseDrawing.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseDrawing.migrateDataSafe
...
`source`Inherited from BaseDrawing.migrateDataSafe
...
the data argument
Inherited from BaseDrawing.shimData
...
`data`Inherited from BaseDrawing.shimData
...
Inherited from BaseDrawing.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseDrawing.updateDocuments
...
Inherited from BaseDrawing.validateJoint
...
Returns Promise<void>Inherited from BaseDrawing._onCreateOperation
...
Inherited from BaseDrawing._onCreateOperation
...
Returns Promise<void>Inherited from BaseDrawing._onDeleteOperation
...
Inherited from BaseDrawing._onDeleteOperation
...
Returns Promise<void>Inherited from BaseDrawing._onUpdateOperation
...
Inherited from BaseDrawing._onUpdateOperation
...
Inherited from BaseDrawing._preCreateOperation
...
Inherited from BaseDrawing._preDeleteOperation
...
Inherited from BaseDrawing._preUpdateOperation
