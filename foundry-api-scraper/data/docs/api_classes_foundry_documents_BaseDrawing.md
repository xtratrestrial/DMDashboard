...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseDrawing.html
...
- DocumentBaseDrawingDrawingDocument
- BaseDrawingDrawingDocument
- DrawingDocument
...
- new BaseDrawing(    data?: Partial<DrawingData>,    options?: DocumentConstructionContext,): BaseDrawingParametersOptionaldata: Partial<DrawingData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseDrawingInherited from Document.constructor
...
Parametersdata: Partial<Pick<DrawingData, "shape">> & Pick<    DrawingData,    | "text"    | "textAlpha"    | "fillType"    | "fillAlpha"    | "strokeWidth"    | "strokeAlpha",>Returns boolean
...
Overrides Document.validateJoint
