...
- DocumentSheetV2<this>CardsConfigCardDeckConfigCardHandConfigCardPileConfig
- CardsConfigCardDeckConfigCardHandConfigCardPileConfig
- CardDeckConfig
- CardHandConfig
- CardPileConfig
...
- new CardsConfig(options: any, ...args: any[]): CardsConfigParametersoptions: any...args: any[]Returns CardsConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- _initializeApplicationOptions(options: any): anyParametersoptions: anyReturns anyInherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._initializeApplicationOptions
- options: any
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<CardsConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<CardsConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<CardsConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<CardsConfig>A Promise which resolves to the rendered Application instance
...
`Protected`- _onDragOver(event: DragEvent): Promise<void>ProtectedThe "dragover" event handler for individual cards
...
`Protected`- _onDragStart(event: DragEvent): Promise<void>ProtectedThe "dragstart" event handler for individual cards
Parametersevent: DragEventReturns Promise<void>
- event: DragEvent
...
`Protected`- _onDrop(event: DragEvent): Promise<any>ProtectedThe "dragdrop" event handler for individual cards
...
### Protected_prepareButtons

`Protected`- _prepareButtons(): FormFooterButton[]ProtectedConfigure footer buttons for the window.
Returns FormFooterButton[]

`Protected`Configure footer buttons for the window.


#### Returns FormFooterButton[]


### Protected_prepareCards

`Protected`- _prepareCards(sortMode?: "standard" | "shuffled"): Card[]ProtectedPrepare a sorted array of cards for display in the sheet.
ParameterssortMode: "standard" | "shuffled" = ...Returns Card[]
