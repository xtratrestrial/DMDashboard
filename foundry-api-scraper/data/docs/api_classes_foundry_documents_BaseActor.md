# BaseActor | Foundry Virtual Tabletop - API Documentation - Version 13
...
- DocumentBaseActordocuments.Actor
- BaseActordocuments.Actor
- documents.Actor
...
- new BaseActor(    data?: Partial<ActorData>,    options?: DocumentConstructionContext,): BaseActorParametersOptionaldata: Partial<ActorData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseActorInherited from Document.constructor
...
- _initializeSource(source: any, options: any): anyInitialize the source data for a new DataModel instance.
...
`data`Overrides Document._initializeSource
