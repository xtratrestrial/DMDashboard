# BaseTableResult | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BaseTableResult.html
...
- DocumentBaseTableResultdocuments.TableResult
- BaseTableResultdocuments.TableResult
...
- new BaseTableResult(    data?: Partial<TableResultData>,    options?: DocumentConstructionContext,): BaseTableResultParametersOptionaldata: Partial<TableResultData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseTableResultInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    description: HTMLField;    documentUuid: DocumentUUIDField;    drawn: BooleanField;    flags: DocumentFlagsField;    img: FilePathField;    name: StringField;    range: ArrayField<NumberField>;    type: DocumentTypeField;    weight: NumberField;}Overrides Document.defineSchema
