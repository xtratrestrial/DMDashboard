...
Source: https://foundryvtt.com/api/classes/foundry.documents.collections.WorldSettings.html
...
- new WorldSettings(data?: object[]): WorldSettingsParametersdata: object[] = []An array of data objects from which to create document instances
Returns WorldSettingsInherited from WorldCollection.constructor
...
- get directory(): nullReturns nullOverrides WorldCollection.directory
...
- getItem(key: string, user?: string): null | stringReturn the serialized value of the world setting as a string
Parameterskey: stringThe setting key
Optionaluser: stringFor user-scoped settings, the user ID.
Returns null | stringThe serialized setting string
- key: stringThe setting key
- Optionaluser: stringFor user-scoped settings, the user ID.
...
`Optional`For user-scoped settings, the user ID.
...
- getSetting(key: string, user?: string): SettingReturn the Setting document with the given key.
Parameterskey: stringThe setting key
Optionaluser: string = nullFor user-scoped settings, the user ID.
Returns SettingThe Setting
- key: stringThe setting key
- Optionaluser: string = nullFor user-scoped settings, the user ID.
