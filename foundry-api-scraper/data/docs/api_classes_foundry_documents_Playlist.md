...
Source: https://foundryvtt.com/api/classes/foundry.documents.Playlist.html
...
- foundry.documents.collections.Playlists: The world-level collection of Playlist documents
- foundry.documents.PlaylistSound: The PlaylistSound embedded document within a parent
Playlist
- foundry.applications.sheets.PlaylistConfig: The Playlist configuration application
...
- new Playlist(    data?: Partial<PlaylistData>,    options?: DocumentConstructionContext,): documents.PlaylistParametersOptionaldata: Partial<PlaylistData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.PlaylistInherited from BasePlaylist.constructor
- Optionaldata: Partial<PlaylistData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BasePlaylist.constructor
...
Inherited from BasePlaylist._source
...
Inherited from BasePlaylist.parent
...
Inherited from BasePlaylist._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BasePlaylist.LOCALIZATION_PREFIXES
...
Inherited from BasePlaylist.metadata
...
Returns anyInherited from ClientDocumentMixin(BasePlaylist).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BasePlaylist).id
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylist).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylist).invalid
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylist).isEmbedded
...
- get playbackOrder(): string[]The order in which sounds within this playlist will be played (if sequential or shuffled)
...
Returns SchemaFieldInherited from ClientDocumentMixin(BasePlaylist).schema
...
Returns stringInherited from ClientDocumentMixin(BasePlaylist).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BasePlaylist).validationFailures
...
- get visible(): anyReturns anyInherit Doc
...
Returns typeof DocumentInherited from ClientDocumentMixin(BasePlaylist).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BasePlaylist).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BasePlaylist).database
...
Returns stringInherited from ClientDocumentMixin(BasePlaylist).documentName
...
Returns booleanInherited from ClientDocumentMixin(BasePlaylist).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BasePlaylist).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BasePlaylist).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BasePlaylist).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BasePlaylist._configure
...
Inherited from BasePlaylist._configure
...
Returns null | stringInherited from BasePlaylist._getParentCollection
...
Inherited from BasePlaylist._getParentCollection
...
Returns voidInherited from BasePlaylist._initialize
...
Inherited from BasePlaylist._initialize


### _onClickDocumentLink

- _onClickDocumentLink(event: any): Promise<documents.Playlist>Parametersevent: anyReturns Promise<documents.Playlist>Inherit Doc
- event: any
...
Returns voidOverrides BasePlaylist._onDelete
...
Overrides BasePlaylist._onDelete
...
- _onSoundEnd(    sound: PlaylistSound,): Promise<undefined | null | Document<object, DocumentConstructionContext>>InternalHandle callback logic when an individual sound within the Playlist concludes playback naturally
Parameterssound: PlaylistSoundReturns Promise<undefined | null | Document<object, DocumentConstructionContext>>
- sound: PlaylistSound

`Internal`Handle callback logic when an individual sound within the Playlist concludes playback naturally
...
#### Returns Promise<undefined | null | Document<object, DocumentConstructionContext>>


### _onSoundStart

- _onSoundStart(sound: PlaylistSound): Promise<void>InternalHandle callback logic when playback for an individual sound within the Playlist is started.
Schedule auto-preload of next track
Parameterssound: PlaylistSoundReturns Promise<void>
- sound: PlaylistSound

`Internal`Handle callback logic when playback for an individual sound within the Playlist is started.
Schedule auto-preload of next track
...
userId: anyThe id of the User requesting the document update
Returns voidOverrides BasePlaylist._onUpdate
...
Overrides BasePlaylist._onUpdate
...
- _preUpdate(changed: any, options: any, user: any): Promise<boolean | void>Pre-process an update operation for a single Document instance. Pre-operation events only occur for the client
...
Overrides BasePlaylist._preUpdate
...
- bulkImportDialog(): Promise<boolean>Spawn a dialog for bulk importing sound files into a playlist.
...
- bulkImportSounds(paths: string[]): Promise<PlaylistSound[]>Create PlaylistSounds in this Playlist from the given file paths.
Parameterspaths: string[]File paths to import.
Returns Promise<PlaylistSound[]>
- paths: string[]File paths to import.
...
Inherited from BasePlaylist.canUserModify
...
Inherited from BasePlaylist.clone
...
Inherited from BasePlaylist.createEmbeddedDocuments
...
- cycleMode(): Promise<documents.Playlist>Cycle the playlist mode
Returns Promise<documents.Playlist>A promise which resolves to the updated Playlist instance
...
Inherited from BasePlaylist.delete
...
SeeDocument.deleteDocuments
Inherited from BasePlaylist.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BasePlaylist.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BasePlaylist.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BasePlaylist.getFlag
...
Inherited from BasePlaylist.getUserLevel
...
Inherited from BasePlaylist.migrateSystemData
...
- playAll(): Promise<documents.Playlist>Begin simultaneous playback for all sounds in the Playlist.
Returns Promise<documents.Playlist>The updated Playlist document
...
- playNext(    soundId?: string,    options?: { direction?: number },): Promise<undefined | null | documents.Playlist>Play the next Sound within the sequential or shuffled Playlist.
ParametersOptionalsoundId: stringThe currently playing sound ID, if known
Optionaloptions: { direction?: number } = {}Additional options which configure the next track
Optionaldirection?: numberWhether to advance forward (if 1) or backwards (if -1)
Returns Promise<undefined | null | documents.Playlist>If successfully updated, this Playlist document
- OptionalsoundId: stringThe currently playing sound ID, if known
- Optionaloptions: { direction?: number } = {}Additional options which configure the next track
Optionaldirection?: numberWhether to advance forward (if 1) or backwards (if -1)
- Optionaldirection?: numberWhether to advance forward (if 1) or backwards (if -1)
...
`Optional`The currently playing sound ID, if known

`Optional`Additional options which configure the next track
...
`Optional`Whether to advance forward (if 1) or backwards (if -1)


#### Returns Promise<undefined | null | documents.Playlist>
...
- playSound(sound: PlaylistSound): Promise<documents.Playlist>Begin playback of a specific Sound within this Playlist.
Determine which other sounds should remain playing, if any.
Parameterssound: PlaylistSoundThe desired sound that should play
Returns Promise<documents.Playlist>The updated Playlist
- sound: PlaylistSoundThe desired sound that should play
...
Returns voidInherited from BasePlaylist.reset
...
Inherited from BasePlaylist.reset
...
Inherited from BasePlaylist.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
- stopAll(): Promise<documents.Playlist>End playback for any/all currently playing sounds within the Playlist.
Returns Promise<documents.Playlist>The updated Playlist document
...
- stopSound(sound: PlaylistSound): Promise<documents.Playlist>Stop playback of a specific Sound within this Playlist.
Determine which other sounds should remain playing, if any.
Parameterssound: PlaylistSoundThe desired sound that should play
Returns Promise<documents.Playlist>The updated Playlist
- sound: PlaylistSoundThe desired sound that should play
...
Inherited from BasePlaylist.testUserPermission
...
- toAnchor(__namedParameters?: { classes?: never[] }): anyParameters__namedParameters: { classes?: never[] } = {}Returns anyInherit Doc
...
Inherited from BasePlaylist.toJSON
...
Inherited from BasePlaylist.toObject
...
Returns Generator<any, void, any>YieldsInherited from BasePlaylist.traverseEmbeddedDocuments
...
Inherited from BasePlaylist.traverseEmbeddedDocuments
...
Inherited from BasePlaylist.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BasePlaylist.update
...
SeeDocument.updateDocuments
Inherited from BasePlaylist.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BasePlaylist.updateSource
...
Inherited from BasePlaylist.validate
...
### Protected_getNextSound

`Protected`- _getNextSound(soundId: number): anyProtectedGet the next sound in the cached playback order. For internal use.
ParameterssoundId: numberReturns any
- soundId: number

`Protected`Get the next sound in the cached playback order. For internal use.
...
### Protected_getPreviousSound

`Protected`- _getPreviousSound(soundId: number): anyProtectedGet the previous sound in the cached playback order. For internal use.
ParameterssoundId: numberReturns any
- soundId: number

`Protected`Get the previous sound in the cached playback order. For internal use.
...
Inherited from BasePlaylist._initializeSource
...
`data`Inherited from BasePlaylist._initializeSource
...
Returns voidInherited from BasePlaylist._onCreate
...
Inherited from BasePlaylist._onCreate
...
Inherited from BasePlaylist._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BasePlaylist._preDelete
...
### Protected_sortSounds

`Protected`- _sortSounds(a: Sound, b: Sound): anyProtectedDefine the sorting order for the Sounds within this Playlist. For internal use.
...
Parametersa: Soundb: SoundReturns any
- a: Sound
- b: Sound

`Protected`Define the sorting order for the Sounds within this Playlist. For internal use.
If sorting alphabetically, the sounds are sorted with a locale-independent comparator
to ensure the same order on all clients.
...
Inherited from BasePlaylist._addDataFieldMigration
...
Returns voidInherited from BasePlaylist._addDataFieldShim
...
Inherited from BasePlaylist._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BasePlaylist._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BasePlaylist._addDataFieldShims
...
Returns voidInherited from BasePlaylist._clearFieldsRecusively
...
Inherited from BasePlaylist._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BasePlaylist._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BasePlaylist._initializationOrder
...
Returns voidInherited from BasePlaylist._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BasePlaylist._logDataFieldMigration
...
Inherited from BasePlaylist.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BasePlaylist.cleanData
...
`source`Inherited from BasePlaylist.cleanData
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BasePlaylist.create
...
Inherited from BasePlaylist.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BasePlaylist.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    channel: StringField;    description: StringField;    fade: NumberField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    mode: NumberField;    name: StringField;    ownership: DocumentOwnershipField;    playing: BooleanField;    seed: NumberField;    sort: IntegerSortField;    sorting: StringField;    sounds: EmbeddedCollectionField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    channel: StringField;    description: StringField;    fade: NumberField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    mode: NumberField;    name: StringField;    ownership: DocumentOwnershipField;    playing: BooleanField;    seed: NumberField;    sort: IntegerSortField;    sorting: StringField;    sounds: EmbeddedCollectionField;}Inherited from BasePlaylist.defineSchema
...
Inherited from BasePlaylist.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BasePlaylist.deleteDocuments
...
Inherited from BasePlaylist.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BasePlaylist.fromSource
...
Inherited from BasePlaylist.fromSource
...
Inherited from BasePlaylist.get
...
Inherited from BasePlaylist.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BasePlaylist.getCollectionName
...
Inherited from BasePlaylist.migrateData
...
`source`Inherited from BasePlaylist.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BasePlaylist.migrateDataSafe
...
`source`Inherited from BasePlaylist.migrateDataSafe
...
the data argument
Inherited from BasePlaylist.shimData
...
`data`Inherited from BasePlaylist.shimData
...
Inherited from BasePlaylist.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BasePlaylist.updateDocuments
...
Inherited from BasePlaylist.validateJoint
...
### Protected Static_getSoundContentLinks

`Protected``Static`- _getSoundContentLinks(doc: any): NodeListOf<Element>ProtectedFind all content links belonging to a given Playlist or foundry.documents.PlaylistSound.
Parametersdoc: anyThe Playlist or PlaylistSound.
Returns NodeListOf<Element>
- doc: anyThe Playlist or PlaylistSound.

`Protected`Find all content links belonging to a given Playlist or foundry.documents.PlaylistSound.
...
Returns Promise<void>Inherited from BasePlaylist._onCreateOperation
...
Inherited from BasePlaylist._onCreateOperation
...
Returns Promise<void>Inherited from BasePlaylist._onDeleteOperation
...
Inherited from BasePlaylist._onDeleteOperation
...
Returns Promise<void>Inherited from BasePlaylist._onUpdateOperation
...
Inherited from BasePlaylist._onUpdateOperation
...
Inherited from BasePlaylist._preCreateOperation
...
Inherited from BasePlaylist._preDeleteOperation
...
Inherited from BasePlaylist._preUpdateOperation
