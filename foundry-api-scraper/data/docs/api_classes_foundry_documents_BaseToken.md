# BaseToken | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BaseToken.html
...
- DocumentBaseTokenTokenDocument
- BaseTokenTokenDocument
- TokenDocument
...
- new BaseToken(    data?: Partial<TokenData>,    options?: DocumentConstructionContext,): BaseTokenParametersOptionaldata: Partial<TokenData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseTokenInherited from Document.constructor
...
Overrides Document.updateSource
...
Parametersposition1: TokenPositionposition2: TokenPositionReturns boolean
