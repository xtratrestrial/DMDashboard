...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.DrawingConfig.html
...
- DocumentSheetV2<this>DrawingConfig
- DrawingConfig
...
- new DrawingConfig(options: any, ...args: any[]): DrawingConfigParametersoptions: any...args: any[]Returns DrawingConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- get id(): stringReturns stringInherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2).id
...
- _prepareContext(    options: any,): Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        author: any;        buttons: FormFooterButton[];        drawingRoles: { false: string; true: string };        fillDisabled: boolean;        fontFamilies: Record<string, string>;        gridUnits: any;        scaledBezierFactor: number;        userColor: any;    },>Parametersoptions: anyReturns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        author: any;        buttons: FormFooterButton[];        drawingRoles: { false: string; true: string };        fillDisabled: boolean;        fontFamilies: Record<string, string>;        gridUnits: any;        scaledBezierFactor: number;        userColor: any;    },>Inherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareContext
- options: any
...
#### Returns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        author: any;        buttons: FormFooterButton[];        drawingRoles: { false: string; true: string };        fillDisabled: boolean;        fontFamilies: Record<string, string>;        gridUnits: any;        scaledBezierFactor: number;        userColor: any;    },>
...
- _prepareTabs(group: any): Record<string, ApplicationTab>Parametersgroup: anyReturns Record<string, ApplicationTab>Inherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareTabs
- group: any
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<DrawingConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<DrawingConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<DrawingConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<DrawingConfig>A Promise which resolves to the rendered Application instance
