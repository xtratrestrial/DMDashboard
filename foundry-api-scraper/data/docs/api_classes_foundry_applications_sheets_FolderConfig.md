...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.FolderConfig.html
...
- DocumentSheetV2<this>FolderConfig
- FolderConfig
...
- new FolderConfig(options: any, ...args: any[]): FolderConfigParametersoptions: any...args: any[]Returns FolderConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<FolderConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<FolderConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<FolderConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<FolderConfig>A Promise which resolves to the rendered Application instance
