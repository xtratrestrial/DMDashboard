...
Source: https://foundryvtt.com/api/classes/foundry.documents.FogExploration.html
...
foundry.documents.collections.FogExplorations: The world-level collection of
FogExploration documents


#### Hierarchy (View Summary)

- BaseFogExploration<this>FogExploration
- FogExploration
...
- new FogExploration(    data?: Partial<FogExplorationData>,    options?: DocumentConstructionContext,): documents.FogExplorationParametersOptionaldata: Partial<FogExplorationData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.FogExplorationInherited from BaseFogExploration.constructor
- Optionaldata: Partial<FogExplorationData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
#### Returns documents.FogExploration

Inherited from BaseFogExploration.constructor
...
Inherited from BaseFogExploration._source
...
Inherited from BaseFogExploration.parent
...
Inherited from BaseFogExploration._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseFogExploration.LOCALIZATION_PREFIXES
...
Inherited from BaseFogExploration.metadata
...
Returns anyInherited from ClientDocumentMixin(BaseFogExploration).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseFogExploration).id
...
Returns booleanInherited from ClientDocumentMixin(BaseFogExploration).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseFogExploration).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseFogExploration).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseFogExploration).schema
...
Returns stringInherited from ClientDocumentMixin(BaseFogExploration).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseFogExploration).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseFogExploration).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseFogExploration).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseFogExploration).database
...
Returns stringInherited from ClientDocumentMixin(BaseFogExploration).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseFogExploration).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseFogExploration).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseFogExploration).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseFogExploration).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseFogExploration._configure
...
Inherited from BaseFogExploration._configure
...
Returns null | stringInherited from BaseFogExploration._getParentCollection
...
Inherited from BaseFogExploration._getParentCollection
...
Returns voidOverrides BaseFogExploration._onCreate
...
Overrides BaseFogExploration._onCreate
...
userId: anyThe id of the User requesting the document update
Returns voidOverrides BaseFogExploration._onDelete
...
Overrides BaseFogExploration._onDelete
...
userId: anyThe id of the User requesting the document update
Returns voidOverrides BaseFogExploration._onUpdate
...
Overrides BaseFogExploration._onUpdate
...
Inherited from BaseFogExploration._preUpdate
...
Inherited from BaseFogExploration.canUserModify
...
Inherited from BaseFogExploration.clone
...
Inherited from BaseFogExploration.createEmbeddedDocuments
...
Inherited from BaseFogExploration.delete
...
SeeDocument.deleteDocuments
Inherited from BaseFogExploration.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseFogExploration.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseFogExploration.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseFogExploration.getFlag
...
- getTexture(): null | Texture<Resource>Transform the explored base64 data into a PIXI.Texture object
...
Inherited from BaseFogExploration.getUserLevel
...
Inherited from BaseFogExploration.migrateSystemData
...
Returns voidInherited from BaseFogExploration.reset
...
Inherited from BaseFogExploration.reset
...
Inherited from BaseFogExploration.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseFogExploration.testUserPermission
...
Inherited from BaseFogExploration.toJSON
...
Inherited from BaseFogExploration.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseFogExploration.traverseEmbeddedDocuments
...
Inherited from BaseFogExploration.traverseEmbeddedDocuments
...
Inherited from BaseFogExploration.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseFogExploration.update
...
SeeDocument.updateDocuments
Inherited from BaseFogExploration.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseFogExploration.updateSource
...
Inherited from BaseFogExploration.validate
...
Returns voidInherited from BaseFogExploration._initialize
...
Inherited from BaseFogExploration._initialize
...
Inherited from BaseFogExploration._initializeSource
...
`data`Inherited from BaseFogExploration._initializeSource
...
Inherited from BaseFogExploration._preCreate
...
Inherited from BaseFogExploration._preDelete
...
Inherited from BaseFogExploration._addDataFieldMigration
...
Returns voidInherited from BaseFogExploration._addDataFieldShim
...
Inherited from BaseFogExploration._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseFogExploration._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseFogExploration._addDataFieldShims
...
Returns voidInherited from BaseFogExploration._clearFieldsRecusively
...
Inherited from BaseFogExploration._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseFogExploration._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseFogExploration._initializationOrder
...
Returns voidInherited from BaseFogExploration._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseFogExploration._logDataFieldMigration
...
Inherited from BaseFogExploration.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseFogExploration.cleanData
...
`source`Inherited from BaseFogExploration.cleanData
...
Inherited from BaseFogExploration.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseFogExploration.create
...
Inherited from BaseFogExploration.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseFogExploration.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    explored: FilePathField;    flags: DocumentFlagsField;    positions: ObjectField;    scene: ForeignDocumentField;    timestamp: NumberField;    user: ForeignDocumentField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    explored: FilePathField;    flags: DocumentFlagsField;    positions: ObjectField;    scene: ForeignDocumentField;    timestamp: NumberField;    user: ForeignDocumentField;}Inherited from BaseFogExploration.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    explored: FilePathField;    flags: DocumentFlagsField;    positions: ObjectField;    scene: ForeignDocumentField;    timestamp: NumberField;    user: ForeignDocumentField;}

Inherited from BaseFogExploration.defineSchema
...
Inherited from BaseFogExploration.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseFogExploration.deleteDocuments
...
Inherited from BaseFogExploration.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseFogExploration.fromSource
...
Inherited from BaseFogExploration.fromSource


### Staticget

`Static`- get(    ...args: any[],):    | null    | Document<object, DocumentConstructionContext>    | Promise<null | documents.FogExploration>Get a World-level Document of this type by its id.
Parameters...args: any[]The Document ID
Returns     | null    | Document<object, DocumentConstructionContext>    | Promise<null | documents.FogExploration>The retrieved Document, or null
Overrides BaseFogExploration.get
- ...args: any[]The Document ID
...
#### Returns     | null    | Document<object, DocumentConstructionContext>    | Promise<null | documents.FogExploration>
...
Inherited from BaseFogExploration.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseFogExploration.getCollectionName


### Staticload

`Static`- load(    query?: { scene?: string; user?: string },    options?: object,): Promise<null | documents.FogExploration>Obtain the fog of war exploration progress for a specific Scene and User.
ParametersOptionalquery: { scene?: string; user?: string } = {}Parameters for which FogExploration document is retrieved
Optionalscene?: stringA certain Scene ID
Optionaluser?: stringA certain User ID
Optionaloptions: object = {}Additional options passed to DatabaseBackend#get
Returns Promise<null | documents.FogExploration>
- Optionalquery: { scene?: string; user?: string } = {}Parameters for which FogExploration document is retrieved
Optionalscene?: stringA certain Scene ID
Optionaluser?: stringA certain User ID
- Optionalscene?: stringA certain Scene ID
- Optionaluser?: stringA certain User ID
...
`Optional`Parameters for which FogExploration document is retrieved
...
`Optional`A certain Scene ID


##### Optionaluser?: string

`Optional`A certain User ID

`Optional`Additional options passed to DatabaseBackend#get
...
Inherited from BaseFogExploration.migrateData
...
`source`Inherited from BaseFogExploration.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseFogExploration.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseFogExploration.migrateDataSafe
...
the data argument
Inherited from BaseFogExploration.shimData
...
`data`Inherited from BaseFogExploration.shimData
...
Inherited from BaseFogExploration.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseFogExploration.updateDocuments
...
Inherited from BaseFogExploration.validateJoint
...
Returns Promise<void>Inherited from BaseFogExploration._onCreateOperation
...
Inherited from BaseFogExploration._onCreateOperation
...
Returns Promise<void>Inherited from BaseFogExploration._onDeleteOperation
...
Inherited from BaseFogExploration._onDeleteOperation
...
Returns Promise<void>Inherited from BaseFogExploration._onUpdateOperation
...
Inherited from BaseFogExploration._onUpdateOperation
...
Inherited from BaseFogExploration._preCreateOperation
...
Inherited from BaseFogExploration._preDeleteOperation
...
Inherited from BaseFogExploration._preUpdateOperation
