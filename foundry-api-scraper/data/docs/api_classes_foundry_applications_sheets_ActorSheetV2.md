# ActorSheetV2 | Foundry Virtual Tabletop - API Documentation - Version 13
...
- new ActorSheetV2(options: any, ...args: any[]): ActorSheetV2Parametersoptions: any...args: any[]Returns ActorSheetV2Inherit DocInherited from DocumentSheetV2.constructor
- options: any
- ...args: any[]
...
`null`Inherited from DocumentSheetV2.tabGroups
...
`Static`Inherited from DocumentSheetV2.emittedEvents
...
- get actor(): documents.ActorThe Actor document managed by this sheet.
...
Returns DOMTokenListInherited from DocumentSheetV2.classList
...
Returns ClientDocumentInherited from DocumentSheetV2.document
...
Returns HTMLElementInherited from DocumentSheetV2.element
...
Returns null | HTMLFormElementInherited from DocumentSheetV2.form
...
Returns booleanInherited from DocumentSheetV2.hasFrame
...
Returns stringInherited from DocumentSheetV2.id
...
Returns booleanInherited from DocumentSheetV2.isEditable
...
Returns booleanInherited from DocumentSheetV2.isVisible
...
Returns booleanInherited from DocumentSheetV2.minimized
...
Returns booleanInherited from DocumentSheetV2.rendered
...
Returns numberInherited from DocumentSheetV2.state
...
- get title(): stringReturns stringInherited from DocumentSheetV2.title
...
- get token(): null | TokenDocumentIf this sheet manages the ActorDelta of an unlinked Token, reference that Token document.
...
Returns Promise<void>Inherited from DocumentSheetV2._awaitTransition
...
- _canRender(_options: any): voidParameters_options: anyReturns voidInherited from DocumentSheetV2._canRender
- _options: any
...
- _configureRenderOptions(options: any): voidParametersoptions: anyReturns voidInherit DocInherited from DocumentSheetV2._configureRenderOptions
- options: any
...
- _getHeaderControls(): ApplicationHeaderControlsEntry[]Returns ApplicationHeaderControlsEntry[]Overrides DocumentSheetV2._getHeaderControls
...
- _headerControlButtons(): Generator<    ApplicationHeaderControlsEntry,    void,    unknown,>Returns Generator<ApplicationHeaderControlsEntry, void, unknown>Inherit DocInherited from DocumentSheetV2._headerControlButtons
...
- _initializeApplicationOptions(options: any): anyParametersoptions: anyReturns anyInherit DocInherited from DocumentSheetV2._initializeApplicationOptions
- options: any
...
- _onChangeForm(formConfig: any, event: any): voidParametersformConfig: anyevent: anyReturns voidInherit DocInherited from DocumentSheetV2._onChangeForm
- formConfig: any
- event: any
...
- _onClose(options: any): voidParametersoptions: anyReturns voidInherit DocInherited from DocumentSheetV2._onClose
- options: any
...
- _onFirstRender(context: any, options: any): Promise<void>Parameterscontext: anyoptions: anyReturns Promise<void>Inherit DocInherited from DocumentSheetV2._onFirstRender
- context: any
- options: any
...
- _onRender(context: any, options: any): Promise<void>Parameterscontext: anyoptions: anyReturns Promise<void>Inherit DocOverrides DocumentSheetV2._onRender
- context: any
- options: any
...
- _prepareContext(    options: any,): Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    },>Parametersoptions: anyReturns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    },>Inherit DocInherited from DocumentSheetV2._prepareContext
- options: any
...
- _renderFrame(options: any): Promise<HTMLElement>Parametersoptions: anyReturns Promise<HTMLElement>Inherit DocInherited from DocumentSheetV2._renderFrame
- options: any
...
Returns voidInherited from DocumentSheetV2.bringToFront
...
Returns voidInherited from DocumentSheetV2.changeTab
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<ActorSheetV2>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<ActorSheetV2>A Promise which resolves to the closed Application instance
...
Returns Promise<void>Inherited from DocumentSheetV2.maximize
...
Returns Promise<void>Inherited from DocumentSheetV2.minimize
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<ActorSheetV2>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<ActorSheetV2>A Promise which resolves to the rendered Application instance
...
Returns voidInherited from DocumentSheetV2._attachFrameListeners
...
Returns null | ApplicationTabsConfigurationInherited from DocumentSheetV2._getTabsConfig
...
Returns voidInherited from DocumentSheetV2._insertElement
...
Returns voidInherited from DocumentSheetV2._onClickAction
...
Parametersevent: PointerEventReturns voidInherited from DocumentSheetV2._onClickTab
- event: PointerEvent
...
`Protected`- _onDragStart(event: DragEvent): Promise<void>ProtectedAn event that occurs when a drag workflow begins for a draggable item on the sheet.
Parametersevent: DragEventThe initiating drag start event
Returns Promise<void>
- event: DragEventThe initiating drag start event

`Protected`An event that occurs when a drag workflow begins for a draggable item on the sheet.
...
### Protected_onDropActiveEffect

`Protected`- _onDropActiveEffect(    event: DragEvent,    effect: documents.ActiveEffect,): Promise<undefined | null | documents.ActiveEffect>ProtectedHandle a dropped Active Effect on the Actor Sheet.
The default implementation creates an Active Effect embedded document on the Actor.
Parametersevent: DragEventThe initiating drop event
effect: documents.ActiveEffectThe dropped ActiveEffect document
Returns Promise<undefined | null | documents.ActiveEffect>A Promise resolving to a newly created ActiveEffect, if one was
created, or otherwise a nullish value
- event: DragEventThe initiating drop event
- effect: documents.ActiveEffectThe dropped ActiveEffect document

`Protected`Handle a dropped Active Effect on the Actor Sheet.
The default implementation creates an Active Effect embedded document on the Actor.
...
### Protected_onDropActor

`Protected`- _onDropActor(    event: DragEvent,    actor: documents.Actor,): Promise<undefined | null | documents.Actor>ProtectedHandle a dropped Actor on the Actor Sheet.
Parametersevent: DragEventThe initiating drop event
actor: documents.ActorThe dropped Actor document
Returns Promise<undefined | null | documents.Actor>A Promise resolving to an Actor identical or related to the dropped Actor
to indicate success, or a nullish value to indicate failure or no action
being taken
- event: DragEventThe initiating drop event
- actor: documents.ActorThe dropped Actor document

`Protected`Handle a dropped Actor on the Actor Sheet.
...
### Protected_onDropDocument

`Protected`- _onDropDocument<TDocument extends Document>(    event: DragEvent,    document: TDocument,): Promise<null | TDocument>ProtectedHandle a dropped document on the ActorSheet
Type ParametersTDocument extends DocumentParametersevent: DragEventThe initiating drop event
document: TDocumentThe resolved Document class
Returns Promise<null | TDocument>A Document of the same type as the dropped one in case of a successful result,
or null in case of failure or no action being taken
- TDocument extends Document
- event: DragEventThe initiating drop event
- document: TDocumentThe resolved Document class

`Protected`Handle a dropped document on the ActorSheet
...
### Protected_onDropFolder

`Protected`- _onDropFolder(    event: DragEvent,    folder: documents.Folder,): Promise<undefined | null | documents.Folder>ProtectedHandle a dropped Folder on the Actor Sheet.
Parametersevent: DragEventThe initiating drop event
folder: documents.FolderThe dropped Folder document
Returns Promise<undefined | null | documents.Folder>A Promise resolving to the dropped Folder indicate success, or a nullish
value to indicate failure or no action being taken
- event: DragEventThe initiating drop event
- folder: documents.FolderThe dropped Folder document

`Protected`Handle a dropped Folder on the Actor Sheet.
...
### Protected_onDropItem

`Protected`- _onDropItem(    event: DragEvent,    item: documents.Item,): Promise<undefined | null | documents.Item>ProtectedHandle a dropped Item on the Actor Sheet.
Parametersevent: DragEventThe initiating drop event
item: documents.ItemThe dropped Item document
Returns Promise<undefined | null | documents.Item>A Promise resolving to the dropped Item (if sorting), a newly created Item,
or a nullish value in case of failure or no action being taken
- event: DragEventThe initiating drop event
- item: documents.ItemThe dropped Item document

`Protected`Handle a dropped Item on the Actor Sheet.
...
Returns voidInherited from DocumentSheetV2._onPosition
...
Returns voidInherited from DocumentSheetV2._onRevealSecret
...
### Protected_onSortItem

`Protected`- _onSortItem(    event: DragEvent,    item: documents.Item,): void | Promise<documents.Item[]>ProtectedHandle a drop event for an existing embedded Item to sort that Item relative to its siblings.
Parametersevent: DragEventThe initiating drop event
item: documents.ItemThe dropped Item document
...
`Protected`Handle a drop event for an existing embedded Item to sort that Item relative to its siblings.
...
Returns Promise<void>Inherited from DocumentSheetV2._onSubmitForm
...
Returns Promise<void>Inherited from DocumentSheetV2._postRender
...
Returns Promise<void>Inherited from DocumentSheetV2._preClose
- options: ApplicationRenderOptions & DocumentSheetRenderOptionsProvided render options
...
Parameterscontext: ApplicationRenderContextPrepared context data
options: ApplicationRenderOptions & DocumentSheetRenderOptionsProvided render options
Returns Promise<void>Inherited from DocumentSheetV2._preFirstRender
- context: ApplicationRenderContextPrepared context data
- options: ApplicationRenderOptions & DocumentSheetRenderOptionsProvided render options
...
Returns Record<string, ApplicationTab>Inherited from DocumentSheetV2._prepareTabs
...
Parametersposition: ApplicationPositionThe requested application position
Returns voidInherited from DocumentSheetV2._prePosition
- position: ApplicationPositionThe requested application position
...
Parameterscontext: ApplicationRenderContextPrepared context data
options: ApplicationRenderOptions & DocumentSheetRenderOptionsProvided render options
Returns Promise<void>Inherited from DocumentSheetV2._preRender
- context: ApplicationRenderContextPrepared context data
- options: ApplicationRenderOptions & DocumentSheetRenderOptionsProvided render options
...
Returns Promise<void>Inherited from DocumentSheetV2._processSubmitData
- event: SubmitEventThe originating form submission event
- form: HTMLFormElementThe form element that was submitted
- submitData: objectProcessed and validated form data to be used for a document update
- Optionaloptions: Partial<DatabaseCreateOperation | DatabaseUpdateOperation> = {}Additional options altering the request
...
Returns voidInherited from DocumentSheetV2._removeElement
...
Parameterscontrol: ApplicationHeaderControlsEntryReturns HTMLLIElementInherited from DocumentSheetV2._renderHeaderControl
...
options: ApplicationRenderOptions & DocumentSheetRenderOptionsOptions which configure application rendering behavior
Returns voidInherited from DocumentSheetV2._replaceHTML
...
Parametersoptions: ApplicationClosingOptionsReturns voidInherited from DocumentSheetV2._tearDown
...
Returns voidInherited from DocumentSheetV2._toggleDisabled
...
Returns voidInherited from DocumentSheetV2._updateFrame
