# RegionDocument | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.RegionDocument.html
...
- foundry.documents.Scene: The Scene document type which contains Region documents
- foundry.applications.sheets.RegionConfig: The Region configuration application


#### Hierarchy (View Summary)

- BaseRegion<this>RegionDocument
- RegionDocument
...
- new RegionDocument(    data?: Partial<RegionData>,    options?: DocumentConstructionContext,): RegionDocumentParametersOptionaldata: Partial<RegionData> = {}Initial data used to construct the data object. The provided object will be
...
Returns RegionDocumentInherited from BaseRegion.constructor
- Optionaldata: Partial<RegionData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseRegion.constructor
...
Inherited from BaseRegion._source
...
Inherited from BaseRegion.parent


### Readonlytokens

`Readonly`The tokens inside this region.
...
Inherited from BaseRegion._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseRegion.LOCALIZATION_PREFIXES
...
Inherited from BaseRegion.metadata
...
- get bounds(): RectangleThe bounds of this Region.
...
- get clipperPaths(): readonly (readonly IntPoint[])[]The Clipper paths of this Region.
The value of this property must not be mutated.
This property is updated only by a document update.
...
Returns anyInherited from CanvasDocumentMixin(BaseRegion).compendium
...
Returns null | stringInherited from CanvasDocumentMixin(BaseRegion).id
...
Returns booleanInherited from CanvasDocumentMixin(BaseRegion).inCompendium
...
Returns booleanInherited from CanvasDocumentMixin(BaseRegion).invalid
...
Returns booleanInherited from CanvasDocumentMixin(BaseRegion).isEmbedded
...
- get polygons(): readonly Polygon[]The polygons of this Region.
The value of this property must not be mutated.
This property is updated only by a document update.
...
- get polygonTree(): RegionPolygonTreeThe polygon tree of this Region.
The value of this property must not be mutated.
This property is updated only by a document update.
...
- get regionShapes(): readonly RegionShape<BaseShapeData>[]The shapes of this Region.
The value of this property must not be mutated.
This property is updated only by a document update.
Returns readonly RegionShape<BaseShapeData>[]
...
Returns SchemaFieldInherited from CanvasDocumentMixin(BaseRegion).schema
...
- get triangulation(): Readonly<    { indices: Uint16Array    | Uint32Array; vertices: Float32Array },>The triangulation of this Region.
The value of this property must not be mutated.
This property is updated only by a document update.
...
Returns stringInherited from CanvasDocumentMixin(BaseRegion).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from CanvasDocumentMixin(BaseRegion).validationFailures
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseRegion).baseDocument
...
Returns stringInherited from CanvasDocumentMixin(BaseRegion).collectionName
...
Returns abstract.DatabaseBackendInherited from CanvasDocumentMixin(BaseRegion).database
...
Returns stringInherited from CanvasDocumentMixin(BaseRegion).documentName
...
Returns booleanInherited from CanvasDocumentMixin(BaseRegion).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from CanvasDocumentMixin(BaseRegion).hierarchy
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseRegion).implementation
...
Returns string[]Inherited from CanvasDocumentMixin(BaseRegion).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseRegion._configure
...
Inherited from BaseRegion._configure
...
Returns null | stringInherited from BaseRegion._getParentCollection
...
Inherited from BaseRegion._getParentCollection


### _handleEvent

- _handleEvent(event: RegionEvent): Promise<void>InternalHandle the Region event.
Parametersevent: RegionEventThe Region event
Returns Promise<void>
- event: RegionEventThe Region event

`Internal`Handle the Region event.
...
Returns voidOverrides BaseRegion._onUpdate
...
Overrides BaseRegion._onUpdate
...
- _triggerEvent(eventName: string, eventData: object): Promise<void>InternalTrigger the Region event.
ParameterseventName: stringThe event name
eventData: objectThe event data
Returns Promise<void>
- eventName: stringThe event name
- eventData: objectThe event data

`Internal`Trigger the Region event.
...
Inherited from BaseRegion.canUserModify
...
Inherited from BaseRegion.clone
...
Inherited from BaseRegion.createEmbeddedDocuments
...
Inherited from BaseRegion.delete
...
SeeDocument.deleteDocuments
Inherited from BaseRegion.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseRegion.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseRegion.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseRegion.getFlag
...
Inherited from BaseRegion.getUserLevel
...
Inherited from BaseRegion.migrateSystemData
...
Returns voidInherited from BaseRegion.reset
...
Inherited from BaseRegion.reset


### segmentizeMovementPath

- segmentizeMovementPath(    waypoints: RegionSegmentizeMovementPathWaypoint[],    samples: Point[],): RegionMovementSegment[]Split the movement path into its segments.
Parameterswaypoints: RegionSegmentizeMovementPathWaypoint[]The waypoints of movement.
samples: Point[]The points relative to the waypoints that are tested.
...
Inherited from BaseRegion.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
- teleportToken(token: TokenDocument): Promise<TokenDocument>Teleport a Token into this Region.
...
Parameterstoken: TokenDocumentAn existing Token Document to teleport
...
- token: TokenDocumentAn existing Token Document to teleport
...
- testPoint(point: ElevatedPoint): booleanTest whether the given point (at the given elevation) is inside this Region.
Parameterspoint: ElevatedPointThe point.
Returns booleanIs the point inside this Region?
...
Inherited from BaseRegion.testUserPermission
...
Inherited from BaseRegion.toJSON
...
Inherited from BaseRegion.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseRegion.traverseEmbeddedDocuments
...
Inherited from BaseRegion.traverseEmbeddedDocuments
...
Inherited from BaseRegion.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseRegion.update
...
SeeDocument.updateDocuments
Inherited from BaseRegion.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseRegion.updateSource
...
Inherited from BaseRegion.validate
...
Returns voidInherited from BaseRegion._initialize
...
Inherited from BaseRegion._initialize
...
Inherited from BaseRegion._initializeSource
...
`data`Inherited from BaseRegion._initializeSource
...
Returns voidInherited from BaseRegion._onCreate
...
Inherited from BaseRegion._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseRegion._onDelete
...
Inherited from BaseRegion._onDelete
...
Inherited from BaseRegion._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseRegion._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseRegion._preUpdate
...
`Static`- _activateSocketListeners(    socket: Socket<DefaultEventsMap, DefaultEventsMap>,): voidInternalActivate the Socket event listeners.
Parameterssocket: Socket<DefaultEventsMap, DefaultEventsMap>The active game socket
Returns void
- socket: Socket<DefaultEventsMap, DefaultEventsMap>The active game socket

`Internal`Activate the Socket event listeners.
...
Inherited from BaseRegion._addDataFieldMigration
...
Returns voidInherited from BaseRegion._addDataFieldShim
...
Inherited from BaseRegion._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseRegion._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseRegion._addDataFieldShims
...
Returns voidInherited from BaseRegion._clearFieldsRecusively
...
Inherited from BaseRegion._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseRegion._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseRegion._initializationOrder
...
Returns voidInherited from BaseRegion._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseRegion._logDataFieldMigration


### Static_onCreateOperation

`Static`- _onCreateOperation(documents: any, operation: any, user: any): Promise<void>Parametersdocuments: anyoperation: anyuser: anyReturns Promise<void>Overrides BaseRegion._onCreateOperation
- documents: any
- operation: any
- user: any
...
Overrides BaseRegion._onCreateOperation


### Static_onDeleteOperation

`Static`- _onDeleteOperation(documents: any, operation: any, user: any): Promise<void>Parametersdocuments: anyoperation: anyuser: anyReturns Promise<void>Overrides BaseRegion._onDeleteOperation
- documents: any
- operation: any
- user: any
...
Overrides BaseRegion._onDeleteOperation


### Static_onUpdateOperation

`Static`- _onUpdateOperation(documents: any, operation: any, user: any): Promise<void>Parametersdocuments: anyoperation: anyuser: anyReturns Promise<void>Overrides BaseRegion._onUpdateOperation
- documents: any
- operation: any
- user: any
...
Overrides BaseRegion._onUpdateOperation
...
Inherited from BaseRegion.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseRegion.cleanData
...
`source`Inherited from BaseRegion.cleanData
...
Inherited from BaseRegion.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseRegion.create
...
Inherited from BaseRegion.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseRegion.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    behaviors: EmbeddedCollectionField;    color: ColorField;    elevation: SchemaField;    flags: DocumentFlagsField;    locked: BooleanField;    name: StringField;    shapes: ArrayField<TypedSchemaField>;    visibility: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    behaviors: EmbeddedCollectionField;    color: ColorField;    elevation: SchemaField;    flags: DocumentFlagsField;    locked: BooleanField;    name: StringField;    shapes: ArrayField<TypedSchemaField>;    visibility: NumberField;}Inherited from BaseRegion.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    behaviors: EmbeddedCollectionField;    color: ColorField;    elevation: SchemaField;    flags: DocumentFlagsField;    locked: BooleanField;    name: StringField;    shapes: ArrayField<TypedSchemaField>;    visibility: NumberField;}

Inherited from BaseRegion.defineSchema
...
Inherited from BaseRegion.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseRegion.deleteDocuments
...
Inherited from BaseRegion.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseRegion.fromSource
...
Inherited from BaseRegion.fromSource
...
Inherited from BaseRegion.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseRegion.getCollectionName
...
Inherited from BaseRegion.migrateData
...
`source`Inherited from BaseRegion.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseRegion.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseRegion.migrateDataSafe
...
the data argument
Inherited from BaseRegion.shimData
...
`data`Inherited from BaseRegion.shimData
...
Inherited from BaseRegion.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseRegion.updateDocuments
...
Inherited from BaseRegion.validateJoint
...
Inherited from BaseRegion._preCreateOperation
...
Inherited from BaseRegion._preDeleteOperation
...
Inherited from BaseRegion._preUpdateOperation
