# AmbientSoundConfig | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.AmbientSoundConfig.html
...
- DocumentSheetV2<this>AmbientSoundConfig
- AmbientSoundConfig
...
- new AmbientSoundConfig(options: any, ...args: any[]): AmbientSoundConfigParametersoptions: any...args: any[]Returns AmbientSoundConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- _prepareContext(    options: any,): Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        gridUnits: any;        sound: ClientDocument;        soundEffects: Record<            string,            {                effectClass: | new (                    context: BaseAudioContext,                    options?: BiquadFilterOptions,                ) => BiquadFilterNode                | new (                    context: BaseAudioContext,                    options?: ConvolverOptions,                ) => ConvolverNode;                label: string;            },        >;    },>Parametersoptions: anyReturns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        gridUnits: any;        sound: ClientDocument;        soundEffects: Record<            string,            {                effectClass: | new (                    context: BaseAudioContext,                    options?: BiquadFilterOptions,                ) => BiquadFilterNode                | new (                    context: BaseAudioContext,                    options?: ConvolverOptions,                ) => ConvolverNode;                label: string;            },        >;    },>Inherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareContext
- options: any
...
#### Returns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        buttons: { icon: string; label: string; type: string }[];        gridUnits: any;        sound: ClientDocument;        soundEffects: Record<            string,            {                effectClass: | new (                    context: BaseAudioContext,                    options?: BiquadFilterOptions,                ) => BiquadFilterNode                | new (                    context: BaseAudioContext,                    options?: ConvolverOptions,                ) => ConvolverNode;                label: string;            },        >;    },>
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<AmbientSoundConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<AmbientSoundConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<AmbientSoundConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<AmbientSoundConfig>A Promise which resolves to the rendered Application instance
