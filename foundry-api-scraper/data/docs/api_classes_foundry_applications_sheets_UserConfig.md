...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.UserConfig.html
...
- DocumentSheetV2<this>UserConfig
- UserConfig
...
- new UserConfig(options: any, ...args: any[]): UserConfigParametersoptions: any...args: any[]Returns UserConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<UserConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<UserConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<UserConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<UserConfig>A Promise which resolves to the rendered Application instance
