# BasePlaylist | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BasePlaylist.html
...
- DocumentBasePlaylistdocuments.Playlist
- BasePlaylistdocuments.Playlist
- documents.Playlist
...
- new BasePlaylist(    data?: Partial<PlaylistData>,    options?: DocumentConstructionContext,): BasePlaylistParametersOptionaldata: Partial<PlaylistData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BasePlaylistInherited from Document.constructor
