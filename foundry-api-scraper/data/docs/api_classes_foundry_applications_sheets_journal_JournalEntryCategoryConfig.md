...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.journal.JournalEntryCategoryConfig.html
...
- DocumentSheetV2<this>JournalEntryCategoryConfig
- JournalEntryCategoryConfig
...
- new JournalEntryCategoryConfig(    options: any,    ...args: any[],): JournalEntryCategoryConfigParametersoptions: any...args: any[]Returns JournalEntryCategoryConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- get title(): stringReturns stringOverrides HandlebarsApplicationMixin(DocumentSheetV2).title
...
- close(    options?: Partial<ApplicationClosingOptions>,): Promise<JournalEntryCategoryConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<JournalEntryCategoryConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<JournalEntryCategoryConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<JournalEntryCategoryConfig>A Promise which resolves to the rendered Application instance
