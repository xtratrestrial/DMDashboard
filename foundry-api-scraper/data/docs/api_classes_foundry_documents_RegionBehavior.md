...
Source: https://foundryvtt.com/api/classes/foundry.documents.RegionBehavior.html
...
- foundry.documents.RegionDocument: The Region document type which contains
RegionBehavior documents
- foundry.applications.sheets.RegionBehaviorConfig: The RegionBehaviorConfig
configuration application


#### Hierarchy (View Summary)

- BaseRegionBehavior<this>RegionBehavior
- RegionBehavior
...
- new RegionBehavior(    data?: Partial<RegionBehaviorData>,    options?: DocumentConstructionContext,): documents.RegionBehaviorParametersOptionaldata: Partial<RegionBehaviorData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.RegionBehaviorInherited from BaseRegionBehavior.constructor
- Optionaldata: Partial<RegionBehaviorData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
#### Returns documents.RegionBehavior

Inherited from BaseRegionBehavior.constructor
...
Inherited from BaseRegionBehavior._source
...
Inherited from BaseRegionBehavior.parent
...
Inherited from BaseRegionBehavior._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseRegionBehavior.LOCALIZATION_PREFIXES
...
Inherited from BaseRegionBehavior.metadata
...
- get active(): booleanA RegionBehavior is active if and only if it was created, hasn't been deleted yet, and isn't disabled.
Returns boolean
...
Returns anyInherited from ClientDocumentMixin(BaseRegionBehavior).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseRegionBehavior).id
...
Returns booleanInherited from ClientDocumentMixin(BaseRegionBehavior).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseRegionBehavior).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseRegionBehavior).isEmbedded
...
- get region(): null | RegionDocumentA convenience reference to the RegionDocument which contains this RegionBehavior.
...
- get scene(): null | documents.SceneA convenience reference to the Scene which contains this RegionBehavior.
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseRegionBehavior).schema
...
Returns stringInherited from ClientDocumentMixin(BaseRegionBehavior).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseRegionBehavior).validationFailures
...
- get viewed(): booleanA RegionBehavior is viewed if and only if it is active and the Scene of its Region is viewed.
Returns boolean
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseRegionBehavior).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseRegionBehavior).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseRegionBehavior).database
...
Returns stringInherited from ClientDocumentMixin(BaseRegionBehavior).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseRegionBehavior).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseRegionBehavior).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseRegionBehavior).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseRegionBehavior).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseRegionBehavior._configure
...
Inherited from BaseRegionBehavior._configure
...
Returns null | stringInherited from BaseRegionBehavior._getParentCollection
...
Inherited from BaseRegionBehavior._getParentCollection


### _handleRegionEvent

- _handleRegionEvent(event: RegionEvent): Promise<void>InternalHandle the Region event.
...
Inherited from BaseRegionBehavior.canUserModify
...
Inherited from BaseRegionBehavior.clone
...
Inherited from BaseRegionBehavior.createEmbeddedDocuments
...
Inherited from BaseRegionBehavior.delete
...
SeeDocument.deleteDocuments
Inherited from BaseRegionBehavior.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseRegionBehavior.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseRegionBehavior.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseRegionBehavior.getFlag
...
Inherited from BaseRegionBehavior.getUserLevel
...
- hasEvent(eventName: string): booleanDoes this RegionBehavior handle the Region events with the given name?
ParameterseventName: stringThe Region event name
Returns boolean
- eventName: stringThe Region event name
...
Inherited from BaseRegionBehavior.migrateSystemData
...
Returns voidInherited from BaseRegionBehavior.reset
...
Inherited from BaseRegionBehavior.reset
...
Inherited from BaseRegionBehavior.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseRegionBehavior.testUserPermission
...
Inherited from BaseRegionBehavior.toJSON
...
Inherited from BaseRegionBehavior.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseRegionBehavior.traverseEmbeddedDocuments
...
Inherited from BaseRegionBehavior.traverseEmbeddedDocuments
...
Inherited from BaseRegionBehavior.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseRegionBehavior.update
...
SeeDocument.updateDocuments
Inherited from BaseRegionBehavior.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseRegionBehavior.updateSource
...
Inherited from BaseRegionBehavior.validate
...
Returns voidInherited from BaseRegionBehavior._initialize
...
Inherited from BaseRegionBehavior._initialize
...
Inherited from BaseRegionBehavior._initializeSource
...
`data`Inherited from BaseRegionBehavior._initializeSource
...
Returns voidInherited from BaseRegionBehavior._onCreate
...
Inherited from BaseRegionBehavior._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseRegionBehavior._onDelete
...
Inherited from BaseRegionBehavior._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseRegionBehavior._onUpdate
...
Inherited from BaseRegionBehavior._onUpdate
...
Inherited from BaseRegionBehavior._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseRegionBehavior._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseRegionBehavior._preUpdate
...
Inherited from BaseRegionBehavior._addDataFieldMigration
...
Returns voidInherited from BaseRegionBehavior._addDataFieldShim
...
Inherited from BaseRegionBehavior._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseRegionBehavior._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseRegionBehavior._addDataFieldShims
...
Returns voidInherited from BaseRegionBehavior._clearFieldsRecusively
...
Inherited from BaseRegionBehavior._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseRegionBehavior._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseRegionBehavior._initializationOrder
...
Returns voidInherited from BaseRegionBehavior._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseRegionBehavior._logDataFieldMigration


### StaticcanUserCreate

`Static`- canUserCreate(user: any): anyParametersuser: anyReturns anyInherited from BaseRegionBehavior.canUserCreate
- user: any
...
Inherited from BaseRegionBehavior.canUserCreate
...
Inherited from BaseRegionBehavior.cleanData
...
`source`Inherited from BaseRegionBehavior.cleanData
...
Inherited from BaseRegionBehavior.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseRegionBehavior.create


### StaticcreateDialog

`Static`- createDialog(data: any, createOptions: any, dialogOptions: any): Promise<any>Parametersdata: anycreateOptions: anydialogOptions: anyReturns Promise<any>Inherit DocOverrides ClientDocumentMixin(BaseRegionBehavior).createDialog
- data: any
- createOptions: any
- dialogOptions: any
...
Inherited from BaseRegionBehavior.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseRegionBehavior.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    disabled: BooleanField;    flags: DocumentFlagsField;    name: StringField;    system: TypeDataField;    type: DocumentTypeField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    disabled: BooleanField;    flags: DocumentFlagsField;    name: StringField;    system: TypeDataField;    type: DocumentTypeField;}Inherited from BaseRegionBehavior.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    disabled: BooleanField;    flags: DocumentFlagsField;    name: StringField;    system: TypeDataField;    type: DocumentTypeField;}

Inherited from BaseRegionBehavior.defineSchema
...
Inherited from BaseRegionBehavior.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseRegionBehavior.deleteDocuments
...
Inherited from BaseRegionBehavior.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseRegionBehavior.fromSource
...
Inherited from BaseRegionBehavior.fromSource
...
Inherited from BaseRegionBehavior.get
...
Inherited from BaseRegionBehavior.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseRegionBehavior.getCollectionName
...
Inherited from BaseRegionBehavior.migrateData
...
`source`Inherited from BaseRegionBehavior.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseRegionBehavior.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseRegionBehavior.migrateDataSafe
...
the data argument
Inherited from BaseRegionBehavior.shimData
...
`data`Inherited from BaseRegionBehavior.shimData
...
Inherited from BaseRegionBehavior.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseRegionBehavior.updateDocuments
...
Inherited from BaseRegionBehavior.validateJoint
...
Returns Promise<void>Inherited from BaseRegionBehavior._onCreateOperation
...
Inherited from BaseRegionBehavior._onCreateOperation
...
Returns Promise<void>Inherited from BaseRegionBehavior._onDeleteOperation
...
Inherited from BaseRegionBehavior._onDeleteOperation
...
Returns Promise<void>Inherited from BaseRegionBehavior._onUpdateOperation
...
Inherited from BaseRegionBehavior._onUpdateOperation
...
Inherited from BaseRegionBehavior._preCreateOperation
...
Inherited from BaseRegionBehavior._preDeleteOperation
...
Inherited from BaseRegionBehavior._preUpdateOperation
