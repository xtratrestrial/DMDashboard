...
Source: https://foundryvtt.com/api/classes/foundry.documents.Macro.html
...
- foundry.documents.collections.Macros: The world-level collection of Macro documents
- foundry.applications.sheets.MacroConfig: The Macro configuration application


#### Hierarchy (View Summary)

- BaseMacro<this>Macro
- Macro
...
- new Macro(    data?: Partial<MacroData>,    options?: DocumentConstructionContext,): documents.MacroParametersOptionaldata: Partial<MacroData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.MacroInherited from BaseMacro.constructor
- Optionaldata: Partial<MacroData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
#### Returns documents.Macro

Inherited from BaseMacro.constructor
...
Inherited from BaseMacro._source
...
Inherited from BaseMacro.parent
...
Inherited from BaseMacro._schema
...
Inherited from BaseMacro.DEFAULT_ICON


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseMacro.LOCALIZATION_PREFIXES
...
Inherited from BaseMacro.metadata
...
- get canExecute(): booleanTest whether the current User is capable of executing this Macro.
Returns boolean
...
Returns anyInherited from ClientDocumentMixin(BaseMacro).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseMacro).id
...
Returns booleanInherited from ClientDocumentMixin(BaseMacro).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseMacro).invalid
...
- get isAuthor(): booleanIs the current User the author of this macro?
Returns boolean
...
Returns booleanInherited from ClientDocumentMixin(BaseMacro).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseMacro).schema
...
Returns stringInherited from ClientDocumentMixin(BaseMacro).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseMacro).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseMacro).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseMacro).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseMacro).database
...
Returns stringInherited from ClientDocumentMixin(BaseMacro).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseMacro).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseMacro).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseMacro).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseMacro).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseMacro._configure
...
Inherited from BaseMacro._configure
...
Returns null | stringInherited from BaseMacro._getParentCollection
...
Inherited from BaseMacro._getParentCollection
...
Returns voidInherited from BaseMacro._initialize
...
Inherited from BaseMacro._initialize


### _onClickDocumentLink

- _onClickDocumentLink(event: any): void | Promise<unknown>Parametersevent: anyReturns void | Promise<unknown>Inherit Doc
- event: any
...
Returns voidOverrides BaseMacro._onCreate
...
Inherited from BaseMacro._preCreate
- data: anyThe initial data object provided to the document creation request
- options: anyAdditional options which modify the creation request
- user: anyThe User requesting the document creation
...
- canUserExecute(user: documents.User): booleanTest whether the given User is capable of executing this Macro.
Parametersuser: documents.UserThe User to test.
Returns booleanCan this User execute this Macro?
- user: documents.UserThe User to test.
...
Inherited from BaseMacro.canUserModify
...
Inherited from BaseMacro.clone
...
Inherited from BaseMacro.createEmbeddedDocuments
...
Inherited from BaseMacro.delete
...
SeeDocument.deleteDocuments
Inherited from BaseMacro.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
- execute(    scope?: {        actor?: any;        event?: Event | RegionEvent;        speaker?: any;        token?: any;    },): void| Promise<unknown>Execute the Macro command.
ParametersOptionalscope: { actor?: any; event?: Event | RegionEvent; speaker?: any; token?: any } = {}Macro execution scope which is passed to script macros
Optionalactor?: anyAn Actor who is the protagonist of the executed action
Optionalevent?: Event | RegionEventAn optional event passed to the executed macro
Optionalspeaker?: anyThe speaker data
Optionaltoken?: anyA Token which is the protagonist of the executed action
Returns void | Promise<unknown>A promise containing a created foundry.documents.ChatMessage
...
- Optionalscope: { actor?: any; event?: Event | RegionEvent; speaker?: any; token?: any } = {}Macro execution scope which is passed to script macros
Optionalactor?: anyAn Actor who is the protagonist of the executed action
Optionalevent?: Event | RegionEventAn optional event passed to the executed macro
Optionalspeaker?: anyThe speaker data
Optionaltoken?: anyA Token which is the protagonist of the executed action
...
`Optional`Macro execution scope which is passed to script macros
...
`Optional`An Actor who is the protagonist of the executed action


##### Optionalevent?: Event | RegionEvent

`Optional`An optional event passed to the executed macro
...
`Optional`A Token which is the protagonist of the executed action


#### Returns void | Promise<unknown>

A promise containing a created foundry.documents.ChatMessage
(or undefined) if a chat  macro or the return value if a script macro.
A void return is possible if the user is not permitted to execute macros
or a script macro execution fails.
...
Inherited from BaseMacro.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseMacro.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseMacro.getFlag
...
Inherited from BaseMacro.getUserLevel
...
Inherited from BaseMacro.migrateSystemData
...
Returns voidInherited from BaseMacro.reset
...
Inherited from BaseMacro.reset
...
Inherited from BaseMacro.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseMacro.testUserPermission
...
Inherited from BaseMacro.toJSON
...
Inherited from BaseMacro.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseMacro.traverseEmbeddedDocuments
...
Inherited from BaseMacro.traverseEmbeddedDocuments
...
Inherited from BaseMacro.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseMacro.update
...
SeeDocument.updateDocuments
Inherited from BaseMacro.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseMacro.updateSource
...
Inherited from BaseMacro.validate
...
Inherited from BaseMacro._initializeSource
...
`data`Inherited from BaseMacro._initializeSource
...
Returns voidInherited from BaseMacro._onDelete
...
Inherited from BaseMacro._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseMacro._onUpdate
...
Inherited from BaseMacro._onUpdate
...
Inherited from BaseMacro._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseMacro._preUpdate
...
Inherited from BaseMacro._addDataFieldMigration
...
Returns voidInherited from BaseMacro._addDataFieldShim
...
Inherited from BaseMacro._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseMacro._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseMacro._addDataFieldShims
...
Returns voidInherited from BaseMacro._clearFieldsRecusively
...
Inherited from BaseMacro._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseMacro._initializationOrder
...
Returns voidInherited from BaseMacro._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseMacro._logDataFieldMigration


### StaticcanUserCreate

`Static`- canUserCreate(user: any): anyParametersuser: anyReturns anyInherited from BaseMacro.canUserCreate
- user: any
...
Inherited from BaseMacro.canUserCreate
...
Inherited from BaseMacro.cleanData
...
`source`Inherited from BaseMacro.cleanData
...
Inherited from BaseMacro.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseMacro.create
...
Inherited from BaseMacro.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseMacro.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    author: DocumentAuthorField;    command: StringField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    img: FilePathField;    name: StringField;    ownership: DocumentOwnershipField;    scope: StringField;    sort: IntegerSortField;    type: DocumentTypeField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    author: DocumentAuthorField;    command: StringField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    img: FilePathField;    name: StringField;    ownership: DocumentOwnershipField;    scope: StringField;    sort: IntegerSortField;    type: DocumentTypeField;}Inherited from BaseMacro.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    author: DocumentAuthorField;    command: StringField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    img: FilePathField;    name: StringField;    ownership: DocumentOwnershipField;    scope: StringField;    sort: IntegerSortField;    type: DocumentTypeField;}
...
Inherited from BaseMacro.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseMacro.deleteDocuments
...
Inherited from BaseMacro.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseMacro.fromSource
...
Inherited from BaseMacro.fromSource
...
Inherited from BaseMacro.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseMacro.getCollectionName
...
Inherited from BaseMacro.migrateData
...
`source`Inherited from BaseMacro.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseMacro.migrateDataSafe
...
`source`Inherited from BaseMacro.migrateDataSafe
...
the data argument
Inherited from BaseMacro.shimData
...
`data`Inherited from BaseMacro.shimData
...
Inherited from BaseMacro.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseMacro.updateDocuments


### StaticvalidateJoint

`Static`- validateJoint(data: any): voidParametersdata: anyReturns voidInherited from BaseMacro.validateJoint
- data: any
...
Inherited from BaseMacro.validateJoint
...
Returns Promise<void>Inherited from BaseMacro._onCreateOperation
...
Inherited from BaseMacro._onCreateOperation
...
Returns Promise<void>Inherited from BaseMacro._onDeleteOperation
...
Inherited from BaseMacro._onDeleteOperation
...
Returns Promise<void>Inherited from BaseMacro._onUpdateOperation
...
Inherited from BaseMacro._onUpdateOperation
...
Inherited from BaseMacro._preCreateOperation
...
Inherited from BaseMacro._preDeleteOperation
...
Inherited from BaseMacro._preUpdateOperation
