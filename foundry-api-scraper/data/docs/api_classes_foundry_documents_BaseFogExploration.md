...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseFogExploration.html
...
- DocumentBaseFogExplorationdocuments.FogExploration
- BaseFogExplorationdocuments.FogExploration
...
- new BaseFogExploration(    data?: Partial<FogExplorationData>,    options?: DocumentConstructionContext,): BaseFogExplorationParametersOptionaldata: Partial<FogExplorationData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseFogExplorationInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    explored: FilePathField;    flags: DocumentFlagsField;    positions: ObjectField;    scene: ForeignDocumentField;    timestamp: NumberField;    user: ForeignDocumentField;}Overrides Document.defineSchema
