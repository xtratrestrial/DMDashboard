# MeasuredTemplateDocument | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.MeasuredTemplateDocument.html
...
- foundry.documents.Scene: The Scene document type which contains MeasuredTemplate documents
- foundry.applications.sheets.MeasuredTemplateConfig: The MeasuredTemplate
configuration application


#### Hierarchy (View Summary)

- BaseMeasuredTemplate<this>MeasuredTemplateDocument
- MeasuredTemplateDocument
...
- new MeasuredTemplateDocument(    data?: Partial<MeasuredTemplateData>,    options?: DocumentConstructionContext,): MeasuredTemplateDocumentParametersOptionaldata: Partial<MeasuredTemplateData> = {}Initial data used to construct the data object. The provided object will be
...
Returns MeasuredTemplateDocumentInherited from BaseMeasuredTemplate.constructor
- Optionaldata: Partial<MeasuredTemplateData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseMeasuredTemplate.constructor
...
Inherited from BaseMeasuredTemplate._source
...
Inherited from BaseMeasuredTemplate.parent
...
Inherited from BaseMeasuredTemplate._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseMeasuredTemplate.LOCALIZATION_PREFIXES
...
Inherited from BaseMeasuredTemplate.metadata
...
Returns anyInherited from CanvasDocumentMixin(BaseMeasuredTemplate).compendium
...
Returns null | stringInherited from CanvasDocumentMixin(BaseMeasuredTemplate).id
...
Returns booleanInherited from CanvasDocumentMixin(BaseMeasuredTemplate).inCompendium
...
Returns booleanInherited from CanvasDocumentMixin(BaseMeasuredTemplate).invalid
...
- get isAuthor(): booleanIs the current User the author of this template?
Returns boolean
...
Returns booleanInherited from CanvasDocumentMixin(BaseMeasuredTemplate).isEmbedded
...
- get rotation(): numberRotation is an alias for direction
Returns number
...
Returns SchemaFieldInherited from CanvasDocumentMixin(BaseMeasuredTemplate).schema
...
Returns stringInherited from CanvasDocumentMixin(BaseMeasuredTemplate).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from CanvasDocumentMixin(BaseMeasuredTemplate).validationFailures
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseMeasuredTemplate).baseDocument
...
Returns stringInherited from CanvasDocumentMixin(BaseMeasuredTemplate).collectionName
...
Returns abstract.DatabaseBackendInherited from CanvasDocumentMixin(BaseMeasuredTemplate).database
...
Returns stringInherited from CanvasDocumentMixin(BaseMeasuredTemplate).documentName
...
Returns booleanInherited from CanvasDocumentMixin(BaseMeasuredTemplate).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from CanvasDocumentMixin(BaseMeasuredTemplate).hierarchy
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseMeasuredTemplate).implementation
...
Returns string[]Inherited from CanvasDocumentMixin(BaseMeasuredTemplate).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseMeasuredTemplate._configure
...
Inherited from BaseMeasuredTemplate._configure
...
Returns null | stringInherited from BaseMeasuredTemplate._getParentCollection
...
Inherited from BaseMeasuredTemplate._getParentCollection
...
Inherited from BaseMeasuredTemplate.canUserModify
...
Inherited from BaseMeasuredTemplate.clone
...
Inherited from BaseMeasuredTemplate.createEmbeddedDocuments
...
Inherited from BaseMeasuredTemplate.delete
...
SeeDocument.deleteDocuments
Inherited from BaseMeasuredTemplate.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseMeasuredTemplate.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseMeasuredTemplate.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseMeasuredTemplate.getFlag
...
Inherited from BaseMeasuredTemplate.getUserLevel
...
Inherited from BaseMeasuredTemplate.migrateSystemData
...
Returns voidInherited from BaseMeasuredTemplate.reset
...
Inherited from BaseMeasuredTemplate.reset
...
Inherited from BaseMeasuredTemplate.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseMeasuredTemplate.testUserPermission
...
Inherited from BaseMeasuredTemplate.toJSON
...
Inherited from BaseMeasuredTemplate.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseMeasuredTemplate.traverseEmbeddedDocuments
...
Inherited from BaseMeasuredTemplate.traverseEmbeddedDocuments
...
Inherited from BaseMeasuredTemplate.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseMeasuredTemplate.update
...
SeeDocument.updateDocuments
Inherited from BaseMeasuredTemplate.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseMeasuredTemplate.updateSource
...
Inherited from BaseMeasuredTemplate.validate
...
Returns voidInherited from BaseMeasuredTemplate._initialize
...
Inherited from BaseMeasuredTemplate._initialize
...
Inherited from BaseMeasuredTemplate._initializeSource
...
`data`Inherited from BaseMeasuredTemplate._initializeSource
...
Returns voidInherited from BaseMeasuredTemplate._onCreate
...
Inherited from BaseMeasuredTemplate._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseMeasuredTemplate._onDelete
...
Inherited from BaseMeasuredTemplate._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseMeasuredTemplate._onUpdate
...
Inherited from BaseMeasuredTemplate._onUpdate
...
Inherited from BaseMeasuredTemplate._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseMeasuredTemplate._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseMeasuredTemplate._preUpdate
...
Inherited from BaseMeasuredTemplate._addDataFieldMigration
...
Returns voidInherited from BaseMeasuredTemplate._addDataFieldShim
...
Inherited from BaseMeasuredTemplate._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseMeasuredTemplate._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseMeasuredTemplate._addDataFieldShims
...
Returns voidInherited from BaseMeasuredTemplate._clearFieldsRecusively
...
Inherited from BaseMeasuredTemplate._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseMeasuredTemplate._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseMeasuredTemplate._initializationOrder
...
Returns voidInherited from BaseMeasuredTemplate._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseMeasuredTemplate._logDataFieldMigration
...
Inherited from BaseMeasuredTemplate.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseMeasuredTemplate.cleanData
...
`source`Inherited from BaseMeasuredTemplate.cleanData
...
Inherited from BaseMeasuredTemplate.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseMeasuredTemplate.create
...
Inherited from BaseMeasuredTemplate.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseMeasuredTemplate.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    angle: AngleField;    author: DocumentAuthorField;    borderColor: ColorField;    direction: AngleField;    distance: NumberField;    elevation: NumberField;    fillColor: ColorField;    flags: DocumentFlagsField;    hidden: BooleanField;    sort: NumberField;    t: StringField;    texture: FilePathField;    width: NumberField;    x: NumberField;    y: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    angle: AngleField;    author: DocumentAuthorField;    borderColor: ColorField;    direction: AngleField;    distance: NumberField;    elevation: NumberField;    fillColor: ColorField;    flags: DocumentFlagsField;    hidden: BooleanField;    sort: NumberField;    t: StringField;    texture: FilePathField;    width: NumberField;    x: NumberField;    y: NumberField;}Inherited from BaseMeasuredTemplate.defineSchema
...
Inherited from BaseMeasuredTemplate.defineSchema
...
Inherited from BaseMeasuredTemplate.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseMeasuredTemplate.deleteDocuments
...
Inherited from BaseMeasuredTemplate.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseMeasuredTemplate.fromSource
...
Inherited from BaseMeasuredTemplate.fromSource
...
Inherited from BaseMeasuredTemplate.get
...
Inherited from BaseMeasuredTemplate.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseMeasuredTemplate.getCollectionName
...
Inherited from BaseMeasuredTemplate.migrateData
...
`source`Inherited from BaseMeasuredTemplate.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseMeasuredTemplate.migrateDataSafe
...
`source`Inherited from BaseMeasuredTemplate.migrateDataSafe
...
the data argument
Inherited from BaseMeasuredTemplate.shimData
...
`data`Inherited from BaseMeasuredTemplate.shimData
...
Inherited from BaseMeasuredTemplate.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseMeasuredTemplate.updateDocuments
...
Inherited from BaseMeasuredTemplate.validateJoint
...
Returns Promise<void>Inherited from BaseMeasuredTemplate._onCreateOperation
...
Inherited from BaseMeasuredTemplate._onCreateOperation
...
Returns Promise<void>Inherited from BaseMeasuredTemplate._onDeleteOperation
...
Inherited from BaseMeasuredTemplate._onDeleteOperation
...
Returns Promise<void>Inherited from BaseMeasuredTemplate._onUpdateOperation
...
Inherited from BaseMeasuredTemplate._onUpdateOperation
...
Inherited from BaseMeasuredTemplate._preCreateOperation
...
Inherited from BaseMeasuredTemplate._preDeleteOperation
...
Inherited from BaseMeasuredTemplate._preUpdateOperation
