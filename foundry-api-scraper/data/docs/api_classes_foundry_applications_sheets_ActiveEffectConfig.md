...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.ActiveEffectConfig.html
...
- new ActiveEffectConfig(options: any, ...args: any[]): ActiveEffectConfigParametersoptions: any...args: any[]Returns ActiveEffectConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
### StaticDEFAULT_PRIORITIES

`Static`The default priorities of the core change modes
...
- _preparePartContext(partId: any, context: any): Promise<any>ParameterspartId: anycontext: anyReturns Promise<any>Inherit Doc
- partId: any
- context: any
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<ActiveEffectConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<ActiveEffectConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<ActiveEffectConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<ActiveEffectConfig>A Promise which resolves to the rendered Application instance
