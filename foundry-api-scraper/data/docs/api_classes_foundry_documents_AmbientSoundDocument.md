...
Source: https://foundryvtt.com/api/classes/foundry.documents.AmbientSoundDocument.html
...
- foundry.documents.Scene: The Scene document type which contains AmbientSound documents
- foundry.applications.sheets.AmbientSoundConfig: The AmbientSound configuration
application


#### Hierarchy (View Summary)

- BaseAmbientSound<this>AmbientSoundDocument
- AmbientSoundDocument
...
- new AmbientSoundDocument(    data?: Partial<AmbientSoundData>,    options?: DocumentConstructionContext,): AmbientSoundDocumentParametersOptionaldata: Partial<AmbientSoundData> = {}Initial data used to construct the data object. The provided object will be
...
Returns AmbientSoundDocumentInherited from BaseAmbientSound.constructor
- Optionaldata: Partial<AmbientSoundData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseAmbientSound.constructor
...
Inherited from BaseAmbientSound._source
...
Inherited from BaseAmbientSound.parent
...
Inherited from BaseAmbientSound._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseAmbientSound.LOCALIZATION_PREFIXES
...
Inherited from BaseAmbientSound.metadata
...
Returns anyInherited from CanvasDocumentMixin(BaseAmbientSound).compendium
...
Returns null | stringInherited from CanvasDocumentMixin(BaseAmbientSound).id
...
Returns booleanInherited from CanvasDocumentMixin(BaseAmbientSound).inCompendium
...
Returns booleanInherited from CanvasDocumentMixin(BaseAmbientSound).invalid
...
Returns booleanInherited from CanvasDocumentMixin(BaseAmbientSound).isEmbedded
...
Returns SchemaFieldInherited from CanvasDocumentMixin(BaseAmbientSound).schema
...
Returns stringInherited from CanvasDocumentMixin(BaseAmbientSound).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from CanvasDocumentMixin(BaseAmbientSound).validationFailures
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseAmbientSound).baseDocument
...
Returns stringInherited from CanvasDocumentMixin(BaseAmbientSound).collectionName
...
Returns abstract.DatabaseBackendInherited from CanvasDocumentMixin(BaseAmbientSound).database
...
Returns stringInherited from CanvasDocumentMixin(BaseAmbientSound).documentName
...
Returns booleanInherited from CanvasDocumentMixin(BaseAmbientSound).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from CanvasDocumentMixin(BaseAmbientSound).hierarchy
...
Returns typeof DocumentInherited from CanvasDocumentMixin(BaseAmbientSound).implementation
...
Returns string[]Inherited from CanvasDocumentMixin(BaseAmbientSound).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseAmbientSound._configure
...
Inherited from BaseAmbientSound._configure
...
Returns null | stringInherited from BaseAmbientSound._getParentCollection
...
Inherited from BaseAmbientSound._getParentCollection
...
Inherited from BaseAmbientSound.canUserModify
...
Inherited from BaseAmbientSound.clone
...
Inherited from BaseAmbientSound.createEmbeddedDocuments
...
Inherited from BaseAmbientSound.delete
...
SeeDocument.deleteDocuments
Inherited from BaseAmbientSound.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseAmbientSound.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseAmbientSound.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseAmbientSound.getFlag
...
Inherited from BaseAmbientSound.getUserLevel
...
Inherited from BaseAmbientSound.migrateSystemData
...
Returns voidInherited from BaseAmbientSound.reset
...
Inherited from BaseAmbientSound.reset
...
Inherited from BaseAmbientSound.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseAmbientSound.testUserPermission
...
Inherited from BaseAmbientSound.toJSON
...
Inherited from BaseAmbientSound.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseAmbientSound.traverseEmbeddedDocuments
...
Inherited from BaseAmbientSound.traverseEmbeddedDocuments
...
Inherited from BaseAmbientSound.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseAmbientSound.update
...
SeeDocument.updateDocuments
Inherited from BaseAmbientSound.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseAmbientSound.updateSource
...
Inherited from BaseAmbientSound.validate
...
Returns voidInherited from BaseAmbientSound._initialize
...
Inherited from BaseAmbientSound._initialize
...
Inherited from BaseAmbientSound._initializeSource
...
`data`Inherited from BaseAmbientSound._initializeSource
...
Returns voidInherited from BaseAmbientSound._onCreate
...
Inherited from BaseAmbientSound._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseAmbientSound._onDelete
...
Inherited from BaseAmbientSound._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseAmbientSound._onUpdate
...
Inherited from BaseAmbientSound._onUpdate
...
Inherited from BaseAmbientSound._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseAmbientSound._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseAmbientSound._preUpdate
...
Inherited from BaseAmbientSound._addDataFieldMigration
...
Returns voidInherited from BaseAmbientSound._addDataFieldShim
...
Inherited from BaseAmbientSound._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseAmbientSound._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseAmbientSound._addDataFieldShims
...
Returns voidInherited from BaseAmbientSound._clearFieldsRecusively
...
Inherited from BaseAmbientSound._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseAmbientSound._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseAmbientSound._initializationOrder
...
Returns voidInherited from BaseAmbientSound._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseAmbientSound._logDataFieldMigration
...
Inherited from BaseAmbientSound.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseAmbientSound.cleanData
...
`source`Inherited from BaseAmbientSound.cleanData
...
Inherited from BaseAmbientSound.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseAmbientSound.create
...
Inherited from BaseAmbientSound.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseAmbientSound.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    darkness: SchemaField;    easing: BooleanField;    effects: SchemaField;    elevation: NumberField;    flags: DocumentFlagsField;    hidden: BooleanField;    path: FilePathField;    radius: NumberField;    repeat: BooleanField;    volume: AlphaField;    walls: BooleanField;    x: NumberField;    y: NumberField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    darkness: SchemaField;    easing: BooleanField;    effects: SchemaField;    elevation: NumberField;    flags: DocumentFlagsField;    hidden: BooleanField;    path: FilePathField;    radius: NumberField;    repeat: BooleanField;    volume: AlphaField;    walls: BooleanField;    x: NumberField;    y: NumberField;}Inherited from BaseAmbientSound.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    darkness: SchemaField;    easing: BooleanField;    effects: SchemaField;    elevation: NumberField;    flags: DocumentFlagsField;    hidden: BooleanField;    path: FilePathField;    radius: NumberField;    repeat: BooleanField;    volume: AlphaField;    walls: BooleanField;    x: NumberField;    y: NumberField;}

Inherited from BaseAmbientSound.defineSchema
...
Inherited from BaseAmbientSound.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseAmbientSound.deleteDocuments
...
Inherited from BaseAmbientSound.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseAmbientSound.fromSource
...
Inherited from BaseAmbientSound.fromSource
...
Inherited from BaseAmbientSound.get
...
Inherited from BaseAmbientSound.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseAmbientSound.getCollectionName
...
Inherited from BaseAmbientSound.migrateData
...
`source`Inherited from BaseAmbientSound.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseAmbientSound.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseAmbientSound.migrateDataSafe
...
the data argument
Inherited from BaseAmbientSound.shimData
...
`data`Inherited from BaseAmbientSound.shimData
...
Inherited from BaseAmbientSound.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseAmbientSound.updateDocuments
...
Inherited from BaseAmbientSound.validateJoint
...
Returns Promise<void>Inherited from BaseAmbientSound._onCreateOperation
...
Inherited from BaseAmbientSound._onCreateOperation
...
Returns Promise<void>Inherited from BaseAmbientSound._onDeleteOperation
...
Inherited from BaseAmbientSound._onDeleteOperation
...
Returns Promise<void>Inherited from BaseAmbientSound._onUpdateOperation
...
Inherited from BaseAmbientSound._onUpdateOperation
...
Inherited from BaseAmbientSound._preCreateOperation
...
Inherited from BaseAmbientSound._preDeleteOperation
...
Inherited from BaseAmbientSound._preUpdateOperation
