...
Source: https://foundryvtt.com/api/classes/foundry.documents.Adventure.html
...
- hookEvents.preImportAdventure (emitted by Adventure#import)
- hookEvents.importAdventure (emitted by Adventure#import)
...
- new Adventure(    data?: Partial<AdventureData>,    options?: DocumentConstructionContext,): documents.AdventureParametersOptionaldata: Partial<AdventureData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.AdventureInherited from BaseAdventure.constructor
- Optionaldata: Partial<AdventureData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
#### Returns documents.Adventure

Inherited from BaseAdventure.constructor
...
Inherited from BaseAdventure._source
...
Inherited from BaseAdventure.parent
...
Inherited from BaseAdventure._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseAdventure.LOCALIZATION_PREFIXES
...
Inherited from BaseAdventure.metadata
...
Returns anyInherited from ClientDocumentMixin(BaseAdventure).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseAdventure).id
...
Returns booleanInherited from ClientDocumentMixin(BaseAdventure).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseAdventure).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseAdventure).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseAdventure).schema
...
- get thumbnail(): stringProvide a thumbnail image path used to represent the Adventure document.
Returns stringInherited from ClientDocumentMixin(BaseAdventure).thumbnail
...
Returns stringInherited from ClientDocumentMixin(BaseAdventure).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseAdventure).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseAdventure).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseAdventure).collectionName
...
`Static`- get contentFields(): Record<string, typeof Document>An array of the fields which provide imported content from the Adventure.
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseAdventure).database
...
Returns stringInherited from ClientDocumentMixin(BaseAdventure).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseAdventure).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseAdventure).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseAdventure).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseAdventure).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseAdventure._configure
...
Inherited from BaseAdventure._configure
...
Returns null | stringInherited from BaseAdventure._getParentCollection
...
Inherited from BaseAdventure._getParentCollection
...
Inherited from BaseAdventure.canUserModify
...
Inherited from BaseAdventure.clone
...
Inherited from BaseAdventure.createEmbeddedDocuments
...
Inherited from BaseAdventure.delete
...
SeeDocument.deleteDocuments
Inherited from BaseAdventure.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseAdventure.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseAdventure.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseAdventure.getFlag
...
Inherited from BaseAdventure.getUserLevel
...
- import(options?: AdventureImportOptions): Promise<AdventureImportResult>Perform a full import workflow of this Adventure.
Create new and update existing documents within the World.
ParametersOptionaloptions: AdventureImportOptions = {}Options which configure and customize the import process
Returns Promise<AdventureImportResult>The import result
- Optionaloptions: AdventureImportOptions = {}Options which configure and customize the import process
...
`Optional`Options which configure and customize the import process
...
- importContent(data?: AdventureImportData): Promise<AdventureImportResult>Execute an Adventure import workflow, creating and updating documents in the World.
Parametersdata: AdventureImportData = {}Prepared adventure data to import
Returns Promise<AdventureImportResult>The import result
- data: AdventureImportData = {}Prepared adventure data to import
...
Inherited from BaseAdventure.migrateSystemData
...
- prepareImport(options?: AdventureImportOptions): Promise<AdventureImportData>Prepare Adventure data for import into the World.
ParametersOptionaloptions: AdventureImportOptionsOptions which configure import behavior
Returns Promise<AdventureImportData>
- Optionaloptions: AdventureImportOptionsOptions which configure import behavior
...
`Optional`Options which configure import behavior
...
Returns voidInherited from BaseAdventure.reset
...
Inherited from BaseAdventure.reset
...
Inherited from BaseAdventure.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseAdventure.testUserPermission
...
Inherited from BaseAdventure.toJSON
...
Inherited from BaseAdventure.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseAdventure.traverseEmbeddedDocuments
...
Inherited from BaseAdventure.traverseEmbeddedDocuments
...
Inherited from BaseAdventure.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseAdventure.update
...
SeeDocument.updateDocuments
Inherited from BaseAdventure.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseAdventure.updateSource
...
Inherited from BaseAdventure.validate
...
Returns voidInherited from BaseAdventure._initialize
...
Inherited from BaseAdventure._initialize
...
Inherited from BaseAdventure._initializeSource
...
`data`Inherited from BaseAdventure._initializeSource
...
Returns voidInherited from BaseAdventure._onCreate
...
Inherited from BaseAdventure._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseAdventure._onDelete
...
Inherited from BaseAdventure._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseAdventure._onUpdate
...
Inherited from BaseAdventure._onUpdate
...
Inherited from BaseAdventure._preCreate
- data: objectThe initial data object provided to the document creation request
- options: objectAdditional options which modify the creation request
- user: BaseUserThe User requesting the document creation
...
Inherited from BaseAdventure._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseAdventure._preUpdate
...
Inherited from BaseAdventure._addDataFieldMigration
...
Returns voidInherited from BaseAdventure._addDataFieldShim
...
Inherited from BaseAdventure._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseAdventure._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseAdventure._addDataFieldShims
...
Returns voidInherited from BaseAdventure._clearFieldsRecusively
...
Inherited from BaseAdventure._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseAdventure._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseAdventure._initializationOrder
...
Returns voidInherited from BaseAdventure._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseAdventure._logDataFieldMigration
...
Inherited from BaseAdventure.canUserCreate
- user: BaseUserThe User being tested
...
Inherited from BaseAdventure.cleanData
...
`source`Inherited from BaseAdventure.cleanData
...
Inherited from BaseAdventure.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseAdventure.create
...
Inherited from BaseAdventure.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseAdventure.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    actors: SetField;    caption: HTMLField;    cards: SetField;    combats: SetField;    description: HTMLField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    folders: SetField;    img: FilePathField;    items: SetField;    journal: SetField;    macros: SetField;    name: StringField;    playlists: SetField;    scenes: SetField;    sort: IntegerSortField;    tables: SetField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    actors: SetField;    caption: HTMLField;    cards: SetField;    combats: SetField;    description: HTMLField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    folders: SetField;    img: FilePathField;    items: SetField;    journal: SetField;    macros: SetField;    name: StringField;    playlists: SetField;    scenes: SetField;    sort: IntegerSortField;    tables: SetField;}Inherited from BaseAdventure.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    actors: SetField;    caption: HTMLField;    cards: SetField;    combats: SetField;    description: HTMLField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    folders: SetField;    img: FilePathField;    items: SetField;    journal: SetField;    macros: SetField;    name: StringField;    playlists: SetField;    scenes: SetField;    sort: IntegerSortField;    tables: SetField;}

Inherited from BaseAdventure.defineSchema
...
Inherited from BaseAdventure.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseAdventure.deleteDocuments
...
Inherited from BaseAdventure.fromJSON
...
`Static`- fromSource(    source: any,    options?: {},): DataModel<object, DataModelConstructionContext>Create a new instance of this DataModel from a source record.
The source is presumed to be trustworthy and is not strictly validated.
Parameterssource: anyInitial document data which comes from a trusted source.
options: {} = {}Model construction context
Returns DataModel<object, DataModelConstructionContext>Overrides BaseAdventure.fromSource
- source: anyInitial document data which comes from a trusted source.
- options: {} = {}Model construction context
...
Overrides BaseAdventure.fromSource
...
Inherited from BaseAdventure.get
...
Inherited from BaseAdventure.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseAdventure.getCollectionName
...
Inherited from BaseAdventure.migrateData
...
`source`Inherited from BaseAdventure.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseAdventure.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseAdventure.migrateDataSafe
...
the data argument
Inherited from BaseAdventure.shimData
...
`data`Inherited from BaseAdventure.shimData
...
Inherited from BaseAdventure.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseAdventure.updateDocuments
...
Inherited from BaseAdventure.validateJoint
...
Returns Promise<void>Inherited from BaseAdventure._onCreateOperation
...
Inherited from BaseAdventure._onCreateOperation
...
Returns Promise<void>Inherited from BaseAdventure._onDeleteOperation
...
Inherited from BaseAdventure._onDeleteOperation
...
Returns Promise<void>Inherited from BaseAdventure._onUpdateOperation
...
Inherited from BaseAdventure._onUpdateOperation
...
Inherited from BaseAdventure._preCreateOperation
...
Inherited from BaseAdventure._preDeleteOperation
...
Inherited from BaseAdventure._preUpdateOperation
