...
Source: https://foundryvtt.com/api/classes/foundry.documents.collections.Macros.html
...
- foundry.documents.Macro: The Macro document
- foundry.applications.sidebar.tabs.MacroDirectory: The MacroDirectory sidebar directory


#### Hierarchy (View Summary)

- WorldCollectionMacros
- Macros
...
- new Macros(data?: object[]): MacrosParametersdata: object[] = []An array of data objects from which to create document instances
Returns MacrosInherited from WorldCollection.constructor
...
- get directory(): anyReturns anyOverrides WorldCollection.directory
...
- fromCompendium(document: any, options?: {}): objectApply data transformations when importing a Document from a Compendium pack
Parametersdocument: anyThe source Document, or a plain data object
options: {} = {}Additional options which modify how the document is imported
