...
Source: https://foundryvtt.com/api/classes/foundry.documents.Item.html
...
- foundry.documents.collections.Items: The world-level collection of Item documents
- foundry.applications.sheets.ItemSheet: The Item configuration application
...
- new Item(    data?: Partial<ItemData>,    options?: DocumentConstructionContext,): documents.ItemParametersOptionaldata: Partial<ItemData> = {}Initial data used to construct the data object. The provided object will be
...
Returns documents.ItemInherited from BaseItem.constructor
...
Inherited from BaseItem.constructor
...
Inherited from BaseItem._source
...
Inherited from BaseItem.parent
...
Inherited from BaseItem._schema
...
Inherited from BaseItem.DEFAULT_ICON


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseItem.LOCALIZATION_PREFIXES
...
Inherited from BaseItem.metadata
...
- get actor(): null | documents.ActorA convenience alias of Item#parent which is more semantically intuitive
...
Returns anyInherited from ClientDocumentMixin(BaseItem).compendium
...
Returns null | stringInherited from ClientDocumentMixin(BaseItem).id
...
Returns booleanInherited from ClientDocumentMixin(BaseItem).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseItem).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseItem).isEmbedded
...
- get isOwned(): booleanA legacy alias of Item#isEmbedded
Returns boolean
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseItem).schema
...
- get transferredEffects(): documents.ActiveEffect[]Return an array of the Active Effect instances which originated from this Item.
...
Returns stringInherited from ClientDocumentMixin(BaseItem).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseItem).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseItem).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseItem).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseItem).database
...
Returns stringInherited from ClientDocumentMixin(BaseItem).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseItem).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseItem).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseItem).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseItem).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseItem._configure
...
Inherited from BaseItem._configure
...
Returns null | stringInherited from BaseItem._getParentCollection
...
Inherited from BaseItem._getParentCollection
...
Returns voidInherited from BaseItem._initialize
...
Inherited from BaseItem._initialize
...
Inherited from BaseItem.canUserModify
...
Inherited from BaseItem.createEmbeddedDocuments
...
Inherited from BaseItem.delete
...
SeeDocument.deleteDocuments
Inherited from BaseItem.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseItem.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseItem.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseItem.getFlag
...
Inherited from BaseItem.getUserLevel
...
Inherited from BaseItem.migrateSystemData
...
Returns voidInherited from BaseItem.reset
...
Inherited from BaseItem.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseItem.testUserPermission
...
Inherited from BaseItem.toJSON
...
Inherited from BaseItem.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseItem.traverseEmbeddedDocuments
...
Inherited from BaseItem.traverseEmbeddedDocuments
...
Inherited from BaseItem.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseItem.update
...
SeeDocument.updateDocuments
Inherited from BaseItem.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseItem.updateSource
...
Inherited from BaseItem.validate
...
Inherited from BaseItem._initializeSource
...
`data`Inherited from BaseItem._initializeSource
...
Returns voidInherited from BaseItem._onCreate
...
Inherited from BaseItem._onCreate
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseItem._onDelete
...
Inherited from BaseItem._onDelete
...
userId: stringThe id of the User requesting the document update
Returns voidInherited from BaseItem._onUpdate
...
Inherited from BaseItem._onUpdate
...
Inherited from BaseItem._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseItem._preUpdate
...
Inherited from BaseItem._addDataFieldMigration
...
Returns voidInherited from BaseItem._addDataFieldShim
...
Inherited from BaseItem._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseItem._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseItem._addDataFieldShims
...
Returns voidInherited from BaseItem._clearFieldsRecusively
...
Inherited from BaseItem._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseItem._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseItem._initializationOrder
...
Returns voidInherited from BaseItem._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseItem._logDataFieldMigration


### Static_onCreateOperation

`Static`- _onCreateOperation(documents: any, operation: any, user: any): Promise<void>Parametersdocuments: anyoperation: anyuser: anyReturns Promise<void>Overrides BaseItem._onCreateOperation
- documents: any
- operation: any
- user: any
...
Overrides BaseItem._onCreateOperation


### Static_onDeleteOperation

`Static`- _onDeleteOperation(documents: any, operation: any, user: any): Promise<void>Post-process a deletion operation, reacting to database changes which have occurred. Post-operation events occur
for all connected clients.
This batch-wise workflow occurs after individual _onDelete workflows.
Parametersdocuments: anyThe Document instances which were deleted
operation: anyParameters of the database deletion operation
user: anyThe User who performed the deletion operation
Returns Promise<void>Overrides BaseItem._onDeleteOperation
- documents: anyThe Document instances which were deleted
- operation: anyParameters of the database deletion operation
- user: anyThe User who performed the deletion operation
...
Overrides BaseItem._onDeleteOperation


### StaticcanUserCreate

`Static`- canUserCreate(user: any): anyParametersuser: anyReturns anyInherited from BaseItem.canUserCreate
- user: any
...
Inherited from BaseItem.canUserCreate
...
Inherited from BaseItem.cleanData
...
`source`Inherited from BaseItem.cleanData
...
Inherited from BaseItem.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseItem.create
...
Inherited from BaseItem.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseItem.createDocuments
...
Inherited from BaseItem.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseItem.deleteDocuments
...
Inherited from BaseItem.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseItem.fromSource
...
Inherited from BaseItem.fromSource
...
Inherited from BaseItem.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseItem.getCollectionName
...
Inherited from BaseItem.getDefaultArtwork
...
Inherited from BaseItem.migrateData
...
`source`Inherited from BaseItem.migrateData
...
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseItem.migrateDataSafe
...
`source`Inherited from BaseItem.migrateDataSafe
...
the data argument
Inherited from BaseItem.shimData
...
`data`Inherited from BaseItem.shimData
...
Inherited from BaseItem.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseItem.updateDocuments
...
Inherited from BaseItem.validateJoint
...
Returns Promise<void>Inherited from BaseItem._onUpdateOperation
...
Inherited from BaseItem._onUpdateOperation
...
Inherited from BaseItem._preCreateOperation
...
Inherited from BaseItem._preDeleteOperation
...
Inherited from BaseItem._preUpdateOperation
