...
Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.SceneConfig.html
...
- DocumentSheetV2<this>SceneConfig
- SceneConfig
...
- new SceneConfig(options: any, ...args: any[]): SceneConfigParametersoptions: any...args: any[]Returns SceneConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- _previewScene(changed: string, options?: { force?: boolean }): voidInternalLive update the scene as certain properties are changed.
Parameterschanged: stringThe changed property
Optionaloptions: { force?: boolean } = {}Optionalforce?: booleanShould the preview be forced, regardless of changes?
Returns void
- changed: stringThe changed property
- Optionaloptions: { force?: boolean } = {}Optionalforce?: booleanShould the preview be forced, regardless of changes?
- Optionalforce?: booleanShould the preview be forced, regardless of changes?

`Internal`Live update the scene as certain properties are changed.
...
`Optional`- Optionalforce?: booleanShould the preview be forced, regardless of changes?


##### Optionalforce?: boolean

`Optional`Should the preview be forced, regardless of changes?
...
- _processSubmitData(    event: any,    form: any,    submitData: any,    options: any,): Promise<void>Parametersevent: anyform: anysubmitData: anyoptions: anyReturns Promise<void>Overrides HandlebarsApplicationMixin(DocumentSheetV2)._processSubmitData
- event: any
- form: any
- submitData: any
- options: any
...
- changeTab(tab: any, group: any, options: any): voidParameterstab: anygroup: anyoptions: anyReturns voidInherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2).changeTab
- tab: any
- group: any
- options: any
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<SceneConfig>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<SceneConfig>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<SceneConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<SceneConfig>A Promise which resolves to the rendered Application instance
...
`Static`- _getGridTypes(): Record<GRID_TYPES, string>InternalGet an enumeration of the available grid types which can be applied to this Scene
Returns Record<GRID_TYPES, string>

`Internal`Get an enumeration of the available grid types which can be applied to this Scene
