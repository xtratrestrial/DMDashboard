...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseScene.html
...
- DocumentBaseScenedocuments.Scene
- BaseScenedocuments.Scene
- documents.Scene
...
- new BaseScene(    data?: Partial<SceneData>,    options?: DocumentConstructionContext,): BaseSceneParametersOptionaldata: Partial<SceneData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseSceneInherited from Document.constructor
