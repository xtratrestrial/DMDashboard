# CardConfig | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.applications.sheets.CardConfig.html
...
- DocumentSheetV2<this>CardConfig
- CardConfig
...
- new CardConfig(options: any, ...args: any[]): CardConfigParametersoptions: any...args: any[]Returns CardConfigInherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
`Static`- get TYPES(): Record<string, string>Card types with pre-localized labels
...
- close(options?: Partial<ApplicationClosingOptions>): Promise<CardConfig>Close the Application, removing it from the DOM.
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<CardConfig>Render the Application, creating its HTMLElement and replacing its innerHTML.
