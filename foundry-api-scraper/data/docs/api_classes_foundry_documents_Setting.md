...
Source: https://foundryvtt.com/api/classes/foundry.documents.Setting.html
...
foundry.documents.collections.WorldSettings: The world-level collection of Setting
documents


#### Hierarchy (View Summary)

- BaseSetting<this>Setting
- Setting
...
- new Setting(    data?: Partial<SettingData>,    options?: DocumentConstructionContext,): SettingParametersOptionaldata: Partial<SettingData> = {}Initial data used to construct the data object. The provided object will be
...
Returns SettingInherited from BaseSetting.constructor
- Optionaldata: Partial<SettingData> = {}Initial data used to construct the data object. The provided object will be
owned by the constructed model instance and may be mutated.
- Optionaloptions: DocumentConstructionContext = {}Context and data validation options which affects initial model construction.
...
Inherited from BaseSetting.constructor
...
Inherited from BaseSetting._source
...
Inherited from BaseSetting.parent
...
Inherited from BaseSetting._schema


### StaticLOCALIZATION_PREFIXES

`Static`Inherited from BaseSetting.LOCALIZATION_PREFIXES
...
Inherited from BaseSetting.metadata
...
Returns anyInherited from ClientDocumentMixin(BaseSetting).compendium
...
- get config(): undefined | SettingsConfigThe setting configuration for this setting document.
Returns undefined | SettingsConfig
...
Returns null | stringInherited from ClientDocumentMixin(BaseSetting).id
...
Returns booleanInherited from ClientDocumentMixin(BaseSetting).inCompendium
...
Returns booleanInherited from ClientDocumentMixin(BaseSetting).invalid
...
Returns booleanInherited from ClientDocumentMixin(BaseSetting).isEmbedded
...
Returns SchemaFieldInherited from ClientDocumentMixin(BaseSetting).schema
...
Returns stringInherited from ClientDocumentMixin(BaseSetting).uuid
...
Returns {    fields: null | DataModelValidationFailure;    joint: null | DataModelValidationFailure;}Inherited from ClientDocumentMixin(BaseSetting).validationFailures
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseSetting).baseDocument
...
Returns stringInherited from ClientDocumentMixin(BaseSetting).collectionName
...
Returns abstract.DatabaseBackendInherited from ClientDocumentMixin(BaseSetting).database
...
Returns stringInherited from ClientDocumentMixin(BaseSetting).documentName
...
Returns booleanInherited from ClientDocumentMixin(BaseSetting).hasTypeData
...
Returns Readonly<Record<string, any>>Inherited from ClientDocumentMixin(BaseSetting).hierarchy
...
Returns typeof DocumentInherited from ClientDocumentMixin(BaseSetting).implementation
...
Returns string[]Inherited from ClientDocumentMixin(BaseSetting).TYPES
...
- _configure(__namedParameters?: { pack?: null; parentCollection?: null }): voidParameters__namedParameters: { pack?: null; parentCollection?: null } = {}Returns voidInherited from BaseSetting._configure
...
Inherited from BaseSetting._configure
...
Returns null | stringInherited from BaseSetting._getParentCollection
...
Inherited from BaseSetting._getParentCollection
...
Returns voidOverrides BaseSetting._initialize
...
Overrides BaseSetting._initialize
...
Returns voidOverrides BaseSetting._onCreate
...
Overrides BaseSetting._onCreate
...
userId: anyThe id of the User requesting the document update
Returns voidOverrides BaseSetting._onUpdate
...
Overrides BaseSetting._onUpdate
...
Inherited from BaseSetting.canUserModify
...
Inherited from BaseSetting.clone
...
Inherited from BaseSetting.createEmbeddedDocuments
...
Inherited from BaseSetting.delete
...
SeeDocument.deleteDocuments
Inherited from BaseSetting.deleteEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- ids: string[]An array of string ids for each Document to be deleted
- Optionaloperation: DatabaseDeleteOperation = {}Parameters of the database deletion workflow
...
Inherited from BaseSetting.getEmbeddedCollection
- embeddedName: stringThe name of the embedded Document type
...
found.
Inherited from BaseSetting.getEmbeddedDocument
- embeddedName: stringThe name of the embedded Document type
- id: stringThe id of the child document to retrieve
- Optionaloptions: { invalid?: boolean; strict?: boolean } = {}Additional options which modify how embedded documents are retrieved
Optionalinvalid?: booleanAllow retrieving an invalid Embedded Document.
...
Inherited from BaseSetting.getFlag
...
Inherited from BaseSetting.getUserLevel
...
Inherited from BaseSetting.migrateSystemData
...
Returns voidInherited from BaseSetting.reset
...
Inherited from BaseSetting.reset
...
Inherited from BaseSetting.setFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
- value: anyThe flag value
...
Inherited from BaseSetting.testUserPermission
...
Inherited from BaseSetting.toJSON
...
Inherited from BaseSetting.toObject
...
Returns Generator<any, void, any>YieldsInherited from BaseSetting.traverseEmbeddedDocuments
...
Inherited from BaseSetting.traverseEmbeddedDocuments
...
Inherited from BaseSetting.unsetFlag
- scope: stringThe flag scope which namespaces the key
- key: stringThe flag key
...
Inherited from BaseSetting.update
...
SeeDocument.updateDocuments
Inherited from BaseSetting.updateEmbeddedDocuments
- embeddedName: stringThe name of the embedded Document type
- updates: object[] = []An array of differential data objects, each used to update a
single Document
- Optionaloperation: DatabaseUpdateOperation = {}Parameters of the database update workflow
...
Inherited from BaseSetting.updateSource
...
Inherited from BaseSetting.validate
...
`Protected`- _castType(): anyProtectedCast the value of the Setting into its defined type.
Returns anyThe initialized type of the Setting document.

`Protected`Cast the value of the Setting into its defined type.
...
Inherited from BaseSetting._initializeSource
...
`data`Inherited from BaseSetting._initializeSource
...
Returns voidInherited from BaseSetting._onDelete
...
Inherited from BaseSetting._onDelete
...
Inherited from BaseSetting._preCreate
...
Inherited from BaseSetting._preDelete
- options: objectAdditional options which modify the deletion request
- user: BaseUserThe User requesting the document deletion
...
Inherited from BaseSetting._preUpdate
...
Inherited from BaseSetting._addDataFieldMigration
...
Returns voidInherited from BaseSetting._addDataFieldShim
...
Inherited from BaseSetting._addDataFieldShim
...
Optionalvalue?: anyThe value of the shim
Optionalwarning?: stringThe deprecation message
Returns voidInherited from BaseSetting._addDataFieldShims
- data: objectThe data object being shimmed
- shims: { [oldKey: string]: string }The mapping of old keys to new keys
- Optionaloptions: { value?: any; warning?: string }Options passed to foundry.utils.logCompatibilityWarning
Optionalvalue?: anyThe value of the shim
...
Inherited from BaseSetting._addDataFieldShims
...
Returns voidInherited from BaseSetting._clearFieldsRecusively
...
Inherited from BaseSetting._clearFieldsRecusively


### Static_initializationOrder

`Static`- _initializationOrder(): Generator<any[], void, unknown>Returns Generator<any[], void, unknown>Inherited from BaseSetting._initializationOrder


#### Returns Generator<any[], void, unknown>

Inherited from BaseSetting._initializationOrder
...
Returns voidInherited from BaseSetting._logDataFieldMigration
- oldKey: stringThe old field name
- newKey: stringThe new field name
- Optionaloptions: object = {}Options passed to foundry.utils.logCompatibilityWarning
...
Inherited from BaseSetting._logDataFieldMigration


### StaticcanUserCreate

`Static`- canUserCreate(user: any): anyParametersuser: anyReturns anyInherited from BaseSetting.canUserCreate
- user: any
...
Inherited from BaseSetting.canUserCreate
...
Inherited from BaseSetting.cleanData
...
`source`Inherited from BaseSetting.cleanData
...
Inherited from BaseSetting.create
...
`const data = [{name: "Special Sword", type: "weapon"}];const created = await Item.implementation.create(data, {pack: "mymodule.mypack"});`Inherited from BaseSetting.create
...
Inherited from BaseSetting.createDocuments
...
`const data = [{name: "Compendium Actor", type: "character", img: "path/to/profile.jpg"}];const created = await Actor.implementation.createDocuments(data, {pack: "mymodule.mypack"});`Inherited from BaseSetting.createDocuments


### StaticdefineSchema

`Static`- defineSchema(): {    _id: DocumentIdField;    _stats: DocumentStatsField;    key: StringField;    user: ForeignDocumentField;    value: JSONField;}Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    key: StringField;    user: ForeignDocumentField;    value: JSONField;}Inherited from BaseSetting.defineSchema

Define the data schema for documents of this type.
The schema is populated the first time it is accessed and cached for future reuse.


#### Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    key: StringField;    user: ForeignDocumentField;    value: JSONField;}

Inherited from BaseSetting.defineSchema
...
Inherited from BaseSetting.deleteDocuments
...
`const actor = await pack.getDocument(documentId);const deleted = await Actor.implementation.deleteDocuments([actor.id], {pack: "mymodule.mypack"});`Inherited from BaseSetting.deleteDocuments
...
Inherited from BaseSetting.fromJSON
...
Returns DataModel<object, DataModelConstructionContext>Inherited from BaseSetting.fromSource
...
Inherited from BaseSetting.fromSource
...
Inherited from BaseSetting.get
...
Inherited from BaseSetting.getCollectionName
...
`Actor.implementation.getCollectionName("Item");// returns "items"`Inherited from BaseSetting.getCollectionName
...
Inherited from BaseSetting.migrateData
...
`source`Inherited from BaseSetting.migrateData
...
Parameterssource: objectThe candidate source data from which the model will be constructed
Returns objectMigrated source data, which is the same object as the source argument
Inherited from BaseSetting.migrateDataSafe
- source: objectThe candidate source data from which the model will be constructed
...
`source`Inherited from BaseSetting.migrateDataSafe
...
the data argument
Inherited from BaseSetting.shimData
...
`data`Inherited from BaseSetting.shimData
...
Inherited from BaseSetting.updateDocuments
...
`const actor = await pack.getDocument(documentId);const updated = await Actor.implementation.updateDocuments([{_id: actor.id, name: "New Name"}],  {pack: "mymodule.mypack"});`Inherited from BaseSetting.updateDocuments
...
Inherited from BaseSetting.validateJoint
...
Returns Promise<void>Inherited from BaseSetting._onCreateOperation
...
Inherited from BaseSetting._onCreateOperation
...
Returns Promise<void>Inherited from BaseSetting._onDeleteOperation
...
Inherited from BaseSetting._onDeleteOperation
...
Returns Promise<void>Inherited from BaseSetting._onUpdateOperation
...
Inherited from BaseSetting._onUpdateOperation
...
Inherited from BaseSetting._preCreateOperation
...
Inherited from BaseSetting._preDeleteOperation
...
Inherited from BaseSetting._preUpdateOperation
