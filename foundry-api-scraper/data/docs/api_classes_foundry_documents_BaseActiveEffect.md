...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseActiveEffect.html
...
- DocumentBaseActiveEffectdocuments.ActiveEffect
- BaseActiveEffectdocuments.ActiveEffect
...
- new BaseActiveEffect(    data?: Partial<ActiveEffectData>,    options?: DocumentConstructionContext,): BaseActiveEffectParametersOptionaldata: Partial<ActiveEffectData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseActiveEffectInherited from Document.constructor
