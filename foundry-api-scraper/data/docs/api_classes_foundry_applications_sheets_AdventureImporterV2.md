# AdventureImporterV2 | Foundry Virtual Tabletop - API Documentation - Version 13
...
- DocumentSheetV2<this>AdventureImporterV2
- AdventureImporterV2
...
- new AdventureImporterV2(options: any, ...args: any[]): AdventureImporterV2Parametersoptions: any...args: any[]Returns AdventureImporterV2Inherit DocInherited from HandlebarsApplicationMixin(DocumentSheetV2).constructor
- options: any
- ...args: any[]
...
- get adventure(): documents.AdventureA convenience alias for AdventureImporter#document
...
- get isEditable(): anyReturns anyOverrides HandlebarsApplicationMixin(DocumentSheetV2).isEditable
...
- _configureImport(importOptions: AdventureImportOptions): Promise<void>InternalConfigure how adventures that use this sheet class are imported.
This can be implemented by subclasses to implement custom import workflows.
ParametersimportOptions: AdventureImportOptionsReturns Promise<void>
- importOptions: AdventureImportOptions

`Internal`Configure how adventures that use this sheet class are imported.
This can be implemented by subclasses to implement custom import workflows.
...
- _onChangeForm(formConfig: any, event: any): voidParametersformConfig: anyevent: anyReturns voidInherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._onChangeForm
- formConfig: any
- event: any
...
- _onImport(    importResult: AdventureImportResult,    importOptions: AdventureImportOptions,): Promise<void>InternalConfigure how adventures that use this sheet class are imported.
This can be implemented by subclasses to implement custom import workflows.
ParametersimportResult: AdventureImportResultimportOptions: AdventureImportOptionsReturns Promise<void>
- importResult: AdventureImportResult
- importOptions: AdventureImportOptions
...
- _preImport(    importData: AdventureImportData,    importOptions: AdventureImportOptions,): Promise<void>InternalConfigure how adventures that use this sheet class are imported.
This can be implemented by subclasses to implement custom import workflows.
ParametersimportData: AdventureImportDataimportOptions: AdventureImportOptionsReturns Promise<void>
- importData: AdventureImportData
- importOptions: AdventureImportOptions
...
- _prepareContext(    options: any,): Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        adventure: ClientDocument;        buttons: { icon: string; label: string; type: string }[];        contents: { count: number; icon: string; label: string }[];        description: string;        imported: boolean;        optionsSchema: undefined | SchemaField;    },>Parametersoptions: anyReturns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        adventure: ClientDocument;        buttons: { icon: string; label: string; type: string }[];        contents: { count: number; icon: string; label: string }[];        description: string;        imported: boolean;        optionsSchema: undefined | SchemaField;    },>Inherit DocOverrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareContext
- options: any
...
#### Returns Promise<    ApplicationRenderContext & {        document: ClientDocument;        editable: boolean;        fields: any;        rootId: string;        source: any;        user: null        | documents.User;    } & {        adventure: ClientDocument;        buttons: { icon: string; label: string; type: string }[];        contents: { count: number; icon: string; label: string }[];        description: string;        imported: boolean;        optionsSchema: undefined | SchemaField;    },>
...
- _prepareSubmitData(    event: any,    form: any,    formData: any,    _updateData: any,): objectParametersevent: anyform: anyformData: any_updateData: anyReturns objectOverrides HandlebarsApplicationMixin(DocumentSheetV2)._prepareSubmitData
- event: any
- form: any
- formData: any
- _updateData: any
...
- _processSubmitData(    _event: any,    _form: any,    submitData: any,    _options: any,): Promise<void>Parameters_event: any_form: anysubmitData: any_options: anyReturns Promise<void>Overrides HandlebarsApplicationMixin(DocumentSheetV2)._processSubmitData
- _event: any
- _form: any
- submitData: any
- _options: any
...
- close(    options?: Partial<ApplicationClosingOptions>,): Promise<AdventureImporterV2>Close the Application, removing it from the DOM.
ParametersOptionaloptions: Partial<ApplicationClosingOptions> = {}Options which modify how the application is closed.
Returns Promise<AdventureImporterV2>A Promise which resolves to the closed Application instance
...
- render(    options?:        | boolean        | ApplicationRenderOptions & DocumentSheetRenderOptions,    _options?: ApplicationRenderOptions & DocumentSheetRenderOptions,): Promise<AdventureImporterV2>Render the Application, creating its HTMLElement and replacing its innerHTML.
...
Returns Promise<AdventureImporterV2>A Promise which resolves to the rendered Application instance
...
### Protected_getContentList

`Protected`- _getContentList(): { count: number; icon: string; label: string }[]ProtectedPrepare a list of content types provided by this adventure.
Returns { count: number; icon: string; label: string }[]

`Protected`Prepare a list of content types provided by this adventure.
...
### Protected_onToggleImportAll

`Protected`- _onToggleImportAll(event: Event): voidProtectedHandle toggling the import all checkbox.
Parametersevent: EventThe change event.
Returns void
- event: EventThe change event.

`Protected`Handle toggling the import all checkbox.
...
### Protected_prepareImportOptionsSchema

`Protected`- _prepareImportOptionsSchema(    options: AdventureImportOptions,): undefined | SchemaFieldProtectedPrepare import options schema.
Options are rendered using the DataField#toInput method.
Parametersoptions: AdventureImportOptionsReturns undefined | SchemaField
- options: AdventureImportOptions

`Protected`Prepare import options schema.
Options are rendered using the DataField#toInput method.
