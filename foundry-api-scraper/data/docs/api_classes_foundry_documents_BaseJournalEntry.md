...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseJournalEntry.html
...
- DocumentBaseJournalEntrydocuments.JournalEntry
- BaseJournalEntrydocuments.JournalEntry
...
- new BaseJournalEntry(    data?: Partial<JournalEntryData>,    options?: DocumentConstructionContext,): BaseJournalEntryParametersOptionaldata: Partial<JournalEntryData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseJournalEntryInherited from Document.constructor
...
Returns {    _id: DocumentIdField;    _stats: DocumentStatsField;    categories: EmbeddedCollectionField;    flags: DocumentFlagsField;    folder: ForeignDocumentField;    name: StringField;    ownership: DocumentOwnershipField;    pages: EmbeddedCollectionField;    sort: IntegerSortField;}Overrides Document.defineSchema
