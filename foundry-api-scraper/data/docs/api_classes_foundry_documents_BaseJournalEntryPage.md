...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseJournalEntryPage.html
...
- DocumentBaseJournalEntryPagedocuments.JournalEntryPage
- BaseJournalEntryPagedocuments.JournalEntryPage
...
- new BaseJournalEntryPage(    data?: Partial<JournalEntryPageData>,    options?: DocumentConstructionContext,): BaseJournalEntryPageParametersOptionaldata: Partial<JournalEntryPageData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseJournalEntryPageInherited from Document.constructor
