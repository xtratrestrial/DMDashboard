...
Source: https://foundryvtt.com/api/classes/foundry.documents.BaseCombatant.html
...
- DocumentBaseCombatantdocuments.Combatant
- BaseCombatantdocuments.Combatant
- documents.Combatant
...
- new BaseCombatant(    data?: Partial<CombatantData>,    options?: DocumentConstructionContext,): BaseCombatantParametersOptionaldata: Partial<CombatantData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseCombatantInherited from Document.constructor
