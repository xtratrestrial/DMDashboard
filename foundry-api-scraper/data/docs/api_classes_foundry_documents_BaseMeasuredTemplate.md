# BaseMeasuredTemplate | Foundry Virtual Tabletop - API Documentation - Version 13

Source: https://foundryvtt.com/api/classes/foundry.documents.BaseMeasuredTemplate.html
...
- DocumentBaseMeasuredTemplateMeasuredTemplateDocument
- BaseMeasuredTemplateMeasuredTemplateDocument
...
- new BaseMeasuredTemplate(    data?: Partial<MeasuredTemplateData>,    options?: DocumentConstructionContext,): BaseMeasuredTemplateParametersOptionaldata: Partial<MeasuredTemplateData> = {}Initial data used to construct the data object. The provided object will be
...
Returns BaseMeasuredTemplateInherited from Document.constructor
