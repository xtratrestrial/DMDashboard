...
Source: https://foundryvtt.com/api/classes/foundry.documents.collections.RollTables.html
...
- foundry.documents.RollTable: The RollTable document
- foundry.applications.sidebar.tabs.RollTableDirectory: The RollTableDirectory
sidebar directory


#### Hierarchy (View Summary)

- WorldCollectionRollTables
- RollTables
...
- new RollTables(data?: object[]): RollTablesParametersdata: object[] = []An array of data objects from which to create document instances
Returns RollTablesInherited from WorldCollection.constructor
...
`Static`- registerSettings(): voidRegister world settings related to RollTable documents
Returns void
